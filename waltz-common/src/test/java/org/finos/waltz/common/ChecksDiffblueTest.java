...
class ChecksDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test checkAll(Collection, Predicate, String) with 'Collection', 'Predicate', 'String'; when Predicate; then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Collection Checks.checkAll(Collection, Predicate, String)"})
  void testCheckAllWithCollectionPredicateString_whenPredicate_thenReturnEmpty() {
    // Arrange and Act
    Collection<Object> actualCheckAllResult =
