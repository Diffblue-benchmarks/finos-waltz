...
class DateTimeUtilitiesDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link DateTimeUtilities#toSqlDate(Date)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link DateTimeUtilities#toSqlDate(LocalDate)}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link DateTimeUtilities#toSqlTimestamp(LocalDateTime)}
   */
  @Test
  @DisplayName(
      "Test toSqlTimestamp(LocalDateTime); then return SimpleDateFormat(String) with 'yyyy-MM-dd' format is '1970-01-01'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testToSqlTimestamp_thenReturnSimpleDateFormatWithYyyyMmDdFormatIs19700101() {
    // Arrange and Act
    Timestamp actualToSqlTimestampResult =
        DateTimeUtilities.toSqlTimestamp(LocalDate.of(1970, 1, 1).atStartOfDay());

    // Assert
    assertEquals(
        "1970-01-01", new SimpleDateFormat("yyyy-MM-dd").format(actualToSqlTimestampResult));
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link DateTimeUtilities#toLocalDate(Date)}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link DateTimeUtilities#toLocalDate(Timestamp)}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link DateTimeUtilities#toLocalDateTime(Date)}
   */
  @Test
  ...
  void testToLocalDateTime_thenReturnToLocalTimeToStringIs0000() {
    // Arrange and Act
    LocalDateTime actualToLocalDateTimeResult =
        DateTimeUtilities.toLocalDateTime(
