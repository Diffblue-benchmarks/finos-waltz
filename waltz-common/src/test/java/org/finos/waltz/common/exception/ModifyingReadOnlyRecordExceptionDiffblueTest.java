...
class ModifyingReadOnlyRecordExceptionDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ModifyingReadOnlyRecordException.<init>(String, String)",
    "String ModifyingReadOnlyRecordException.getCode()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    ModifyingReadOnlyRecordException actualModifyingReadOnlyRecordException =
        new ModifyingReadOnlyRecordException("Code", "An error occurred");
    String actualCode = actualModifyingReadOnlyRecordException.getCode();
  ...
  /**
   * Test {@link ModifyingReadOnlyRecordException#ModifyingReadOnlyRecordException(String, String,
   * Object[])}.
   *
   * <p>Method under test: {@link
   * ModifyingReadOnlyRecordException#ModifyingReadOnlyRecordException(String, String, Object[])}
   */
  @Test
  ...
  void testNewModifyingReadOnlyRecordException() {
    // Arrange and Act
    ModifyingReadOnlyRecordException actualModifyingReadOnlyRecordException =
        new ModifyingReadOnlyRecordException("Code", "An error occurred", "Args");
