...
class NodeDiffblueTest {
   ...
   *
   * <p>Method under test: {@link Node#getChildren()}
   */
  @Test
   ...
   *   <li>Then return {@link Node#Node(Object, Object)} with {@code Id} and {@code Data}.
   * </ul>
   *
   * <p>Method under test: {@link Node#addChild(Node)}
   */
  @Test
  @DisplayName(
      "Test addChild(Node); when Node(Object, Object) with 'Id' and 'Data'; then return Node(Object, Object) with 'Id' and 'Data'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testAddChild_whenNodeWithIdAndData_thenReturnNodeWithIdAndData() {
    ...
    // Act
    Node<Object, Object> actualAddChildResult = node.addChild(new Node<>("Id", "Data"));

    // Assert
    assertSame(node, actualAddChildResult);
  }
}
