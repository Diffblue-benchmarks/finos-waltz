...
class UnsupportedSearcherDiffblueTest {
   ...
   *
   * <p>Method under test: {@link UnsupportedSearcher#searchFullText(DSLContext,
   * EntitySearchOptions)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.util.List UnsupportedSearcher.searchFullText(DSLContext, EntitySearchOptions)"
  })
  void testSearchFullText() {
    ...
    assertTrue(
        unsupportedSearcher
            .searchFullText(
                new DefaultDSLContext(SQLDialect.SQL99), mock(EntitySearchOptions.class))
            .isEmpty());
  }
}
