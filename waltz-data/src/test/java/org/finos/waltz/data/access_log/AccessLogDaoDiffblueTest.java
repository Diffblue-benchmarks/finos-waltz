...
class AccessLogDaoDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test write(AccessLog); given InsertSetMoreStep execute() return one; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int AccessLogDao.write(AccessLog)"})
  void testWrite_givenInsertSetMoreStepExecuteReturnOne_thenReturnOne() throws DataAccessException {
    // Arrange
