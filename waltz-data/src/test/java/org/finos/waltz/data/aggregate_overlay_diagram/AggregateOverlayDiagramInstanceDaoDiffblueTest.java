...
class AggregateOverlayDiagramInstanceDaoDiffblueTest {
  ...
  void testFindAll() throws DataAccessException {
    ...
    Set<AggregateOverlayDiagramInstance> actualFindAllResult =
        new AggregateOverlayDiagramInstanceDao(dsl).findAll();
   ...
   *
   * <p>Method under test: {@link AggregateOverlayDiagramInstanceDao#getById(Long)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "AggregateOverlayDiagramInstance AggregateOverlayDiagramInstanceDao.getById(Long)"
  })
  void testGetById() throws DataAccessException {
    ...
    ImmutableAggregateOverlayDiagramInstance.Builder nameResult =
    ...
    AggregateOverlayDiagramInstance actualById =
        new AggregateOverlayDiagramInstanceDao(dsl).getById(1L);
  ...
  void testFindByDiagramId() throws DataAccessException {
    ...
    Set<AggregateOverlayDiagramInstance> actualFindByDiagramIdResult =
        new AggregateOverlayDiagramInstanceDao(dsl).findByDiagramId(1L);
  ...
  void testCreateInstance_thenCallsSetDescription() throws DataAccessException {
    ...
    DSLContext dsl = mock(DSLContext.class);
    when(dsl.insertInto(Mockito.<Table<AggregateOverlayDiagramInstanceRecord>>any()))
