...
class AggregateOverlayDiagramPresetDaoDiffblueTest {
  @InjectMocks private AggregateOverlayDiagramPresetDao aggregateOverlayDiagramPresetDao;
  ...
  void testFindPresetsForDiagram() throws DataAccessException {
    ...
    Set<AggregateOverlayDiagramPreset> actualFindPresetsForDiagramResult =
        aggregateOverlayDiagramPresetDao.findPresetsForDiagram(1L);
  ...
  void testCreate_thenCallsSetDescription() throws DataAccessException {
    ...
    when(dSLContext.insertInto(Mockito.<Table<AggregateOverlayDiagramPresetRecord>>any()))
        .thenReturn(insertSetStep);
    when(dSLContext.newRecord(Mockito.<Table<AggregateOverlayDiagramPresetRecord>>any()))
