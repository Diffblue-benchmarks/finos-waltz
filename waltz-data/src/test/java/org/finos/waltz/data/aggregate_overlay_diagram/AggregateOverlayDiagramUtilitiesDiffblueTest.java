...
class AggregateOverlayDiagramUtilitiesDiffblueTest {
  /**
   * Test {@link AggregateOverlayDiagramUtilities#loadExpandedCellMappingsForDiagram(DSLContext, long)}.
   * <ul>
   *   <li>Then return Empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link AggregateOverlayDiagramUtilities#loadExpandedCellMappingsForDiagram(DSLContext, long)}
   */
  @Test
  @DisplayName("Test loadExpandedCellMappingsForDiagram(DSLContext, long); then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.loadExpandedCellMappingsForDiagram(DSLContext, long)"})
  void testLoadExpandedCellMappingsForDiagram_thenReturnEmpty() throws SQLException {
    // Arrange
  ...
  /**
   * Test {@link AggregateOverlayDiagramUtilities#loadCellExtIdToAggregatedEntities(DSLContext, Set, EntityKind, Select, Optional)}.
   * <ul>
   *   <li>When {@code ALL}.</li>
   *   <li>Then throw {@link IllegalArgumentException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AggregateOverlayDiagramUtilities#loadCellExtIdToAggregatedEntities(DSLContext, Set, EntityKind, Select, Optional)}
   */
  @Test
  @DisplayName("Test loadCellExtIdToAggregatedEntities(DSLContext, Set, EntityKind, Select, Optional); when 'ALL'; then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link AggregateOverlayDiagramUtilities#toMeasurableIds(Set)}
   */
  @Test
  @DisplayName("Test toMeasurableIds(Set); given EntityReference kind() return 'ALL'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.toMeasurableIds(Set)"})
  void testToMeasurableIds_givenEntityReferenceKindReturnAll_thenReturnEmpty() {
    // Arrange
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.toMeasurableIds(Set)"})
  void testToMeasurableIds_givenEntityReferenceKindReturnAll_thenReturnEmpty2() {
    // Arrange
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.kind()).thenReturn(EntityKind.ALL);
    Tuple2<String, EntityReference> tuple2 = new Tuple2<>("V1", entityReference);
   ...
   */
  @Test
  @DisplayName("Test toMeasurableIds(Set); then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.toMeasurableIds(Set)"})
  void testToMeasurableIds_thenThrowIllegalArgumentException() {
    // Arrange
    HashSet<Tuple2<String, EntityReference>> cellMappings = new HashSet<>();
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.kind()).thenThrow(new IllegalArgumentException("foo"));
    cellMappings.add(new Tuple2<>("V1", entityReference));
    EntityReference entityReference2 = mock(EntityReference.class);
    when(entityReference2.kind()).thenReturn(EntityKind.ALL);
    cellMappings.add(new Tuple2<>("V1", entityReference2));
    EntityReference entityReference3 = mock(EntityReference.class);
    when(entityReference3.kind()).thenReturn(EntityKind.ALL);
    cellMappings.add(new Tuple2<>("V1", entityReference3));
   ...
   * </ul>
   * <p>
   * Method under test: {@link AggregateOverlayDiagramUtilities#toDataTypeIds(Set)}
   */
  @Test
  @DisplayName("Test toDataTypeIds(Set); given EntityReference kind() return 'ALL'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.toDataTypeIds(Set)"})
  void testToDataTypeIds_givenEntityReferenceKindReturnAll_thenReturnEmpty() {
    // Arrange
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.kind()).thenReturn(EntityKind.ALL);
    Tuple2<String, EntityReference> tuple2 = new Tuple2<>("V1", entityReference);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.toDataTypeIds(Set)"})
  void testToDataTypeIds_givenEntityReferenceKindReturnAll_thenReturnEmpty2() {
    // Arrange
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.kind()).thenReturn(EntityKind.ALL);
    Tuple2<String, EntityReference> tuple2 = new Tuple2<>("V1", entityReference);
   ...
   */
  @Test
  @DisplayName("Test toDataTypeIds(Set); then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Set AggregateOverlayDiagramUtilities.toDataTypeIds(Set)"})
  void testToDataTypeIds_thenThrowIllegalArgumentException() {
    // Arrange
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.kind()).thenReturn(EntityKind.ALL);
    Tuple2<String, EntityReference> tuple2 = new Tuple2<>("V1", entityReference);
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> AggregateOverlayDiagramUtilities.toDataTypeIds(cellMappings));
    verify(entityReference3).kind();
  }
  ...
  /**
   * Test {@link AggregateOverlayDiagramUtilities#findMeasurableIdToAggregatedEntityIdMap(DSLContext, EntityKind, Select, Set, Optional)}.
   * <ul>
   *   <li>Then throw {@link IllegalArgumentException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AggregateOverlayDiagramUtilities#findMeasurableIdToAggregatedEntityIdMap(DSLContext, EntityKind, Select, Set, Optional)}
   */
  @Test
  @DisplayName("Test findMeasurableIdToAggregatedEntityIdMap(DSLContext, EntityKind, Select, Set, Optional); then throw IllegalArgumentException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  /**
   * Test {@link AggregateOverlayDiagramUtilities#loadEntityIdToRefMap(DSLContext, EntityKind, Select)}.
   * <p>
   * Method under test: {@link AggregateOverlayDiagramUtilities#loadEntityIdToRefMap(DSLContext, EntityKind, Select)}
   */
  @Test
