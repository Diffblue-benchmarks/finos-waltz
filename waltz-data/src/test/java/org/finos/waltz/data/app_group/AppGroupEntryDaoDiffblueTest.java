...
class AppGroupEntryDaoDiffblueTest {
  ...
  void testAddApplication_givenInsertReturningStepExecuteReturnThree_thenReturnThree()
    ...
    when(dSLContext.insertInto(Mockito.<Table<ApplicationGroupEntryRecord>>any()))
        .thenReturn(insertSetStep);

    // Act
    int actualAddApplicationResult = appGroupEntryDao.addApplication(1L, 1L);
  ...
  void testAddApplication_whenFour_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualAddApplicationResult = appGroupEntryDao.addApplication(4L, 1L);
  ...
  void testAddApplication_whenThree_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualAddApplicationResult = appGroupEntryDao.addApplication(3L, 1L);
  ...
  void testAddApplication_whenTwo_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualAddApplicationResult = appGroupEntryDao.addApplication(2L, 1L);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] AppGroupEntryDao.addApplications(long, Collection)"})
  void testAddApplications_givenDefaultDSLContextWithConnectionAndDialectIsSql992()
      throws SQLException {
    // Arrange
    Statement statement = mock(Statement.class);
    doNothing().when(statement).addBatch(Mockito.<String>any());
  ...
  @Test
  @DisplayName(
      "Test addApplications(long, Collection); given zero; when ArrayList() add zero; then calls execute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] AppGroupEntryDao.addApplications(long, Collection)"})
  void testAddApplications_givenZero_whenArrayListAddZero_thenCallsExecute()
      throws DataAccessException {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test addApplications(long, Collection); when ArrayList(); then calls execute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] AppGroupEntryDao.addApplications(long, Collection)"})
  void testAddApplications_whenArrayList_thenCallsExecute() throws DataAccessException {
    // Arrange
    Batch batch = mock(Batch.class);
    when(batch.execute()).thenReturn(new int[] {1, -1, 1, -1});
    when(dSLContext.batch((Query[]) Mockito.any())).thenReturn(batch);
  ...
  void testRemoveApplication_givenDeleteConditionStepExecuteReturnThree_thenReturnThree()
    ...
    when(dSLContext.delete(Mockito.<Table<ApplicationGroupEntryRecord>>any()))
        .thenReturn(deleteUsingStep);

    // Act
    int actualRemoveApplicationResult = appGroupEntryDao.removeApplication(1L, 1L);
  ...
  void testRemoveApplication_whenFour_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualRemoveApplicationResult = appGroupEntryDao.removeApplication(4L, 1L);
  ...
  void testRemoveApplication_whenThree_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualRemoveApplicationResult = appGroupEntryDao.removeApplication(3L, 1L);
  ...
  void testRemoveApplication_whenTwo_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualRemoveApplicationResult = appGroupEntryDao.removeApplication(2L, 1L);
   ...
   *
   * <ul>
   *   <li>Given {@link Tuple2}.
   *   <li>When {@link HashSet#HashSet()} add {@link Tuple2}.
   * </ul>
   *
   * <p>Method under test: {@link AppGroupEntryDao#replaceGroupApplicationEntries(Set)}
   */
  @Test
  @DisplayName("Test replaceGroupApplicationEntries(Set); given Tuple2; when HashSet() add Tuple2")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AppGroupEntryDao.replaceGroupApplicationEntries(Set)"})
  void testReplaceGroupApplicationEntries_givenTuple2_whenHashSetAddTuple2() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test replaceGroupApplicationEntries(Set); then calls transaction(TransactionalRunnable)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AppGroupEntryDao.replaceGroupApplicationEntries(Set)"})
  void testReplaceGroupApplicationEntries_thenCallsTransaction() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
  ...
  @Test
  @DisplayName(
      "Test replaceGroupApplicationEntries(Set); when HashSet(); then calls transaction(TransactionalRunnable)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AppGroupEntryDao.replaceGroupApplicationEntries(Set)"})
  void testReplaceGroupApplicationEntries_whenHashSet_thenCallsTransaction() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
  ...
  @Test
  @DisplayName(
      "Test replaceGroupChangeInitiativeEntries(Set); given Tuple2; when HashSet() add Tuple2")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AppGroupEntryDao.replaceGroupChangeInitiativeEntries(Set)"})
  void testReplaceGroupChangeInitiativeEntries_givenTuple2_whenHashSetAddTuple2() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
  ...
  @Test
  @DisplayName(
      "Test replaceGroupChangeInitiativeEntries(Set); then calls transaction(TransactionalRunnable)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AppGroupEntryDao.replaceGroupChangeInitiativeEntries(Set)"})
  void testReplaceGroupChangeInitiativeEntries_thenCallsTransaction() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
  ...
  @Test
  @DisplayName(
      "Test replaceGroupChangeInitiativeEntries(Set); when HashSet(); then calls transaction(TransactionalRunnable)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AppGroupEntryDao.replaceGroupChangeInitiativeEntries(Set)"})
  void testReplaceGroupChangeInitiativeEntries_whenHashSet_thenCallsTransaction() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
