...
class SqlServerAppSearchDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SqlServerAppSearch#searchFullText(DSLContext, EntitySearchOptions)}
   */
  @Test
  @DisplayName("Test searchFullText(DSLContext, EntitySearchOptions); then return size is two")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List SqlServerAppSearch.searchFullText(DSLContext, EntitySearchOptions)"})
  void testSearchFullText_thenReturnSizeIsTwo() throws SQLException {
    // Arrange
