...
class AssessmentDefinitionDaoDiffblueTest {
  ...
  void testFindAll() throws DataAccessException {
    ...
    // Act
    Set<AssessmentDefinition> actualFindAllResult = assessmentDefinitionDao.findAll();
  ...
  void testFindByEntityKind() throws DataAccessException {
    ...
    Set<AssessmentDefinition> actualFindByEntityKindResult =
        assessmentDefinitionDao.findByEntityKind(EntityKind.ALL);
  ...
  void testFindByEntityKindAndQualifier2() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetchSet(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new HashSet<>());
  ...
  void testRemove_givenDeleteConditionStepExecuteReturnOne_thenReturnOne()
    ...
    when(dSLContext.deleteFrom(Mockito.<Table<AssessmentDefinitionRecord>>any()))
        .thenReturn(deleteUsingStep);

    // Act
    int actualRemoveResult = assessmentDefinitionDao.remove(1L);
   ...
   */
  @Test
  @DisplayName("Test findFavourites(Set, Set); given one; when HashSet() add one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set AssessmentDefinitionDao.findFavourites(Set, Set)"})
  void testFindFavourites_givenOne_whenHashSetAddOne() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetchSet(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new HashSet<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set AssessmentDefinitionDao.findFavourites(Set, Set)"})
  void testFindFavourites_givenOne_whenHashSetAddOne2() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetchSet(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new HashSet<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set AssessmentDefinitionDao.findFavourites(Set, Set)"})
  void testFindFavourites_givenZero_whenHashSetAddZero2() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetchSet(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new HashSet<>());
   ...
   */
  @Test
  @DisplayName("Test findFavourites(Set, Set); when HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set AssessmentDefinitionDao.findFavourites(Set, Set)"})
  void testFindFavourites_whenHashSet() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetchSet(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new HashSet<>());
