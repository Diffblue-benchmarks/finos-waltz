...
class AttestationRunDaoDiffblueTest {
   ...
   *
   * <p>Method under test: {@link AttestationRunDao#getById(long)}
   */
  @Test
  ...
  void testGetById() throws DataAccessException {
    ...
    // Act
    AttestationRun actualById = attestationRunDao.getById(1L);
  ...
  void testGetEntityCount_givenSelectJoinStepFetchOneReturnOne_whenSelect_thenReturnOne()
    ...
    // Act
    int actualEntityCount = new AttestationRunDao(dsl).getEntityCount(mock(Select.class));
  ...
  void testUpdateRecipientInvolvementGroupId_whenFour_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualUpdateRecipientInvolvementGroupIdResult =
        new AttestationRunDao(dsl).updateRecipientInvolvementGroupId(4L, 1L);
  ...
  void testUpdateRecipientInvolvementGroupId_whenThree_thenReturnThree()
    ...
    // Act
    int actualUpdateRecipientInvolvementGroupIdResult =
        new AttestationRunDao(dsl).updateRecipientInvolvementGroupId(3L, 1L);
  ...
  void testUpdateRecipientInvolvementGroupId_whenTwo_thenReturnThree() throws DataAccessException {
    ...
    // Act
    int actualUpdateRecipientInvolvementGroupIdResult =
        new AttestationRunDao(dsl).updateRecipientInvolvementGroupId(2L, 1L);
