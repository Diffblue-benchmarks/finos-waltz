...
class PostgresChangeInitiativeSearchDiffblueTest {
  /**
   * Test {@link PostgresChangeInitiativeSearch#searchFullText(DSLContext, EntitySearchOptions)}.
   *
   * <ul>
   *   <li>Then return Empty.
   * </ul>
   *
   * <p>Method under test: {@link PostgresChangeInitiativeSearch#searchFullText(DSLContext,
   * EntitySearchOptions)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List PostgresChangeInitiativeSearch.searchFullText(DSLContext, EntitySearchOptions)"
  })
  void testSearchFullText_thenReturnEmpty() throws DataAccessException {
    // Arrange
    PostgresChangeInitiativeSearch postgresChangeInitiativeSearch =
        new PostgresChangeInitiativeSearch();
    ...
    // Act
    List<ChangeInitiative> actualSearchFullTextResult =
        postgresChangeInitiativeSearch.searchFullText(
            dsl,
            builderResult
