...
class PostgresChangeInitiativeSearchDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link PostgresChangeInitiativeSearch#searchFullText(DSLContext, EntitySearchOptions)}
   */
  @Test
  @DisplayName("Test searchFullText(DSLContext, EntitySearchOptions); given ResultSet next() return 'false'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List PostgresChangeInitiativeSearch.searchFullText(DSLContext, EntitySearchOptions)"})
