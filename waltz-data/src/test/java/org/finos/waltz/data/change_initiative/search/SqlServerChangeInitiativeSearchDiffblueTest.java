...
class SqlServerChangeInitiativeSearchDiffblueTest {
   ...
   *
   * <p>Method under test: {@link SqlServerChangeInitiativeSearch#searchFullText(DSLContext,
   * EntitySearchOptions)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List SqlServerChangeInitiativeSearch.searchFullText(DSLContext, EntitySearchOptions)"
  })
  void testSearchFullText() throws DataAccessException {
    // Arrange
    SqlServerChangeInitiativeSearch sqlServerChangeInitiativeSearch =
        new SqlServerChangeInitiativeSearch();
    ...
    List<ChangeInitiative> actualSearchFullTextResult =
        sqlServerChangeInitiativeSearch.searchFullText(
            dsl,
            builderResult
