...
class ChangeUnitIdSelectorFactoryDiffblueTest {
  /**
   * Method under test:
   * {@link ChangeUnitIdSelectorFactory#apply(IdSelectionOptions)}
   */
  @Test
  void testApply() {
    // Arrange
   ...
   * {@link ChangeUnitIdSelectorFactory}
   */
  @Test
  void testNewChangeUnitIdSelectorFactory() {
    // Arrange and Act
   ...
   */
  @Test
  void testNewChangeUnitIdSelectorFactory2() {
    // Arrange and Act
    ChangeUnitIdSelectorFactory actualChangeUnitIdSelectorFactory = new ChangeUnitIdSelectorFactory();
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.id()).thenReturn(1L);
