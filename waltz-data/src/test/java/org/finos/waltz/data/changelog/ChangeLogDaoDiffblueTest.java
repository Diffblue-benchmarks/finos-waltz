...
class ChangeLogDaoDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test findByParentReference(EntityReference, Optional, Optional); then calls id()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List ChangeLogDao.findByParentReference(EntityReference, Optional, Optional)"
  })
  void testFindByParentReference_thenCallsId() throws DataAccessException {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test findByParentReference(EntityReference, Optional, Optional); then calls select(SelectFieldOrAsterisk[])")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List ChangeLogDao.findByParentReference(EntityReference, Optional, Optional)"
  })
  void testFindByParentReference_thenCallsSelect() throws DataAccessException {
    // Arrange
    SelectLimitPercentStep<Record> selectLimitPercentStep = mock(SelectLimitPercentStep.class);
    when(selectLimitPercentStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>Given {@link ChangeLogDao#ChangeLogDao(DSLContext)} with dsl is {@link DSLContext}.
   * </ul>
   *
   * <p>Method under test: {@link ChangeLogDao#findByPersonReference(EntityReference, Optional,
   * Optional)}
  ...
  @Test
  @DisplayName(
      "Test findByPersonReference(EntityReference, Optional, Optional); given ChangeLogDao(DSLContext) with dsl is DSLContext")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List ChangeLogDao.findByPersonReference(EntityReference, Optional, Optional)"
  })
  void testFindByPersonReference_givenChangeLogDaoWithDslIsDSLContext() throws DataAccessException {
    // Arrange
    SelectLimitPercentStep<Record> selectLimitPercentStep = mock(SelectLimitPercentStep.class);
    when(selectLimitPercentStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
  ...
  @Test
  @DisplayName(
      "Test findByPersonReference(EntityReference, Optional, Optional); given ChangeLogDao(DSLContext) with dsl is DSLContext; when empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List ChangeLogDao.findByPersonReference(EntityReference, Optional, Optional)"
  })
  void testFindByPersonReference_givenChangeLogDaoWithDslIsDSLContext_whenEmpty()
  ...
  @Test
  @DisplayName(
      "Test findByParentReferenceForDateRange(EntityReference, Date, Date, Optional); then calls id()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List ChangeLogDao.findByParentReferenceForDateRange(EntityReference, Date, Date, Optional)"
  })
  void testFindByParentReferenceForDateRange_thenCallsId() throws DataAccessException {
    // Arrange
    SelectLimitPercentStep<Record> selectLimitPercentStep = mock(SelectLimitPercentStep.class);
    when(selectLimitPercentStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
  ...
  @Test
  @DisplayName(
      "Test findByPersonReferenceForDateRange(EntityReference, Date, Date, Optional); given ChangeLogDao(DSLContext) with dsl is DSLContext")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List ChangeLogDao.findByPersonReferenceForDateRange(EntityReference, Date, Date, Optional)"
  })
  void testFindByPersonReferenceForDateRange_givenChangeLogDaoWithDslIsDSLContext()
      throws DataAccessException {
    // Arrange
    SelectLimitPercentStep<Record> selectLimitPercentStep = mock(SelectLimitPercentStep.class);
    when(selectLimitPercentStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
  ...
  @Test
  @DisplayName(
      "Test findByUser(String, Optional); given SelectLimitPercentStep fetch(RecordMapper) return ArrayList(); then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List ChangeLogDao.findByUser(String, Optional)"})
  void testFindByUser_givenSelectLimitPercentStepFetchReturnArrayList_thenReturnEmpty()
      throws DataAccessException {
    // Arrange
    SelectLimitPercentStep<Record> selectLimitPercentStep = mock(SelectLimitPercentStep.class);
    when(selectLimitPercentStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] ChangeLogDao.write(Collection)"})
  void testWriteWithChangeLogs_givenStatementAddBatchDoesNothing_thenCallsAddBatch2()
      throws SQLException {
    // Arrange
    Statement statement = mock(Statement.class);
    doNothing().when(statement).addBatch(Mockito.<String>any());
   ...
   */
  @Test
  @DisplayName("Test write(Collection) with 'changeLogs'; then calls execute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] ChangeLogDao.write(Collection)"})
  void testWriteWithChangeLogs_thenCallsExecute() throws DataAccessException {
    // Arrange
    Batch batch = mock(Batch.class);
    when(batch.execute()).thenReturn(new int[] {1, -1, 1, -1});
  ...
  @Test
  @DisplayName(
      "Test write(Collection) with 'changeLogs'; when ArrayList(); then calls createStatement()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] ChangeLogDao.write(Collection)"})
  void testWriteWithChangeLogs_whenArrayList_thenCallsCreateStatement() throws SQLException {
    // Arrange
    Statement statement = mock(Statement.class);
    when(statement.executeBatch()).thenReturn(new int[] {1, -1, 1, -1});
    when(statement.getWarnings()).thenReturn(new SQLWarning());
  ...
  void testWriteWithTxChangeLog() throws SQLException {
    // Arrange
  ...
  void testWriteWithTxChangeLog_givenInsertSetMoreStepExecuteReturnOne_thenReturnOne()
    ...
    when(defaultDSLContext.insertInto(Mockito.<Table<ChangeLogRecord>>any()))
    ...
    verify(defaultDSLContext).insertInto(isA(Table.class));
  ...
  @Test
  @DisplayName(
      "Test findUnattestedChanges(EntityReference); given ChangeLogDao(DSLContext) with dsl is DSLContext")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List ChangeLogDao.findUnattestedChanges(EntityReference)"})
  void testFindUnattestedChanges_givenChangeLogDaoWithDslIsDSLContext() throws DataAccessException {
    // Arrange
    SelectQuery<Record> selectQuery = mock(SelectQuery.class);
    when(selectQuery.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
    ...
    DSLContext dsl = mock(DSLContext.class);
    when(dsl.selectQuery(Mockito.<TableLike<Record>>any())).thenReturn(selectQuery);
    ChangeLogDao changeLogDao = new ChangeLogDao(dsl);
    ...
    // Assert
    verify(dsl).selectQuery(isA(TableLike.class));
    verify(selectQuery).fetch(isA(RecordMapper.class));
    assertTrue(actualFindUnattestedChangesResult.isEmpty());
  }
}
