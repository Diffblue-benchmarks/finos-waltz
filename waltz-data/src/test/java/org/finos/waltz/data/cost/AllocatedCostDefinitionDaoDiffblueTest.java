...
class AllocatedCostDefinitionDaoDiffblueTest {
  @InjectMocks private AllocatedCostDefinitionDao allocatedCostDefinitionDao;
  ...
  void testFindAll() throws DataAccessException {
    ...
    // Act
    Set<AllocatedCostDefinition> actualFindAllResult = allocatedCostDefinitionDao.findAll();
