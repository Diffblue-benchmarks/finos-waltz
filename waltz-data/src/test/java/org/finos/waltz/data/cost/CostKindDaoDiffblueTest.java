...
class CostKindDaoDiffblueTest {
  ...
  void testFindAll() throws MappingException {
    ...
    // Act
    Set<CostKindWithYears> actualFindAllResult = new CostKindDao(dsl).findAll();
  ...
  void testFindCostKindsBySubjectKind() throws MappingException {
    ...
    Set<CostKindWithYears> actualFindCostKindsBySubjectKindResult =
        new CostKindDao(dsl).findCostKindsBySubjectKind(EntityKind.ALL);
   ...
   *
   * <p>Method under test: {@link CostKindDao#getById(Long)}
   */
  @Test
  ...
  void testGetById() throws DataAccessException {
    ...
    // Act
    EntityCostKind actualById = new CostKindDao(dsl).getById(1L);
    ...
    assertTrue(actualById instanceof ImmutableEntityCostKind);
