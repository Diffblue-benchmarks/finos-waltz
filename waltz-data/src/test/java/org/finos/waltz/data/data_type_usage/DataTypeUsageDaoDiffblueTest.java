...
class DataTypeUsageDaoDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test findForEntity(EntityReference); when EntityReference kind() throw UnsupportedOperationException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataTypeUsageDao.findForEntity(EntityReference)"})
  void testFindForEntity_whenEntityReferenceKindThrowUnsupportedOperationException() {
    // Arrange
    EntityReference ref = mock(EntityReference.class);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataTypeUsageDao.findForEntityAndDataType(EntityReference, Long)"})
  void testFindForEntityAndDataType4() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenThrow(new UnsupportedOperationException());
  ...
  @Test
  @DisplayName(
      "Test findForEntityAndDataType(EntityReference, Long); given DefaultDSLContext(SQLDialect) with dialect is 'SQL99'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataTypeUsageDao.findForEntityAndDataType(EntityReference, Long)"})
  void testFindForEntityAndDataType_givenDefaultDSLContextWithDialectIsSql99() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test findForEntityAndDataType(EntityReference, Long); given one; when EntityReference id() return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List DataTypeUsageDao.findForEntityAndDataType(EntityReference, Long)"})
  void testFindForEntityAndDataType_givenOne_whenEntityReferenceIdReturnOne()
      throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
  ...
  void testDeleteUsageInfo() throws DataAccessException {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@code CONSUMER}.
   *   <li>When {@link ArrayList#ArrayList()} add {@code CONSUMER}.
  ...
  @Test
  @DisplayName(
      "Test deleteUsageInfo(EntityReference, Long, List); given 'CONSUMER'; when ArrayList() add 'CONSUMER'; then calls and(Condition)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int DataTypeUsageDao.deleteUsageInfo(EntityReference, Long, List)"})
  void testDeleteUsageInfo_givenConsumer_whenArrayListAddConsumer_thenCallsAnd() {
    // Arrange
    DeleteConditionStep<DataTypeUsageRecord> deleteConditionStep = mock(DeleteConditionStep.class);
    when(deleteConditionStep.and(Mockito.<Condition>any()))
        .thenThrow(new UnsupportedOperationException());
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> dataTypeUsageDao.deleteUsageInfo(ref, 1L, deletes));
    verify(dSLContext).deleteFrom(isA(Table.class));
    verify(deleteConditionStep3).and(isA(Condition.class));
    verify(deleteConditionStep2).and(isA(Condition.class));
    verify(deleteConditionStep).and(isA(Condition.class));
  ...
  @Test
  @DisplayName(
      "Test deleteUsageInfo(EntityReference, Long, List); given DefaultDSLContext(SQLDialect) with dialect is 'SQL99'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int DataTypeUsageDao.deleteUsageInfo(EntityReference, Long, List)"})
  void testDeleteUsageInfo_givenDefaultDSLContextWithDialectIsSql99() {
    // Arrange
    DataTypeUsageDao dataTypeUsageDao =
        new DataTypeUsageDao(new DefaultDSLContext(SQLDialect.SQL99));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int DataTypeUsageDao.deleteUsageInfo(EntityReference, Long, List)"})
  void testDeleteUsageInfo_givenDeleteUsingStepWhereThrowUnsupportedOperationException2() {
    // Arrange
    DeleteUsingStep<DataTypeUsageRecord> deleteUsingStep = mock(DeleteUsingStep.class);
    when(deleteUsingStep.where(Mockito.<Condition>any()))
        .thenThrow(new UnsupportedOperationException());
  ...
  @Test
  @DisplayName(
      "Test deleteUsageInfo(EntityReference, Long, List); given 'DISTRIBUTOR'; when ArrayList() add 'DISTRIBUTOR'; then calls and(Condition)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int DataTypeUsageDao.deleteUsageInfo(EntityReference, Long, List)"})
  void testDeleteUsageInfo_givenDistributor_whenArrayListAddDistributor_thenCallsAnd() {
    // Arrange
    DeleteConditionStep<DataTypeUsageRecord> deleteConditionStep = mock(DeleteConditionStep.class);
    when(deleteConditionStep.and(Mockito.<Condition>any()))
        .thenThrow(new UnsupportedOperationException());
  ...
  @Test
  @DisplayName(
      "Test deleteUsageInfo(EntityReference, Long, List); given UnsupportedOperationException(); when LinkedList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int DataTypeUsageDao.deleteUsageInfo(EntityReference, Long, List)"})
  void testDeleteUsageInfo_givenUnsupportedOperationException_whenLinkedList() {
    // Arrange
    when(dSLContext.deleteFrom(Mockito.<Table<DataTypeUsageRecord>>any()))
        .thenReturn(mock(DeleteUsingStep.class));
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> dataTypeUsageDao.deleteUsageInfo(ref, 1L, new LinkedList<>()));
    verify(ref).kind();
    verify(dSLContext).deleteFrom(isA(Table.class));
  }
  ...
  void testRecalculateForAllApplications_thenReturnTrue() {
    ...
    // Assert
    verify(dSLContext, atLeast(1)).transaction(Mockito.<TransactionalRunnable>any());
