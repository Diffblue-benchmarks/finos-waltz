...
class PhysicalSpecDecoratorDaoDiffblueTest {
  ...
  void testGetByEntityIdAndDataTypeId7() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test getByEntityIdAndDataTypeId(long, long); then calls fetchOne(RecordMapper)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "DataTypeDecorator PhysicalSpecDecoratorDao.getByEntityIdAndDataTypeId(long, long)"
  })
  void testGetByEntityIdAndDataTypeId_thenCallsFetchOne() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
  ...
  void testFindByEntityId_givenSelectConditionStepFetchReturnArrayList_thenReturnEmpty()
    ...
    List<DataTypeDecorator> actualFindByEntityIdResult =
        physicalSpecDecoratorDao.findByEntityId(1L);
  ...
  void testFindByAppIdSelector() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> physicalSpecDecoratorDao.findByAppIdSelector(mock(Select.class)));
  }
  ...
  void testFindByFlowIdSelector() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> physicalSpecDecoratorDao.findByFlowIdSelector(mock(Select.class)));
  }
  ...
  void testFindByDataTypeIdSelector() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> physicalSpecDecoratorDao.findByDataTypeIdSelector(mock(Select.class)));
  }
  ...
  @Test
  @DisplayName(
      "Test removeDataTypes(EntityReference, Collection); given DSLContext deleteFrom(Table) throw UnsupportedOperationException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.removeDataTypes(EntityReference, Collection)"})
  void testRemoveDataTypes_givenDSLContextDeleteFromThrowUnsupportedOperationException() {
    // Arrange
    when(dSLContext.deleteFrom(Mockito.<Table<PhysicalSpecDataTypeRecord>>any()))
        .thenThrow(new UnsupportedOperationException());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.removeDataTypes(EntityReference, Collection)"})
  void testRemoveDataTypes_givenDeleteConditionStepExecuteReturnOne_thenReturnOne2()
      throws DataAccessException {
    // Arrange
    DeleteConditionStep<PhysicalSpecDataTypeRecord> deleteConditionStep =
        mock(DeleteConditionStep.class);
  ...
  void testFindDatatypeUsageCharacteristics() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> physicalSpecDecoratorDao.findDatatypeUsageCharacteristics(null));
    verify(dSLContext)
  ...
  void testFindDatatypeUsageCharacteristics7() throws DataAccessException {
    // Arrange
  ...
  void testFindByLogicalFlowIdSelector() {
    ...
    assertThrows(
        UnsupportedOperationException.class,
        () -> physicalSpecDecoratorDao.findByLogicalFlowIdSelector(mock(Select.class)));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows2() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows4() throws DataAccessException {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows5() throws SQLException {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows6() throws SQLException {
    // Arrange
    PreparedStatement preparedStatement = mock(PreparedStatement.class);
    when(preparedStatement.execute()).thenReturn(true);
    when(preparedStatement.getWarnings()).thenReturn(new SQLWarning());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows7() throws SQLException {
    // Arrange
    PreparedStatement preparedStatement = mock(PreparedStatement.class);
    when(preparedStatement.execute()).thenReturn(true);
    when(preparedStatement.getWarnings()).thenReturn(new SQLWarning());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows8() throws SQLException {
    // Arrange
    PreparedStatement preparedStatement = mock(PreparedStatement.class);
    when(preparedStatement.execute()).thenReturn(true);
    when(preparedStatement.getWarnings()).thenReturn(new SQLWarning());
    ...
    verify(connection)
        .prepareStatement(
            "insert into \"logical_flow_decorator\" (\"logical_flow_id\", \"decorator_entity_kind\", \"decorator_entity_id\", \"rating\", \"provenance\", \"last_updated_at\", \"last_updated_by\") select distinct \"physical_flow\".\"logical_flow_id\", ?, \"physical_spec_data_type\".\"data_type_id\", ?, ?, cast(? as timestamp), ? from \"physical_spec_data_type\" join \"data_type\" on (\"physical_spec_data_type\".\"data_type_id\" = \"data_type\".\"id\" and \"data_type\".\"unknown\" = false and \"data_type\".\"deprecated\" = false) join \"physical_specification\" on (\"physical_spec_data_type\".\"specification_id\" = \"physical_specification\".\"id\" and \"physical_specification\".\"is_removed\" = false) join \"physical_flow\" on (\"physical_spec_data_type\".\"specification_id\" = \"physical_flow\".\"specification_id\" and \"physical_flow\".\"is_removed\" = false and \"physical_flow\".\"entity_lifecycle_status\" = ?) join \"logical_flow\" on (\"physical_flow\".\"logical_flow_id\" = \"logical_flow\".\"id\" and \"logical_flow\".\"is_removed\" = false and \"logical_flow\".\"entity_lifecycle_status\" = ?) left outer join \"logical_flow_decorator\" on (\"logical_flow_decorator\".\"logical_flow_id\" = \"logical_flow\".\"id\" and \"logical_flow_decorator\".\"decorator_entity_id\" = \"physical_spec_data_type\".\"data_type_id\" and \"logical_flow_decorator\".\"decorator_entity_kind\" = ?) where \"logical_flow_decorator\".\"logical_flow_id\" is null");
    verify(preparedStatement).execute();
    verify(preparedStatement, atLeast(1)).setString(anyInt(), Mockito.<String>any());
    verify(preparedStatement).setTimestamp(eq(4), isA(Timestamp.class));
    verify(preparedStatement).close();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int PhysicalSpecDecoratorDao.rippleDataTypesToLogicalFlows()"})
  void testRippleDataTypesToLogicalFlows9() throws SQLException {
    // Arrange
    PreparedStatement preparedStatement = mock(PreparedStatement.class);
    when(preparedStatement.execute()).thenReturn(true);
    when(preparedStatement.getWarnings()).thenReturn(new SQLWarning());
    ...
    verify(connection)
        .prepareStatement(
            "insert into logical_flow_decorator (logical_flow_id, decorator_entity_kind, decorator_entity_id, rating, provenance, last_updated_at, last_updated_by) select distinct physical_flow.logical_flow_id, ?, physical_spec_data_type.data_type_id, ?, ?, ?, ? from physical_spec_data_type join data_type on (physical_spec_data_type.data_type_id = data_type.id and data_type.unknown = 0 and data_type.deprecated = 0) join physical_specification on (physical_spec_data_type.specification_id = physical_specification.id and physical_specification.is_removed = 0) join physical_flow on (physical_spec_data_type.specification_id = physical_flow.specification_id and physical_flow.is_removed = 0 and physical_flow.entity_lifecycle_status = ?) join logical_flow on (physical_flow.logical_flow_id = logical_flow.id and logical_flow.is_removed = 0 and logical_flow.entity_lifecycle_status = ?) left outer join logical_flow_decorator on (logical_flow_decorator.logical_flow_id = logical_flow.id and logical_flow_decorator.decorator_entity_id = physical_spec_data_type.data_type_id and logical_flow_decorator.decorator_entity_kind = ?) where logical_flow_decorator.logical_flow_id is null");
    verify(preparedStatement).execute();
    verify(preparedStatement, atLeast(1)).setString(anyInt(), Mockito.<String>any());
    verify(preparedStatement).close();
    verify(preparedStatement).getWarnings();
