...
class EntityEnumValueDaoDiffblueTest {
  @Mock private DSLContext dSLContext;

  @InjectMocks private EntityEnumValueDao entityEnumValueDao;

  /**
   * Test {@link EntityEnumValueDao#findByEntity(EntityReference)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link EntityEnumValueDao#findByEntity(EntityReference)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List EntityEnumValueDao.findByEntity(EntityReference)"})
  void testFindByEntity_givenSelectConditionStepFetchReturnArrayList_thenReturnEmpty()
    ...
    // Act
    List<EntityEnumValue> actualFindByEntityResult =
        entityEnumValueDao.findByEntity(
