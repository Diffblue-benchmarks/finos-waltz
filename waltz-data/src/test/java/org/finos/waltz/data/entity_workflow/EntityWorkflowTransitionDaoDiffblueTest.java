...
class EntityWorkflowTransitionDaoDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test findForEntityReferenceAndWorkflowId(long, EntityReference); then calls id()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List EntityWorkflowTransitionDao.findForEntityReferenceAndWorkflowId(long, EntityReference)"
  })
  void testFindForEntityReferenceAndWorkflowId_thenCallsId() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
    ...
    EntityWorkflowTransitionDao entityWorkflowTransitionDao = new EntityWorkflowTransitionDao(dsl);
