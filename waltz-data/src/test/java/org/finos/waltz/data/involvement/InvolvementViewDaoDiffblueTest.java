...
class InvolvementViewDaoDiffblueTest {
  ...
  void testFindAllInvolvements() throws MappingException {
    ...
    when(dsl.select(Mockito.<Collection<SelectFieldOrAsterisk>>any())).thenReturn(selectSelectStep);
    InvolvementViewDao involvementViewDao = new InvolvementViewDao(dsl);
    ...
    // Assert
    verify(dsl).select(isA(Collection.class));
   ...
   *
   * <ul>
   *   <li>Then calls {@link SelectOrderByStep#fetchGroups(RecordMapper, RecordMapper)}.
   * </ul>
   *
   * <p>Method under test: {@link InvolvementViewDao#findAllInvolvements(EntityReference)}
   */
  @Test
  @DisplayName(
      "Test findAllInvolvements(EntityReference); then calls fetchGroups(RecordMapper, RecordMapper)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Map InvolvementViewDao.findAllInvolvements(EntityReference)"})
  void testFindAllInvolvements_thenCallsFetchGroups() throws MappingException {
    // Arrange
    ...
    // Assert
    verify(dsl, atLeast(1)).select(isA(Collection.class));
  ...
  void testMkInvolvementApiQuery() {
    ...
    // Act
    InvolvementViewDao.mkInvolvementApiQuery(dsl, ref);
   ...
   *
   * <ul>
   *   <li>Given {@link DSLContext} {@link DSLContext#select(Collection)} return {@link
   *       SelectSelectStep}.
   * </ul>
   *
   * <p>Method under test: {@link InvolvementViewDao#mkInvolvementApiQuery(DSLContext,
  ...
  @Test
  @DisplayName(
      "Test mkInvolvementApiQuery(DSLContext, EntityReference); given DSLContext select(Collection) return SelectSelectStep")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Select InvolvementViewDao.mkInvolvementApiQuery(DSLContext, EntityReference)"
  })
  void testMkInvolvementApiQuery_givenDSLContextSelectReturnSelectSelectStep() {
    // Arrange
    SelectOnConditionStep<Record> selectOnConditionStep = mock(SelectOnConditionStep.class);
    when(selectOnConditionStep.where(Mockito.<Condition>any()))
        .thenReturn(mock(SelectConditionStep.class));
  ...
  void testMkInvolvementExtractorQuery() {
    ...
    // Act
    InvolvementViewDao.mkInvolvementExtractorQuery(dsl, ref);
  ...
  @Test
  @DisplayName(
      "Test mkInvolvementExtractorQuery(DSLContext, EntityReference); given DSLContext select(Collection) return SelectSelectStep")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Select InvolvementViewDao.mkInvolvementExtractorQuery(DSLContext, EntityReference)"
  })
  void testMkInvolvementExtractorQuery_givenDSLContextSelectReturnSelectSelectStep() {
    // Arrange
    SelectOnConditionStep<Record> selectOnConditionStep = mock(SelectOnConditionStep.class);
    when(selectOnConditionStep.where(Mockito.<Condition>any()))
        .thenReturn(mock(SelectConditionStep.class));
