...
class LegalEntitySearchDaoDiffblueTest {
  ...
  void testSearch() throws DataAccessException {
    ...
    LegalEntitySearchDao legalEntitySearchDao = new LegalEntitySearchDao(dsl);
  ...
  void testSearch2() {
    // Arrange
    LegalEntitySearchDao legalEntitySearchDao = new LegalEntitySearchDao(mock(DSLContext.class));
