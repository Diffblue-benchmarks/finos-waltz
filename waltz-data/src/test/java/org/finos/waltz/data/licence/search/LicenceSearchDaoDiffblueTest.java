...
class LicenceSearchDaoDiffblueTest {
  @Mock private DSLContext dSLContext;

  @InjectMocks private LicenceSearchDao licenceSearchDao;

  /**
   * Test {@link LicenceSearchDao#search(EntitySearchOptions)}.
   *
   * <p>Method under test: {@link LicenceSearchDao#search(EntitySearchOptions)}
   */
  @Test
  @DisplayName("Test search(EntitySearchOptions)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List LicenceSearchDao.search(EntitySearchOptions)"})
  void testSearch() throws DataAccessException {
    ...
    LicenceSearchDao licenceSearchDao = new LicenceSearchDao(dsl);

    Builder builderResult = ImmutableEntitySearchOptions.builder();

    // Act
    List<Licence> actualSearchResult =
        licenceSearchDao.search(
            builderResult
  ...
  void testSearch2() {
    // Arrange
    LicenceSearchDao licenceSearchDao = new LicenceSearchDao(mock(DSLContext.class));
  ...
  void testSearch_givenOne_whenEntitySearchOptionsLimitReturnOne_thenCallsLimit()
    ...
    // Act
    List<Licence> actualSearchResult = licenceSearchDao.search(options);
