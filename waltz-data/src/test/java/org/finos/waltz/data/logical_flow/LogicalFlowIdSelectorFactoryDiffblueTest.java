...
class LogicalFlowIdSelectorFactoryDiffblueTest {
  /**
   * Test {@link LogicalFlowIdSelectorFactory#apply(IdSelectionOptions)} with {@code IdSelectionOptions}.
   * <p>
   * Method under test: {@link LogicalFlowIdSelectorFactory#apply(IdSelectionOptions)}
   */
  @Test
  ...
  void testApplyWithIdSelectionOptions() {
    ...
    // Act and Assert
    assertThrows(UnsupportedOperationException.class, () -> logicalFlowIdSelectorFactory.apply(options));
  ...
  /**
   * Test new {@link LogicalFlowIdSelectorFactory} (default constructor).
   * <ul>
   *   <li>Then calls {@link EntityReference#id()}.</li>
   * </ul>
   * <p>
   * Method under test: default or parameterless constructor of {@link LogicalFlowIdSelectorFactory}
   */
  @Test
  @DisplayName("Test new LogicalFlowIdSelectorFactory (default constructor); then calls id()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LogicalFlowIdSelectorFactory.<init>()"})
  void testNewLogicalFlowIdSelectorFactory_thenCallsId() {
    // Arrange and Act
    LogicalFlowIdSelectorFactory actualLogicalFlowIdSelectorFactory = new LogicalFlowIdSelectorFactory();
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.id()).thenReturn(1L);
    when(entityReference.kind()).thenReturn(EntityKind.ACTOR);
    IdSelectionOptions options = mock(IdSelectionOptions.class);
    when(options.scope()).thenReturn(HierarchyQueryScope.EXACT);
    when(options.entityReference()).thenReturn(entityReference);
    actualLogicalFlowIdSelectorFactory.apply(options);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void LogicalFlowIdSelectorFactory.<init>()"})
  void testNewLogicalFlowIdSelectorFactory_thenCallsId2() {
    // Arrange and Act
    LogicalFlowIdSelectorFactory actualLogicalFlowIdSelectorFactory = new LogicalFlowIdSelectorFactory();
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.id()).thenReturn(1L);
