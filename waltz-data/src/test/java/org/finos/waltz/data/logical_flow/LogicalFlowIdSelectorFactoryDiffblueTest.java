...
class LogicalFlowIdSelectorFactoryDiffblueTest {
  /**
   * Method under test:
   * {@link LogicalFlowIdSelectorFactory#apply(IdSelectionOptions)}
   */
  @Test
  void testApply() {
    // Arrange
   ...
   * {@link LogicalFlowIdSelectorFactory}
   */
  @Test
  void testNewLogicalFlowIdSelectorFactory() {
    // Arrange and Act
   ...
   */
  @Test
  void testNewLogicalFlowIdSelectorFactory2() {
    // Arrange and Act
    LogicalFlowIdSelectorFactory actualLogicalFlowIdSelectorFactory = new LogicalFlowIdSelectorFactory();
    EntityReference entityReference = mock(EntityReference.class);
    when(entityReference.id()).thenReturn(1L);
