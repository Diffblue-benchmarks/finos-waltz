...
class MariaMeasurableSearchDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link MariaMeasurableSearch#searchFullText(DSLContext, EntitySearchOptions)}
   */
  @Test
  @DisplayName("Test searchFullText(DSLContext, EntitySearchOptions); given ResultSet getBoolean(int) return 'true'; then return size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List MariaMeasurableSearch.searchFullText(DSLContext, EntitySearchOptions)"})
  void testSearchFullText_givenResultSetGetBooleanReturnTrue_thenReturnSizeIsOne() throws SQLException {
    // Arrange
