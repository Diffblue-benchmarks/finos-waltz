...
class PostgresMeasurableSearchDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link PostgresMeasurableSearch#searchFullText(DSLContext,
   * EntitySearchOptions)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List PostgresMeasurableSearch.searchFullText(DSLContext, EntitySearchOptions)"
  })
  void testSearchFullText_givenActive_whenBuilderAddEntityLifecycleStatusesActive()
    ...
    List<Measurable> actualSearchFullTextResult =
        postgresMeasurableSearch.searchFullText(
            dsl,
            builderResult
