...
class MeasurableRatingIdSelectorFactoryDiffblueTest {
  /**
   * Test {@link MeasurableRatingIdSelectorFactory#apply(IdSelectionOptions)} with {@code IdSelectionOptions}.
   * <p>
   * Method under test: {@link MeasurableRatingIdSelectorFactory#apply(IdSelectionOptions)}
   */
  @Test
