...
class OrganisationalUnitDaoDiffblueTest {
  ...
  @InjectMocks private OrganisationalUnitDao organisationalUnitDao;
  ...
  void testFindAll() throws DataAccessException {
    ...
    // Act
    List<OrganisationalUnit> actualFindAllResult = organisationalUnitDao.findAll();
  ...
  void testUpdateDescription_thenReturnIntValueIsOne() throws DataAccessException {
    ...
    when(dSLContext.update(Mockito.<Table<OrganisationalUnitRecord>>any()))
        .thenReturn(updateSetFirstStep);

    // Act
    Integer actualUpdateDescriptionResult =
        organisationalUnitDao.updateDescription(1L, "The characteristics of someone or something");
  ...
  void testFindByIds() throws DataAccessException {
    ...
    // Act
    List<OrganisationalUnit> actualFindByIdsResult = organisationalUnitDao.findByIds();
   ...
   */
  @Test
  @DisplayName("Test findByIds(Long[]); when one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List OrganisationalUnitDao.findByIds(Long[])"})
  void testFindByIds_whenOne() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
    ...
    // Act
    List<OrganisationalUnit> actualFindByIdsResult = organisationalUnitDao.findByIds(1L);
   ...
   */
  @Test
  @DisplayName("Test findByIds(Long[]); when one and two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List OrganisationalUnitDao.findByIds(Long[])"})
  void testFindByIds_whenOneAndTwo() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
    ...
    // Act
    List<OrganisationalUnit> actualFindByIdsResult = organisationalUnitDao.findByIds(1L, 2L);
