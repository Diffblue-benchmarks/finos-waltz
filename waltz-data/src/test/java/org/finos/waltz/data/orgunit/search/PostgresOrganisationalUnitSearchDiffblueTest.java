...
class PostgresOrganisationalUnitSearchDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link PostgresOrganisationalUnitSearch#searchFullText(DSLContext,
   * EntitySearchOptions)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List PostgresOrganisationalUnitSearch.searchFullText(DSLContext, EntitySearchOptions)"
  })
  void testSearchFullText_thenReturnEmpty() throws DataAccessException {
    // Arrange
    PostgresOrganisationalUnitSearch postgresOrganisationalUnitSearch =
        new PostgresOrganisationalUnitSearch();
    ...
    List<OrganisationalUnit> actualSearchFullTextResult =
        postgresOrganisationalUnitSearch.searchFullText(
            dsl,
            builderResult
