...
class PhysicalSpecificationSearchDaoDiffblueTest {
  ...
  void testSearch() throws DataAccessException {
    ...
    PhysicalSpecificationSearchDao physicalSpecificationSearchDao =
        new PhysicalSpecificationSearchDao(dsl);
  ...
  void testSearch2() {
    // Arrange
    PhysicalSpecificationSearchDao physicalSpecificationSearchDao =
        new PhysicalSpecificationSearchDao(mock(DSLContext.class));
