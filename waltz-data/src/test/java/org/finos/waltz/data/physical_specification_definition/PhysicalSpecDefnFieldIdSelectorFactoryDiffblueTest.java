...
class PhysicalSpecDefnFieldIdSelectorFactoryDiffblueTest {
  /**
   * Test {@link PhysicalSpecDefnFieldIdSelectorFactory#apply(IdSelectionOptions)} with {@code
   * IdSelectionOptions}.
   *
   * <p>Method under test: {@link PhysicalSpecDefnFieldIdSelectorFactory#apply(IdSelectionOptions)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.jooq.Select PhysicalSpecDefnFieldIdSelectorFactory.apply(IdSelectionOptions)"
  })
  void testApplyWithIdSelectionOptions() {
    // Arrange
    PhysicalSpecDefnFieldIdSelectorFactory physicalSpecDefnFieldIdSelectorFactory =
        new PhysicalSpecDefnFieldIdSelectorFactory();
    ...
    assertThrows(
        ...
        () ->
            physicalSpecDefnFieldIdSelectorFactory.apply(
