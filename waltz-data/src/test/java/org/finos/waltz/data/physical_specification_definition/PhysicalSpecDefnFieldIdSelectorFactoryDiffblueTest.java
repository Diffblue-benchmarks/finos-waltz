...
class PhysicalSpecDefnFieldIdSelectorFactoryDiffblueTest {
  /**
   * Test {@link PhysicalSpecDefnFieldIdSelectorFactory#apply(IdSelectionOptions)} with {@code IdSelectionOptions}.
   * <p>
   * Method under test: {@link PhysicalSpecDefnFieldIdSelectorFactory#apply(IdSelectionOptions)}
   */
  @Test
  @DisplayName("Test apply(IdSelectionOptions) with 'IdSelectionOptions'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"org.jooq.Select PhysicalSpecDefnFieldIdSelectorFactory.apply(IdSelectionOptions)"})
