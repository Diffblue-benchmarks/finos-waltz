...
class SqlServerServerInformationSearchDiffblueTest {
  /**
   * Test {@link SqlServerServerInformationSearch#searchFullText(DSLContext, EntitySearchOptions)}.
   *
   * <p>Method under test: {@link SqlServerServerInformationSearch#searchFullText(DSLContext,
   * EntitySearchOptions)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List SqlServerServerInformationSearch.searchFullText(DSLContext, EntitySearchOptions)"
  })
  void testSearchFullText() throws DataAccessException {
    // Arrange
    SqlServerServerInformationSearch sqlServerServerInformationSearch =
        new SqlServerServerInformationSearch();
    ...
    List<ServerInformation> actualSearchFullTextResult =
        sqlServerServerInformationSearch.searchFullText(
            dsl,
            builderResult
