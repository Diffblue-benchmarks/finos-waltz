...
class SqlServerServerInformationSearchDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SqlServerServerInformationSearch#searchFullText(DSLContext, EntitySearchOptions)}
   */
  @Test
  @DisplayName("Test searchFullText(DSLContext, EntitySearchOptions); given ResultSet next() return 'false'; then return Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List SqlServerServerInformationSearch.searchFullText(DSLContext, EntitySearchOptions)"})
