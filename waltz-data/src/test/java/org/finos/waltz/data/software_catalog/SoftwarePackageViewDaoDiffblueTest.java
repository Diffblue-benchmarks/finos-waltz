...
class SoftwarePackageViewDaoDiffblueTest {
  ...
  void testFindByIdsWithLong() throws DataAccessException {
    ...
    // Act
    List<SoftwarePackageView> actualFindByIdsResult = softwarePackageViewDao.findByIds();
  ...
  void testFindByIdsWithLong_whenOne() throws DataAccessException {
    ...
    // Act
    List<SoftwarePackageView> actualFindByIdsResult = softwarePackageViewDao.findByIds(1L);
  ...
  void testFindByIdsWithLong_whenOneAndTwo() throws DataAccessException {
    ...
    // Act
    List<SoftwarePackageView> actualFindByIdsResult = softwarePackageViewDao.findByIds(1L, 2L);
  ...
  void testFindByExternalIds() throws DataAccessException {
    ...
    List<SoftwarePackageView> actualFindByExternalIdsResult =
        softwarePackageViewDao.findByExternalIds();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List SoftwarePackageViewDao.findByExternalIds(String[])"})
  void testFindByExternalIds2() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
    ...
    List<SoftwarePackageView> actualFindByExternalIdsResult =
        softwarePackageViewDao.findByExternalIds(
            "External Ids", "org.finos.waltz.data.software_catalog.SoftwarePackageViewDao");
   ...
   *
   * <ul>
   *   <li>When {@code External Ids}.
   * </ul>
   *
   * <p>Method under test: {@link SoftwarePackageViewDao#findByExternalIds(String[])}
   */
  @Test
  @DisplayName("Test findByExternalIds(String[]); when 'External Ids'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List SoftwarePackageViewDao.findByExternalIds(String[])"})
  void testFindByExternalIds_whenExternalIds() throws DataAccessException {
    // Arrange
    SelectConditionStep<Record> selectConditionStep = mock(SelectConditionStep.class);
    when(selectConditionStep.fetch(Mockito.<RecordMapper<Record, Object>>any()))
        .thenReturn(new ArrayList<>());
    ...
    // Act
    List<SoftwarePackageView> actualFindByExternalIdsResult =
        softwarePackageViewDao.findByExternalIds("External Ids");
  ...
  void testFindAll() throws DataAccessException {
    ...
    // Act
    List<SoftwarePackageView> actualFindAllResult = softwarePackageViewDao.findAll();
