...
class SurveyQuestionDropdownEntryDaoDiffblueTest {
  ...
  @InjectMocks private SurveyQuestionDropdownEntryDao surveyQuestionDropdownEntryDao;
  ...
  void testFindForQuestion() throws DataAccessException {
    ...
    List<SurveyQuestionDropdownEntry> actualFindForQuestionResult =
        surveyQuestionDropdownEntryDao.findForQuestion(1L);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SurveyQuestionDropdownEntryDao.saveEntries(long, Collection)"})
  void testSaveEntries_givenDSLContextTransactionDoesNothing_thenCallsTransaction2() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SurveyQuestionDropdownEntryDao.saveEntries(long, Collection)"})
  void testSaveEntries_givenDSLContextTransactionDoesNothing_thenCallsTransaction3() {
    // Arrange
    doNothing().when(dSLContext).transaction(Mockito.<TransactionalRunnable>any());
  ...
  void testDeleteForTemplate_givenDeleteConditionStepExecuteReturnOne_thenReturnOne()
    ...
    when(dSLContext.deleteFrom(Mockito.<Table<SurveyQuestionDropdownEntryRecord>>any()))
        .thenReturn(deleteUsingStep);

    // Act
    int actualDeleteForTemplateResult = surveyQuestionDropdownEntryDao.deleteForTemplate(1L);
