...
class SurveyViewDaoDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link SurveyViewDao#getById(long)}
   */
  @Test
  @DisplayName("Test getById(long); given ResultSet getInt(int) return one; then calls getInt(int)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"SurveyInstanceInfo SurveyViewDao.getById(long)"})
  void testGetById_givenResultSetGetIntReturnOne_thenCallsGetInt() throws SQLException {
    // Arrange
    ...
    // Act
    SurveyInstanceInfo actualById = (new SurveyViewDao(new DefaultDSLContext(connection, SQLDialect.SQL99)))
        .getById(1L);
   ...
   */
  @Test
  @DisplayName("Test getById(long); given ResultSet getLong(int) return one; then return 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"SurveyInstanceInfo SurveyViewDao.getById(long)"})
  void testGetById_givenResultSetGetLongReturnOne_thenReturnNull() throws SQLException {
    // Arrange
    ResultSet resultSet = mock(ResultSet.class);
    when(resultSet.getLong(anyInt())).thenReturn(1L);
   ...
   */
  @Test
  @DisplayName("Test getById(long); given ResultSet wasNull() return 'true'; then calls wasNull()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"SurveyInstanceInfo SurveyViewDao.getById(long)"})
  void testGetById_givenResultSetWasNullReturnTrue_thenCallsWasNull() throws SQLException {
    // Arrange
    ResultSet resultSet = mock(ResultSet.class);
