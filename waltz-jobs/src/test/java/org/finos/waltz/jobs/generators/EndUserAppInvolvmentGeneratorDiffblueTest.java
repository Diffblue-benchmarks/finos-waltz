...
class EndUserAppInvolvmentGeneratorDiffblueTest {
  /**
   * Test {@link EndUserAppInvolvmentGenerator#remove(ApplicationContext)}.
   * <ul>
   *   <li>Given {@link DeleteConditionStep} {@link Query#execute()} return one.</li>
   *   <li>Then return {@code true}.</li>
   * </ul>
   * <p>
   * Method under test: {@link EndUserAppInvolvmentGenerator#remove(ApplicationContext)}
   */
  @Test
  @DisplayName("Test remove(ApplicationContext); given DeleteConditionStep execute() return one; then return 'true'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean EndUserAppInvolvmentGenerator.remove(ApplicationContext)"})
  void testRemove_givenDeleteConditionStepExecuteReturnOne_thenReturnTrue() throws DataAccessException, BeansException {
    // Arrange
    EndUserAppInvolvmentGenerator endUserAppInvolvmentGenerator = new EndUserAppInvolvmentGenerator();
    ...
    // Act
    boolean actualRemoveResult = endUserAppInvolvmentGenerator.remove(ctx);
