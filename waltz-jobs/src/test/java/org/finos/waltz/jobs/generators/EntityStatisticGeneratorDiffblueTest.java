...
class EntityStatisticGeneratorDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link EntityStatisticGenerator#remove(ApplicationContext)}
   */
  @Test
  @DisplayName(
  ...
  void testRemove_givenPreparedStatementExecuteReturnTrue_thenReturnFalse()
    ...
    verify(connection)
        .prepareStatement(
            "delete from \"entity_statistic_definition\" where \"entity_statistic_definition\".\"provenance\" = ?");
