...
class LegalEntityGeneratorDiffblueTest {
  /**
   * Test {@link LegalEntityGenerator#remove(ApplicationContext)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link LegalEntityGenerator#remove(ApplicationContext)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean LegalEntityGenerator.remove(ApplicationContext)"})
