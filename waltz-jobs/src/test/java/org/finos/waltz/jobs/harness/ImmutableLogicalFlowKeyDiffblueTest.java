...
class ImmutableLogicalFlowKeyDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder src(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.src(EntityReference)"})
  void testBuilderSrc_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableLogicalFlowKey.builder();

    // Act
    Builder actualSrcResult =
        builderResult.src(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
   ...
   */
  @Test
  @DisplayName("Test Builder trg(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.trg(EntityReference)"})
  void testBuilderTrg_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableLogicalFlowKey.builder();

    // Act
    Builder actualTrgResult =
        builderResult.trg(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
