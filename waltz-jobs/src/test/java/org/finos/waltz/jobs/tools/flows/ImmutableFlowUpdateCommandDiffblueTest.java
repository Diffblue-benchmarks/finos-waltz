...
class ImmutableFlowUpdateCommandDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder dataTypeRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.dataTypeRef(EntityReference)"})
  void testBuilderDataTypeRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableFlowUpdateCommand.builder();

    // Act
    Builder actualDataTypeRefResult =
        builderResult.dataTypeRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
   ...
   */
  @Test
  @DisplayName("Test Builder sourceEntityRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.sourceEntityRef(EntityReference)"})
  void testBuilderSourceEntityRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableFlowUpdateCommand.builder();

    // Act
    Builder actualSourceEntityRefResult =
        builderResult.sourceEntityRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
   ...
   */
  @Test
  @DisplayName("Test Builder targetEntityRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.targetEntityRef(EntityReference)"})
  void testBuilderTargetEntityRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableFlowUpdateCommand.builder();

    // Act
    Builder actualTargetEntityRefResult =
        builderResult.targetEntityRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
