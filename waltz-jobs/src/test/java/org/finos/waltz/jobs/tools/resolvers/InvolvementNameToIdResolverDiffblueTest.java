...
class InvolvementNameToIdResolverDiffblueTest {
  /**
   * Method under test:
   * {@link InvolvementNameToIdResolver#InvolvementNameToIdResolver(DSLContext)}
   */
  @Test
  void testNewInvolvementNameToIdResolver() throws SQLException {
    // Arrange
   ...
   */
  @Test
  void testNewInvolvementNameToIdResolver2() throws SQLException {
    // Arrange
    ResultSet resultSet = mock(ResultSet.class);
   ...
   */
  @Test
  void testNewInvolvementNameToIdResolver3() throws SQLException {
    // Arrange
    ResultSet resultSet = mock(ResultSet.class);
  ...
  /**
   * Method under test: {@link InvolvementNameToIdResolver#resolve(String)}
   */
  @Test
  void testResolve() throws SQLException {
    ...
    // Act
    Optional<Long> actualResolveResult = (new InvolvementNameToIdResolver(
