...
class ImmutableSectionDupeConfigDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return build targets size is two.
   * </ul>
   *
   * <p>Method under test: {@link Builder#from(SectionDupeConfig)}
   */
  @Test
  @DisplayName("Test Builder from(SectionDupeConfig); then return build targets size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.from(SectionDupeConfig)"})
  void testBuilderFrom_thenReturnBuildTargetsSizeIsTwo() {
    // Arrange
    Builder builderResult = ImmutableSectionDupeConfig.builder();
    ...
    ImmutableList<TargetSectionConfig> targetsResult =
        builderResult
            ...
            .build()
            .targets();
    assertEquals(2, targetsResult.size());
    TargetSectionConfig getResult = targetsResult.get(0);
    assertTrue(getResult instanceof ImmutableTargetSectionConfig);
    TargetSectionConfig getResult2 = targetsResult.get(1);
    assertTrue(getResult2 instanceof ImmutableTargetSectionConfig);
    assertEquals("Ext Id Prefix", getResult.extIdPrefix());
    assertEquals("Name", getResult.name());
  ...
  void testWithTargetsWithIterable() {
    ...
    Iterable<TargetSectionConfig> elements = mock(Iterable.class);

    ArrayList<TargetSectionConfig> targetSectionConfigList = new ArrayList<>();
    when(elements.iterator()).thenReturn(targetSectionConfigList.iterator());

    // Act
    ImmutableSectionDupeConfig actualWithTargetsResult =
        immutableSectionDupeConfig.withTargets(elements);
   ...
   *
   * <ul>
   *   <li>Then return targets size is four.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableSectionDupeConfig#withTargets(Iterable)}
   */
  @Test
  @DisplayName("Test withTargets(Iterable) with 'Iterable'; then return targets size is four")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSectionDupeConfig ImmutableSectionDupeConfig.withTargets(Iterable)"})
  void testWithTargetsWithIterable_thenReturnTargetsSizeIsFour() {
    // Arrange
    Builder sectionNameResult = ImmutableSectionDupeConfig.builder().sectionName("Section Name");
    ImmutableSectionDupeConfig immutableSectionDupeConfig =
        sectionNameResult.targets(new ArrayList<>()).build();
    ...
    assertEquals(4, targetsResult.size());
    TargetSectionConfig getResult = targetsResult.get(2);
    assertTrue(getResult instanceof ImmutableTargetSectionConfig);
    TargetSectionConfig getResult2 = targetsResult.get(3);
    assertTrue(getResult2 instanceof ImmutableTargetSectionConfig);
    TargetSectionConfig getResult3 = targetsResult.get(0);
   ...
   */
  @Test
  @DisplayName("Test withTargets(Iterable) with 'Iterable'; then return targets size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSectionDupeConfig ImmutableSectionDupeConfig.withTargets(Iterable)"})
  void testWithTargetsWithIterable_thenReturnTargetsSizeIsOne() {
    // Arrange
    Builder sectionNameResult = ImmutableSectionDupeConfig.builder().sectionName("Section Name");
    ImmutableSectionDupeConfig immutableSectionDupeConfig =
        sectionNameResult.targets(new ArrayList<>()).build();
   ...
   *
   * <ul>
   *   <li>Then return targets size is three.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableSectionDupeConfig#withTargets(Iterable)}
   */
  @Test
  @DisplayName("Test withTargets(Iterable) with 'Iterable'; then return targets size is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSectionDupeConfig ImmutableSectionDupeConfig.withTargets(Iterable)"})
  void testWithTargetsWithIterable_thenReturnTargetsSizeIsThree() {
    // Arrange
    Builder sectionNameResult = ImmutableSectionDupeConfig.builder().sectionName("Section Name");
    ImmutableSectionDupeConfig immutableSectionDupeConfig =
        sectionNameResult.targets(new ArrayList<>()).build();
    ...
    verify(elements).iterator();
    ImmutableList<TargetSectionConfig> targetsResult = actualWithTargetsResult.targets();
    assertEquals(3, targetsResult.size());
    TargetSectionConfig getResult = targetsResult.get(1);
    assertTrue(getResult instanceof ImmutableTargetSectionConfig);
    TargetSectionConfig getResult2 = targetsResult.get(2);
    assertTrue(getResult2 instanceof ImmutableTargetSectionConfig);
    TargetSectionConfig getResult3 = targetsResult.get(0);
    assertEquals(getResult3, getResult);
    assertEquals(getResult3, getResult2);
   ...
   */
  @Test
  @DisplayName("Test withTargets(Iterable) with 'Iterable'; then return targets size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSectionDupeConfig ImmutableSectionDupeConfig.withTargets(Iterable)"})
  void testWithTargetsWithIterable_thenReturnTargetsSizeIsTwo() {
    // Arrange
    Builder sectionNameResult = ImmutableSectionDupeConfig.builder().sectionName("Section Name");
    ImmutableSectionDupeConfig immutableSectionDupeConfig =
        sectionNameResult.targets(new ArrayList<>()).build();
   ...
   */
  @Test
  @DisplayName("Test withTargets(Iterable) with 'Iterable'; when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSectionDupeConfig ImmutableSectionDupeConfig.withTargets(Iterable)"})
  void testWithTargetsWithIterable_whenArrayList() {
    // Arrange
    Builder sectionNameResult = ImmutableSectionDupeConfig.builder().sectionName("Section Name");
    ImmutableSectionDupeConfig immutableSectionDupeConfig =
        sectionNameResult.targets(new ArrayList<>()).build();
