...
class TargetSectionConfigDiffblueTest {
   ...
   *
   * <p>Method under test: {@link TargetSectionConfig#mkTargetSection(String, String)}
   */
  @Test
  ...
  void testMkTargetSection() {
    // Arrange and Act
    TargetSectionConfig actualMkTargetSectionResult =
        TargetSectionConfig.mkTargetSection("42", "Name");
