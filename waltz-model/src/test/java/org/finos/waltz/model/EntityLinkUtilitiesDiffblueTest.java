...
class EntityLinkUtilitiesDiffblueTest {
  ...
  void testMkExternalIdLink63() {
    // Arrange, Act and Assert
    assertEquals(
        "/entity/ALLOCATION/external-id/Cannot convert empty or null segments to path",
        EntityLinkUtilities.mkExternalIdLink(
            "///", EntityKind.ALLOCATION, "Cannot convert empty or null segments to path"));
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code : Array was null/entity/ALLOCATION/external-id/}.
   * </ul>
   *
   * <p>Method under test: {@link EntityLinkUtilities#mkExternalIdLink(String, EntityKind, String)}
   */
  @Test
  @DisplayName(
      "Test mkExternalIdLink(String, EntityKind, String); then return ': Array was null/entity/ALLOCATION/external-id/'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String EntityLinkUtilities.mkExternalIdLink(String, EntityKind, String)"})
  void testMkExternalIdLink_thenReturnArrayWasNullEntityAllocationExternalId() {
    // Arrange, Act and Assert
    assertEquals(
        ": Array was null/entity/ALLOCATION/external-id/",
        EntityLinkUtilities.mkExternalIdLink(": Array was null", EntityKind.ALLOCATION, "///"));
  }
