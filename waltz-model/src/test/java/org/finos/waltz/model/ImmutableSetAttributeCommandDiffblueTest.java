...
class ImmutableSetAttributeCommandDiffblueTest {
   ...
   *   <li>When {@link Json} (default constructor) EntityReference is {@link
   *       ImmutableEntityReference.Json} (default constructor).
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given Json (default constructor); when Json (default constructor) EntityReference is Json (default constructor); then return name is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSetAttributeCommand ImmutableSetAttributeCommand.fromJson(Json)"})
  void testFromJson_givenJson_whenJsonEntityReferenceIsJson_thenReturnNameIsJson() {
    // Arrange
    Json json = new Json();
    json.setName("Json");
