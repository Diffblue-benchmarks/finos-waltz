...
class ImmutableWaltzVersionInfoDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code Json}.
   *   <li>When {@link Json} (default constructor) PomVersion is {@code Json}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'Json'; when Json (default constructor) PomVersion is 'Json'; then return pomVersion is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableWaltzVersionInfo ImmutableWaltzVersionInfo.fromJson(Json)"})
  void testFromJson_givenJson_whenJsonPomVersionIsJson_thenReturnPomVersionIsJson() {
    // Arrange
    Json json = new Json();
