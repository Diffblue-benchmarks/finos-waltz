...
class ImmutableAccessLogDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) CreatedAt is 'null'; then return params is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableAccessLog ImmutableAccessLog.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonCreatedAtIsNull_thenReturnParamsIsJson() {
    // Arrange
    Json json = new Json();
    json.setState("Json");
    json.setParams("Json");
