...
class ImmutableComplexityWidgetDataDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder addAllComplexityKinds(Iterable); when ArrayList(); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testFromJson_givenNull_whenJsonApplicationsIsNull_thenReturnCellDataSizeIsOne() {
    ...
    json2.setComplexityKinds(new HashSet<>());
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) CellData is 'null'; then return applications Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableComplexityWidgetData ImmutableComplexityWidgetData.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonCellDataIsNull_thenReturnApplicationsEmpty() {
    ...
    json.setComplexityKinds(new HashSet<>());
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) ComplexityKinds is 'null'; then return cellData size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableComplexityWidgetData ImmutableComplexityWidgetData.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonComplexityKindsIsNull_thenReturnCellDataSizeIsOne() {
    // Arrange
    LinkedHashSet<ComplexityWidgetDatum> cellData = new LinkedHashSet<>();
    ImmutableComplexityWidgetDatum.Json json = new ImmutableComplexityWidgetDatum.Json();
    cellData.add(json);
  ...
  void testFromJson_thenReturnApplicationsSizeIsOne() {
    // Arrange
    LinkedHashSet<ComplexityWidgetDatum> cellData = new LinkedHashSet<>();
    cellData.add(ImmutableComplexityWidgetDatum.builder().cellExternalId("42").build());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) ComplexityKinds is {@link HashSet#HashSet()}.
   *   <li>Then return cellData size is one.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableComplexityWidgetData#fromJson(Json)}
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) ComplexityKinds is HashSet(); then return cellData size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableComplexityWidgetData ImmutableComplexityWidgetData.fromJson(Json)"})
  void testFromJson_whenJsonComplexityKindsIsHashSet_thenReturnCellDataSizeIsOne() {
    // Arrange
    LinkedHashSet<ComplexityWidgetDatum> cellData = new LinkedHashSet<>();
    ImmutableComplexityWidgetDatum.Json json = new ImmutableComplexityWidgetDatum.Json();
    cellData.add(json);
