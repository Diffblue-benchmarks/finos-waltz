...
class ImmutableCostWidgetDataDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder addApplications(Application) with 'element'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addApplications(Application)"})
  void testBuilderAddApplicationsWithElement() {
    // Arrange
    Builder builderResult = ImmutableCostWidgetData.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder addApplications(Application[]) with 'elements'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addApplications(Application[])"})
  void testBuilderAddApplicationsWithElements() {
    // Arrange
    Builder builderResult = ImmutableCostWidgetData.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder addCostKinds(EntityCostKind) with 'element'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addCostKinds(EntityCostKind)"})
  void testBuilderAddCostKindsWithElement() {
    // Arrange
    Builder builderResult = ImmutableCostWidgetData.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder addCostKinds(EntityCostKind[]) with 'elements'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addCostKinds(EntityCostKind[])"})
  void testBuilderAddCostKindsWithElements() {
    // Arrange
    Builder builderResult = ImmutableCostWidgetData.builder();
   ...
   *
   * <ul>
   *   <li>Given {@link LinkedHashSet#LinkedHashSet()} add {@link EntityCostKind}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given LinkedHashSet() add EntityCostKind; then return costKinds size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableCostWidgetData ImmutableCostWidgetData.fromJson(Json)"})
   ...
   *
   * <ul>
   *   <li>Given {@link LinkedHashSet#LinkedHashSet()} add {@link Measurable}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given LinkedHashSet() add Measurable; then return measurables size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableCostWidgetData ImmutableCostWidgetData.fromJson(Json)"})
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) CostKinds is 'null'; then return applications Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableCostWidgetData ImmutableCostWidgetData.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonCostKindsIsNull_thenReturnApplicationsEmpty() {
    // Arrange
    Json json = new Json();
    json.setCellData(null);
    json.setApplications(null);
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); then return cellData size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableCostWidgetData ImmutableCostWidgetData.fromJson(Json)"})
  void testFromJson_thenReturnCellDataSizeIsOne() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then return costKinds is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableCostWidgetData#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return costKinds is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableCostWidgetData ImmutableCostWidgetData.fromJson(Json)"})
  void testFromJson_thenReturnCostKindsIsLinkedHashSet() {
    // Arrange
    LinkedHashSet<EntityCostKind> costKinds = new LinkedHashSet<>();
    costKinds.add(
        ImmutableEntityCostKind.builder()
    ...
    // Assert
    assertEquals(costKinds, actualFromJsonResult.costKinds());
  }
   ...
   *   <li>Then return costKinds is {@link Json} (default constructor) {@link Json#cellData}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableCostWidgetData#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor); then return costKinds is Json (default constructor) cellData")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableCostWidgetData ImmutableCostWidgetData.fromJson(Json)"})
