...
class ImmutableAppChangeWidgetParametersDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#from(AppChangeWidgetParameters)}
   */
  @Test
  @DisplayName("Test Builder from(AppChangeWidgetParameters); then builder build targetDate is LocalDate with '1970' and one and one")
