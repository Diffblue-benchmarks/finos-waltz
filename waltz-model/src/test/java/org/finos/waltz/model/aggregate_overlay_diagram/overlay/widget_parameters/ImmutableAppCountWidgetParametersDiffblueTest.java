...
class ImmutableAppCountWidgetParametersDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#from(AppCountWidgetParameters)}
   */
  @Test
  @DisplayName("Test Builder from(AppCountWidgetParameters); then builder build targetDate is LocalDate with '1970' and one and one")
