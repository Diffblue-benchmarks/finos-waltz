...
class MeasurableRatingPercentageDiffblueTest {
   ...
   * <p>
   * Method under test: {@link MeasurableRatingPercentage#mkMeasurableRatingPercentage(long, int)}
   */
  @Test
  @DisplayName("Test mkMeasurableRatingPercentage(long, int)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MeasurableRatingPercentage MeasurableRatingPercentage.mkMeasurableRatingPercentage(long, int)"})
