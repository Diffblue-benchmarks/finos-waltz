...
class ImmutableAppGroupBulkAddRequestDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add 'Json'; then return unknownIdentifiers size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add one; then return applicationIds size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableAppGroupBulkAddRequest ImmutableAppGroupBulkAddRequest.fromJson(Json)"
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add one; then return changeInitiativeIds size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableAppGroupBulkAddRequest ImmutableAppGroupBulkAddRequest.fromJson(Json)"
   ...
   *
   * <ul>
   *   <li>Then return unknownIdentifiers is {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableAppGroupBulkAddRequest#fromJson(Json)}
   */
  ...
  void testFromJson_thenReturnUnknownIdentifiersIsArrayList() {
    ...
    // Assert
    assertEquals(unknownIdentifiers, actualFromJsonResult.unknownIdentifiers());
  }
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) UnknownIdentifiers is 'null'; then return applicationIds Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableAppGroupBulkAddRequest ImmutableAppGroupBulkAddRequest.fromJson(Json)"
