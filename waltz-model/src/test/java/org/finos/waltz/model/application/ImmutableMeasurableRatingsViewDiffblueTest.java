...
class ImmutableMeasurableRatingsViewDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder addMeasurables(Measurable) with 'element'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addMeasurables(Measurable)"})
  void testBuilderAddMeasurablesWithElement() {
    // Arrange
    Builder builderResult = ImmutableMeasurableRatingsView.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder addMeasurables(Measurable[]) with 'elements'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addMeasurables(Measurable[])"})
  void testBuilderAddMeasurablesWithElements() {
    // Arrange
    Builder builderResult = ImmutableMeasurableRatingsView.builder();
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); then return measurableCategories Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableMeasurableRatingsView ImmutableMeasurableRatingsView.fromJson(Json)"
  })
  void testFromJson_thenReturnMeasurableCategoriesEmpty() {
    // Arrange
    Json json = new Json();
    ...
    // Assert
    Set<MeasurableCategory> measurableCategoriesResult =
        actualFromJsonResult.measurableCategories();
    assertTrue(measurableCategoriesResult.isEmpty());
  ...
  void testFromJson_thenReturnMeasurableCategoriesSizeIsOne() {
    // Arrange
    HashSet<MeasurableCategory> measurableCategories = new HashSet<>();
    ...
    Set<MeasurableHierarchy> measurableHierarchyResult = actualFromJsonResult.measurableHierarchy();
    assertTrue(measurableHierarchyResult.isEmpty());
    assertSame(measurableHierarchyResult, actualFromJsonResult.measurableRatings());
    assertSame(measurableHierarchyResult, actualFromJsonResult.measurables());
    assertSame(measurableHierarchyResult, actualFromJsonResult.ratingSchemeItems());
  }
   ...
   *
   * <ul>
   *   <li>Then return measurableHierarchy is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableMeasurableRatingsView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return measurableHierarchy is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableMeasurableRatingsView ImmutableMeasurableRatingsView.fromJson(Json)"
  })
  void testFromJson_thenReturnMeasurableHierarchyIsLinkedHashSet() {
    // Arrange
    ...
    // Assert
    assertEquals(measurableHierarchy, actualFromJsonResult.measurableHierarchy());
  }
   ...
   *
   * <ul>
   *   <li>Then return measurableHierarchy size is one.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableMeasurableRatingsView#fromJson(Json)}
   */
   ...
   *
   * <ul>
   *   <li>Then return measurableRatings size is one.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableMeasurableRatingsView#fromJson(Json)}
   */
   ...
   *   <li>Then return measurableRatings is {@link Json} (default constructor) {@link
   *       Json#measurableCategories}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableMeasurableRatingsView#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor); then return measurableRatings is Json (default constructor) measurableCategories")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableMeasurableRatingsView ImmutableMeasurableRatingsView.fromJson(Json)"
  })
  void testFromJson_whenJson_thenReturnMeasurableRatingsIsJsonMeasurableCategories() {
    // Arrange
    Json json = new Json();
    ...
    // Assert
    Set<MeasurableCategory> measurableCategorySet = json.measurableCategories;
    assertSame(measurableCategorySet, actualFromJsonResult.measurableRatings());
    assertSame(measurableCategorySet, actualFromJsonResult.measurables());
    assertSame(measurableCategorySet, actualFromJsonResult.ratingSchemeItems());
    Set<RatingSchemeItem> expectedMeasurableHierarchyResult = json.ratingSchemeItems;
    assertSame(expectedMeasurableHierarchyResult, actualFromJsonResult.measurableHierarchy());
  }
