...
class ImmutableApplicationAttestationInstanceInfoDiffblueTest {
  ...
  void testBuilderBuild() {
    ...
    ImmutableApplicationAttestationSummaryFilters.Builder builderResult =
    ...
    ImmutableApplicationAttestationSummaryFilters.Builder appCriticalityResult =
        builderResult.appCriticality(appCriticality);
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    ImmutableApplicationAttestationSummaryFilters.Builder builderResult5 =
        ImmutableApplicationAttestationSummaryFilters.builder();
    Optional<? extends Criticality> appCriticality2 = Optional.of(Criticality.LOW);

    ImmutableApplicationAttestationSummaryFilters.Builder appCriticalityResult2 =
        builderResult5.appCriticality(appCriticality2);
    Optional<? extends LifecyclePhase> appLifecyclePhase2 = Optional.of(LifecyclePhase.PRODUCTION);

    ImmutableApplicationAttestationSummaryFilters.Builder appLifecyclePhaseResult2 =
        appCriticalityResult2.appLifecyclePhase(appLifecyclePhase2);
    ...
    Builder builderResult6 = ImmutableIdSelectionOptions.builder();

    Builder filtersResult4 =
        builderResult6
            .entityReference(
                ImmutableEntityReference.builder()
                    .description("The characteristics of someone or something")
    ...
    Builder joiningEntityKindResult2 = filtersResult4.joiningEntityKind(joiningEntityKind2);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    Builder joiningEntityKindResult2 = filtersResult3.joiningEntityKind(joiningEntityKind2);
  ...
  void testWithFilters() {
    ...
    ImmutableApplicationAttestationSummaryFilters.Builder appCriticalityResult2 =
        builderResult4.appCriticality(appCriticality2);
    Optional<? extends LifecyclePhase> appLifecyclePhase2 = Optional.of(LifecyclePhase.PRODUCTION);
