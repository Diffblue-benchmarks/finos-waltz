...
class ImmutableBulkUploadRelationshipApplyResultDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) RecordsAdded is one.
   *   <li>Then return recordsAdded longValue is one.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) RecordsAdded is one; then return recordsAdded longValue is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableBulkUploadRelationshipApplyResult ImmutableBulkUploadRelationshipApplyResult.fromJson(Json)"
  })
  void testFromJson_whenJsonRecordsAddedIsOne_thenReturnRecordsAddedLongValueIsOne() {
    // Arrange
    Json json = new Json();
