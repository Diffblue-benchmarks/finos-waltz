...
class ImmutableSaveBulkUploadAssessmentStatsDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder assessmentStatistics(BulkChangeStatistics); when BulkChangeStatistics; then return builder")
  ...
  void testBuilderAssessmentStatistics_whenBulkChangeStatistics_thenReturnBuilder() {
    ...
    Builder actualAssessmentStatisticsResult =
        builderResult.assessmentStatistics(mock(BulkChangeStatistics.class));
   ...
   *
   * <ul>
   *   <li>When {@link AssessmentDefinition}.
   *   <li>Then return builder.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test Builder definition(AssessmentDefinition); when AssessmentDefinition; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderDefinition_whenAssessmentDefinition_thenReturnBuilder() {
    ...
    // Act
    Builder actualDefinitionResult = builderResult.definition(mock(AssessmentDefinition.class));
