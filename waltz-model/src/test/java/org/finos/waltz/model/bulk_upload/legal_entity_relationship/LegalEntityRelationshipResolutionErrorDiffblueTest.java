...
class LegalEntityRelationshipResolutionErrorDiffblueTest {
  /**
   * Test {@link LegalEntityRelationshipResolutionError#mkError(LegalEntityResolutionErrorCode, String)}.
   * <p>
   * Method under test: {@link LegalEntityRelationshipResolutionError#mkError(LegalEntityResolutionErrorCode, String)}
   */
  @Test
