...
class RatingResolutionErrorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link RatingResolutionError#mkError(RatingResolutionErrorCode, String)}
   */
  @Test
  @DisplayName("Test mkError(RatingResolutionErrorCode, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"RatingResolutionError RatingResolutionError.mkError(RatingResolutionErrorCode, String)"})
  void testMkError() {
    // Arrange and Act
