...
class ImmutableChangeInitiativeViewDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then builder build ratings size is one.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test Builder addRatings(AssessmentRating) with 'element'; then builder build ratings size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test Builder addRatings(AssessmentRating[]) with 'elements'; then builder build ratings size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addRatings(AssessmentRating[])"})
  ...
  void testFromJson_thenReturnAssessmentDefinitionsSizeIsOne() {
    // Arrange
    LinkedHashSet<ChangeInitiative> changeInitiatives = new LinkedHashSet<>();
   ...
   *
   * <ul>
   *   <li>Then return changeInitiatives is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableChangeInitiativeView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return changeInitiatives is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableChangeInitiativeView ImmutableChangeInitiativeView.fromJson(Json)"})
  void testFromJson_thenReturnChangeInitiativesIsLinkedHashSet() {
    // Arrange
    LinkedHashSet<ChangeInitiative> changeInitiatives = new LinkedHashSet<>();
    ...
    Json json = new Json();
    json.setChangeInitiatives(changeInitiatives);
    json.setAssessmentDefinitions(new HashSet<>());
    json.setRatingSchemeItems(new HashSet<>());
    json.setRatings(new HashSet<>());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) AssessmentDefinitions is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableChangeInitiativeView#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) AssessmentDefinitions is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableChangeInitiativeView ImmutableChangeInitiativeView.fromJson(Json)"})
  void testFromJson_whenJsonAssessmentDefinitionsIsNull() {
    // Arrange
    LinkedHashSet<ChangeInitiative> changeInitiatives = new LinkedHashSet<>();
    changeInitiatives.add(new ImmutableChangeInitiative.Json());
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); when Json (default constructor) RatingSchemeItems is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableChangeInitiativeView ImmutableChangeInitiativeView.fromJson(Json)"})
  void testFromJson_whenJsonRatingSchemeItemsIsNull() {
    // Arrange
    LinkedHashSet<ChangeInitiative> changeInitiatives = new LinkedHashSet<>();
    changeInitiatives.add(new ImmutableChangeInitiative.Json());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) Ratings is {@link HashSet#HashSet()}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) Ratings is HashSet(); then return changeInitiatives size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableChangeInitiativeView ImmutableChangeInitiativeView.fromJson(Json)"})
  void testFromJson_whenJsonRatingsIsHashSet_thenReturnChangeInitiativesSizeIsOne() {
    // Arrange
    LinkedHashSet<ChangeInitiative> changeInitiatives = new LinkedHashSet<>();
    changeInitiatives.add(new ImmutableChangeInitiative.Json());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) Ratings is {@code null}.
   *   <li>Then return changeInitiatives size is one.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableChangeInitiativeView#fromJson(Json)}
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) Ratings is 'null'; then return changeInitiatives size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableChangeInitiativeView ImmutableChangeInitiativeView.fromJson(Json)"})
  void testFromJson_whenJsonRatingsIsNull_thenReturnChangeInitiativesSizeIsOne() {
    // Arrange
    LinkedHashSet<ChangeInitiative> changeInitiatives = new LinkedHashSet<>();
    changeInitiatives.add(new ImmutableChangeInitiative.Json());
   ...
   *   <li>Then return changeInitiatives is {@link Json} (default constructor) {@link Json#ratings}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableChangeInitiativeView#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor); then return changeInitiatives is Json (default constructor) ratings")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableChangeInitiativeView ImmutableChangeInitiativeView.fromJson(Json)"})
  void testFromJson_whenJson_thenReturnChangeInitiativesIsJsonRatings() {
    // Arrange
    Json json = new Json();
