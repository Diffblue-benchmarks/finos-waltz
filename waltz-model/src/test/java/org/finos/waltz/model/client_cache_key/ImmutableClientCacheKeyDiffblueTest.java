...
class ImmutableClientCacheKeyDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'Json'; when Json (default constructor) Key is 'Json'; then return guid is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableClientCacheKey ImmutableClientCacheKey.fromJson(Json)"})
  void testFromJson_givenJson_whenJsonKeyIsJson_thenReturnGuidIsJson() {
    // Arrange
    Json json = new Json();
    json.setKey("Json");
    json.setGuid("Json");
