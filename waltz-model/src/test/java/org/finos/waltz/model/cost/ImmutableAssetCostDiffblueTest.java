...
class ImmutableAssetCostDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given Json (default constructor); when Json (default constructor) AssetCode is 'Json'; then return provenance is 'waltz'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableAssetCost ImmutableAssetCost.fromJson(Json)"})
  void testFromJson_givenJson_whenJsonAssetCodeIsJson_thenReturnProvenanceIsWaltz() {
    // Arrange
    Json json = new Json();
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given Json (default constructor); when Json (default constructor) Provenance is 'Json'; then return provenance is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableAssetCost ImmutableAssetCost.fromJson(Json)"})
