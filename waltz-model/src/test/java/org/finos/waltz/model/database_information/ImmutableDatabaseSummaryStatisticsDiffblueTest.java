...
class ImmutableDatabaseSummaryStatisticsDiffblueTest {
  ...
  void testBuilderAddEndOfLifeStatusCountsWithElement() {
    ...
    ImmutableOrderedTally<String> element = builderResult2.count(10.0d).id("42").index(1).build();
  ...
  void testBuilderAddEndOfLifeStatusCountsWithElements() {
    ...
    Builder actualAddEndOfLifeStatusCountsResult =
        builderResult.addEndOfLifeStatusCounts(
  ...
  void testBuilderAddVendorCountsWithElements_thenBuilderBuildVendorCountsSizeIsOne() {
    ...
    // Act
    Builder actualAddVendorCountsResult =
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); then return environmentCounts is Json (default constructor) environmentCounts")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableDatabaseSummaryStatistics ImmutableDatabaseSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_thenReturnEnvironmentCountsIsJsonEnvironmentCounts() {
    // Arrange
    ...
    environmentCounts.add(builderResult.count(10.0d).id("42").index(1).build());

    ImmutableOrderedTally.Builder<String> builderResult2 = ImmutableOrderedTally.builder();
    environmentCounts.add(builderResult2.count(10.0d).id("42").index(1).build());

    ArrayList<Tally<String>> vendorCounts = new ArrayList<>();

    ImmutableOrderedTally.Builder<String> builderResult3 = ImmutableOrderedTally.builder();
    vendorCounts.add(builderResult3.count(10.0d).id("42").index(1).build());

    ArrayList<Tally<String>> endOfLifeStatusCounts = new ArrayList<>();

    ImmutableOrderedTally.Builder<String> builderResult4 = ImmutableOrderedTally.builder();
    endOfLifeStatusCounts.add(builderResult4.count(10.0d).id("42").index(1).build());
    ...
    // Assert
    List<Tally<String>> expectedEnvironmentCountsResult = json.environmentCounts;
    assertEquals(expectedEnvironmentCountsResult, actualFromJsonResult.environmentCounts());
  }
  ...
  void testFromJson_thenReturnEnvironmentCountsSizeIsOne() {
    ...
    ImmutableOrderedTally.Builder<String> builderResult2 = ImmutableOrderedTally.builder();
    vendorCounts.add(builderResult2.count(10.0d).id("42").index(1).build());

    ArrayList<Tally<String>> endOfLifeStatusCounts = new ArrayList<>();

    ImmutableOrderedTally.Builder<String> builderResult3 = ImmutableOrderedTally.builder();
    endOfLifeStatusCounts.add(builderResult3.count(10.0d).id("42").index(1).build());
    ...
    assertEquals(1, environmentCountsResult.size());
    assertTrue(environmentCountsResult.get(0) instanceof ImmutableOrderedTally);
    List<Tally<String>> vendorCountsResult = actualFromJsonResult.vendorCounts();
    assertEquals(1, vendorCountsResult.size());
    assertTrue(vendorCountsResult.get(0) instanceof ImmutableOrderedTally);
    assertEquals(endOfLifeStatusCounts, actualFromJsonResult.endOfLifeStatusCounts());
  }
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) EndOfLifeStatusCounts is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDatabaseSummaryStatistics#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) EndOfLifeStatusCounts is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableDatabaseSummaryStatistics ImmutableDatabaseSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_whenJsonEndOfLifeStatusCountsIsNull() {
    // Arrange
    Json json = new Json();
    json.setEnvironmentCounts(new ArrayList<>());
    json.setVendorCounts(new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) EnvironmentCounts is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDatabaseSummaryStatistics#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); when Json (default constructor) EnvironmentCounts is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableDatabaseSummaryStatistics ImmutableDatabaseSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_whenJsonEnvironmentCountsIsNull() {
    // Arrange
    Json json = new Json();
    json.setEnvironmentCounts(null);
    json.setVendorCounts(new ArrayList<>());
    json.setEndOfLifeStatusCounts(new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) VendorCounts is {@code null}.
   *   <li>Then return endOfLifeStatusCounts Empty.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDatabaseSummaryStatistics#fromJson(Json)}
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) VendorCounts is 'null'; then return endOfLifeStatusCounts Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableDatabaseSummaryStatistics ImmutableDatabaseSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_whenJsonVendorCountsIsNull_thenReturnEndOfLifeStatusCountsEmpty() {
    // Arrange
    Json json = new Json();
    json.setEnvironmentCounts(new ArrayList<>());
