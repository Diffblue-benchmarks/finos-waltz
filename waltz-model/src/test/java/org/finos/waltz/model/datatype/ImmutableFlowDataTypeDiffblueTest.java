...
class ImmutableFlowDataTypeDiffblueTest {
  ...
  void testBuilderBuild() {
    ...
    Builder actualSourceOutboundRatingResult =
        actualSourceOuIdResult.sourceOutboundRating(sourceOutboundRating);
    ...
    ImmutableFlowDataType actualImmutableFlowDataType =
        actualTargetResult.targetInboundRating(targetInboundRating).targetOuId(1L).build();

    // Assert
    AuthoritativenessRatingValue sourceOutboundRatingResult =
        actualImmutableFlowDataType.sourceOutboundRating();
    assertEquals("42", sourceOutboundRatingResult.value());
    AuthoritativenessRatingValue targetInboundRatingResult =
        actualImmutableFlowDataType.targetInboundRating();
  ...
  /**
   * Test Builder {@link Builder#sourceOutboundRating(AuthoritativenessRatingValue)}.
   *
   * <ul>
   *   <li>Then return builder.
   * </ul>
   *
   * <p>Method under test: {@link Builder#sourceOutboundRating(AuthoritativenessRatingValue)}
   */
  @Test
  @DisplayName(
      "Test Builder sourceOutboundRating(AuthoritativenessRatingValue); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.sourceOutboundRating(AuthoritativenessRatingValue)"})
  void testBuilderSourceOutboundRating_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableFlowDataType.builder();

    // Act
    Builder actualSourceOutboundRatingResult =
        builderResult.sourceOutboundRating(AuthoritativenessRatingValue.of("42"));

    // Assert
    assertSame(builderResult, actualSourceOutboundRatingResult);
  }
  ...
  /**
   * Test Builder {@link Builder#targetInboundRating(AuthoritativenessRatingValue)}.
   *
   * <ul>
   *   <li>Then return builder.
   * </ul>
   *
   * <p>Method under test: {@link Builder#targetInboundRating(AuthoritativenessRatingValue)}
   */
  @Test
  @DisplayName(
      "Test Builder targetInboundRating(AuthoritativenessRatingValue); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.targetInboundRating(AuthoritativenessRatingValue)"})
  void testBuilderTargetInboundRating_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableFlowDataType.builder();

    // Act
    Builder actualTargetInboundRatingResult =
        builderResult.targetInboundRating(AuthoritativenessRatingValue.of("42"));
  ...
  void testCopyOf_thenSourceReturnImmutableEntityReference() {
    ...
    Builder sourceOutboundRatingResult =
        sourceOuIdResult.sourceOutboundRating(sourceOutboundRating);
    ...
    AuthoritativenessRatingValue targetInboundRating = AuthoritativenessRatingValue.of("42");
    ImmutableFlowDataType instance =
        targetResult.targetInboundRating(targetInboundRating).targetOuId(1L).build();
    ...
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualCopyOfResult.sourceOutboundRating());
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual8() {
    ...
    Builder sourceOutboundRatingResult =
        sourceOuIdResult.sourceOutboundRating(AuthoritativenessRatingValue.of("Value"));
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual10() {
    ...
    ImmutableFlowDataType immutableFlowDataType =
        targetResult
            .targetInboundRating(AuthoritativenessRatingValue.of("Value"))
            .targetOuId(1L)
            .build();
   ...
   *   <li>{@link ImmutableFlowDataType#sourceOutboundRating()}
   *   <li>{@link ImmutableFlowDataType#target()}
   *   <li>{@link ImmutableFlowDataType#targetInboundRating()}
  ...
  @MethodsUnderTest({
    ...
    "AuthoritativenessRatingValue ImmutableFlowDataType.sourceOutboundRating()",
    "EntityReference ImmutableFlowDataType.target()",
    "AuthoritativenessRatingValue ImmutableFlowDataType.targetInboundRating()",
  ...
  void testGettersAndSetters() {
    ...
    AuthoritativenessRatingValue actualSourceOutboundRatingResult =
        immutableFlowDataType.sourceOutboundRating();
    ...
    AuthoritativenessRatingValue actualTargetInboundRatingResult =
        immutableFlowDataType.targetInboundRating();
    ...
    assertEquals(
        "FlowDataType{source=EntityReference{kind=ALL, id=1, entityLifecycleStatus=ACTIVE}, target=EntityReference"
            ...
            + " outboundRuleId=1, inboundRuleId=1, sourceOutboundRating=42, targetInboundRating=42}",
  ...
  void testWithDtId_thenSourceReturnImmutableEntityReference() {
    ...
    ImmutableFlowDataType actualWithDtIdResult =
        targetResult.targetInboundRating(targetInboundRating).targetOuId(1L).build().withDtId(42L);

    // Assert
    EntityReference sourceResult = actualWithDtIdResult.source();
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithDtIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithDtIdResult.inboundRuleId().longValue());
    assertEquals(1L, actualWithDtIdResult.outboundRuleId().longValue());
    assertEquals(1L, actualWithDtIdResult.sourceOuId().longValue());
    assertEquals(1L, actualWithDtIdResult.targetOuId().longValue());
    assertEquals(1L, actualWithDtIdResult.lfId());
    assertEquals(1L, actualWithDtIdResult.lfdId());
    assertEquals(42L, actualWithDtIdResult.dtId());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithDtIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithDtIdResult.targetInboundRating());
  }
  ...
  void testWithInboundRuleId_whenFortyTwo_thenSourceReturnImmutableEntityReference() {
    ...
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithInboundRuleIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithInboundRuleIdResult.outboundRuleId().longValue());
    assertEquals(1L, actualWithInboundRuleIdResult.sourceOuId().longValue());
    assertEquals(1L, actualWithInboundRuleIdResult.targetOuId().longValue());
    assertEquals(1L, actualWithInboundRuleIdResult.dtId());
    assertEquals(1L, actualWithInboundRuleIdResult.lfId());
    assertEquals(1L, actualWithInboundRuleIdResult.lfdId());
    assertEquals(42L, actualWithInboundRuleIdResult.inboundRuleId().longValue());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithInboundRuleIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithInboundRuleIdResult.targetInboundRating());
  }
  ...
  void testWithLfId_thenSourceReturnImmutableEntityReference() {
    ...
    ImmutableFlowDataType actualWithLfIdResult =
        targetResult.targetInboundRating(targetInboundRating).targetOuId(1L).build().withLfId(42L);

    // Assert
    EntityReference sourceResult = actualWithLfIdResult.source();
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithLfIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithLfIdResult.inboundRuleId().longValue());
    assertEquals(1L, actualWithLfIdResult.outboundRuleId().longValue());
    assertEquals(1L, actualWithLfIdResult.sourceOuId().longValue());
    assertEquals(1L, actualWithLfIdResult.targetOuId().longValue());
    assertEquals(1L, actualWithLfIdResult.dtId());
    assertEquals(1L, actualWithLfIdResult.lfdId());
    assertEquals(42L, actualWithLfIdResult.lfId());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithLfIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithLfIdResult.targetInboundRating());
  }
  ...
  void testWithLfdId_thenSourceReturnImmutableEntityReference() {
    ...
    ImmutableFlowDataType actualWithLfdIdResult =
        targetResult.targetInboundRating(targetInboundRating).targetOuId(1L).build().withLfdId(42L);

    // Assert
    EntityReference sourceResult = actualWithLfdIdResult.source();
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithLfdIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithLfdIdResult.inboundRuleId().longValue());
    assertEquals(1L, actualWithLfdIdResult.outboundRuleId().longValue());
    assertEquals(1L, actualWithLfdIdResult.sourceOuId().longValue());
    assertEquals(1L, actualWithLfdIdResult.targetOuId().longValue());
    assertEquals(1L, actualWithLfdIdResult.dtId());
    assertEquals(1L, actualWithLfdIdResult.lfId());
    assertEquals(42L, actualWithLfdIdResult.lfdId());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithLfdIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithLfdIdResult.targetInboundRating());
  }
  ...
  void testWithOutboundRuleId_whenFortyTwo_thenSourceReturnImmutableEntityReference() {
    ...
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithOutboundRuleIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithOutboundRuleIdResult.inboundRuleId().longValue());
    assertEquals(1L, actualWithOutboundRuleIdResult.sourceOuId().longValue());
    assertEquals(1L, actualWithOutboundRuleIdResult.targetOuId().longValue());
    assertEquals(1L, actualWithOutboundRuleIdResult.dtId());
    assertEquals(1L, actualWithOutboundRuleIdResult.lfId());
    assertEquals(1L, actualWithOutboundRuleIdResult.lfdId());
    assertEquals(42L, actualWithOutboundRuleIdResult.outboundRuleId().longValue());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithOutboundRuleIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithOutboundRuleIdResult.targetInboundRating());
  }
  ...
  void testWithSourceOuId_whenFortyTwo_thenSourceReturnImmutableEntityReference() {
    ...
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithSourceOuIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithSourceOuIdResult.inboundRuleId().longValue());
    assertEquals(1L, actualWithSourceOuIdResult.outboundRuleId().longValue());
    assertEquals(1L, actualWithSourceOuIdResult.targetOuId().longValue());
    assertEquals(1L, actualWithSourceOuIdResult.dtId());
    assertEquals(1L, actualWithSourceOuIdResult.lfId());
    assertEquals(1L, actualWithSourceOuIdResult.lfdId());
    assertEquals(42L, actualWithSourceOuIdResult.sourceOuId().longValue());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithSourceOuIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithSourceOuIdResult.targetInboundRating());
  }

  /**
   * Test {@link ImmutableFlowDataType#withSourceOutboundRating(AuthoritativenessRatingValue)}.
   *
   * <p>Method under test: {@link
   * ImmutableFlowDataType#withSourceOutboundRating(AuthoritativenessRatingValue)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableFlowDataType ImmutableFlowDataType.withSourceOutboundRating(AuthoritativenessRatingValue)"
  })
  void testWithSourceOutboundRating() {
    ...
    // Act
    ImmutableFlowDataType actualWithSourceOutboundRatingResult =
        immutableFlowDataType.withSourceOutboundRating(AuthoritativenessRatingValue.of("42"));

    // Assert
    assertEquals(immutableFlowDataType, actualWithSourceOutboundRatingResult);
  }
  ...
  /**
   * Test {@link ImmutableFlowDataType#withTargetInboundRating(AuthoritativenessRatingValue)}.
   *
   * <p>Method under test: {@link
   * ImmutableFlowDataType#withTargetInboundRating(AuthoritativenessRatingValue)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableFlowDataType ImmutableFlowDataType.withTargetInboundRating(AuthoritativenessRatingValue)"
  })
  void testWithTargetInboundRating() {
    ...
    // Act
    ImmutableFlowDataType actualWithTargetInboundRatingResult =
        immutableFlowDataType.withTargetInboundRating(AuthoritativenessRatingValue.of("42"));

    // Assert
    assertEquals(immutableFlowDataType, actualWithTargetInboundRatingResult);
  }
  ...
  void testWithTargetOuId_whenFortyTwo_thenSourceReturnImmutableEntityReference() {
    ...
    assertTrue(sourceResult instanceof ImmutableEntityReference);
    EntityReference targetResult2 = actualWithTargetOuIdResult.target();
    assertTrue(targetResult2 instanceof ImmutableEntityReference);
    assertEquals(1L, actualWithTargetOuIdResult.inboundRuleId().longValue());
    assertEquals(1L, actualWithTargetOuIdResult.outboundRuleId().longValue());
    assertEquals(1L, actualWithTargetOuIdResult.sourceOuId().longValue());
    assertEquals(1L, actualWithTargetOuIdResult.dtId());
    assertEquals(1L, actualWithTargetOuIdResult.lfId());
    assertEquals(1L, actualWithTargetOuIdResult.lfdId());
    assertEquals(42L, actualWithTargetOuIdResult.targetOuId().longValue());
    assertEquals(sourceResult, targetResult2);
    assertSame(sourceOutboundRating, actualWithTargetOuIdResult.sourceOutboundRating());
    assertSame(targetInboundRating, actualWithTargetOuIdResult.targetInboundRating());
  }
}
