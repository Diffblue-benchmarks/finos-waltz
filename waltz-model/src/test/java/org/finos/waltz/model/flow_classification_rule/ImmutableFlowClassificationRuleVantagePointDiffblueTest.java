...
class ImmutableFlowClassificationRuleVantagePointDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder vantagePoint(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderVantagePoint_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualVantagePointResult = builderResult.vantagePoint(mock(EntityReference.class));
