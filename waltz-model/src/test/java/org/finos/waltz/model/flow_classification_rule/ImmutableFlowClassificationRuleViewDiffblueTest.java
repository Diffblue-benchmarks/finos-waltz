...
class ImmutableFlowClassificationRuleViewDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return flowClassifications is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableFlowClassificationRuleView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return flowClassifications is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableFlowClassificationRuleView ImmutableFlowClassificationRuleView.fromJson(Json)"
  })
  void testFromJson_thenReturnFlowClassificationsIsLinkedHashSet() {
    // Arrange
    ...
    // Assert
    assertEquals(flowClassifications, actualFromJsonResult.flowClassifications());
  }
   ...
   *   <li>Then return dataTypes is {@link Json} (default constructor) {@link
   *       Json#flowClassificationRules}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableFlowClassificationRuleView#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor); then return dataTypes is Json (default constructor) flowClassificationRules")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableFlowClassificationRuleView ImmutableFlowClassificationRuleView.fromJson(Json)"
  ...
  void testFromJson_whenJson_thenReturnDataTypesIsJsonFlowClassificationRules() {
    ...
    assertSame(
        expectedFlowClassificationRulesResult, actualFromJsonResult.flowClassificationRules());
  }
