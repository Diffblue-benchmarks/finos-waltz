...
class ImmutableInvolvementDetailByDirectionResultsDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) Exact is 'null'; then return ancestors Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
   ...
   *
   * <ul>
   *   <li>Then return exact is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableInvolvementDetailByDirectionResults#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return exact is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableInvolvementDetailByDirectionResults ImmutableInvolvementDetailByDirectionResults.fromJson(Json)"
  })
  void testFromJson_thenReturnExactIsLinkedHashSet() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) Descendents is {@link
   *       LinkedHashSet#LinkedHashSet()}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) Descendents is LinkedHashSet(); then return descendents size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableInvolvementDetailByDirectionResults ImmutableInvolvementDetailByDirectionResults.fromJson(Json)"
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) Exact is {@link LinkedHashSet#LinkedHashSet()}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) Exact is LinkedHashSet(); then return exact size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableInvolvementDetailByDirectionResults ImmutableInvolvementDetailByDirectionResults.fromJson(Json)"
