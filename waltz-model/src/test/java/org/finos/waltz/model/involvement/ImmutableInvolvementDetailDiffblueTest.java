...
class ImmutableInvolvementDetailDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder involvementKind(InvolvementKind); when InvolvementKind; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderInvolvementKind_whenInvolvementKind_thenReturnBuilder() {
    ...
    Builder actualInvolvementKindResult =
        builderResult.involvementKind(mock(InvolvementKind.class));
