...
class ImmutableLegalEntityRelationshipAssessmentInfoDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder definitionRef(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderDefinitionRef_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualDefinitionRefResult = builderResult.definitionRef(mock(EntityReference.class));
