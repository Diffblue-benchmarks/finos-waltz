...
class ImmutableLegalEntityRelationshipViewDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder addAllAssessmentHeaders(Iterable); when ArrayList(); then return builder")
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); given HashSet(); then return rows size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableLegalEntityRelationshipView ImmutableLegalEntityRelationshipView.fromJson(Json)"
  })
  void testFromJson_givenHashSet_thenReturnRowsSizeIsOne() {
    // Arrange
    ...
    Json json = new Json();
    json.setAssessmentHeaders(new HashSet<>());
    json.setRows(rows);
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) AssessmentHeaders is 'null'; then return rows size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableLegalEntityRelationshipView ImmutableLegalEntityRelationshipView.fromJson(Json)"
  })
  void testFromJson_givenNull_whenJsonAssessmentHeadersIsNull_thenReturnRowsSizeIsOne() {
    // Arrange
    LinkedHashSet<LegalEntityRelationshipViewRow> rows = new LinkedHashSet<>();
    rows.add(new ImmutableLegalEntityRelationshipViewRow.Json());
