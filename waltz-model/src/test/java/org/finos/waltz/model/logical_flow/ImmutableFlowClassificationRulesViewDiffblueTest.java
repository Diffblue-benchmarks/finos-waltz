...
class ImmutableFlowClassificationRulesViewDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder addAllFlowClassificationRules(Iterable); when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addAllFlowClassificationRules(Iterable)"})
  void testBuilderAddAllFlowClassificationRules_whenArrayList() {
    // Arrange
    Builder builderResult = ImmutableFlowClassificationRulesView.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder addAllFlowClassifications(Iterable); when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addAllFlowClassifications(Iterable)"})
  void testBuilderAddAllFlowClassifications_whenArrayList() {
    // Arrange
    Builder builderResult = ImmutableFlowClassificationRulesView.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder flowClassificationRules(Iterable); when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.flowClassificationRules(Iterable)"})
  void testBuilderFlowClassificationRules_whenArrayList() {
    // Arrange
    Builder builderResult = ImmutableFlowClassificationRulesView.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder flowClassifications(Iterable); when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.flowClassifications(Iterable)"})
  void testBuilderFlowClassifications_whenArrayList() {
    // Arrange
    Builder builderResult = ImmutableFlowClassificationRulesView.builder();
   ...
   *
   * <ul>
   *   <li>Then return dataTypes is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableFlowClassificationRulesView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return dataTypes is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableFlowClassificationRulesView ImmutableFlowClassificationRulesView.fromJson(Json)"
  })
  void testFromJson_thenReturnDataTypesIsLinkedHashSet() {
    // Arrange
    LinkedHashSet<DataType> dataTypes = new LinkedHashSet<>();
    dataTypes.add(
        ImmutableDataType.builder()
