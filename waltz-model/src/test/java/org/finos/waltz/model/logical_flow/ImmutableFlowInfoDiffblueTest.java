...
class ImmutableFlowInfoDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder actualDataType(EntityReference); when EntityReference; then return builder")
  ...
  void testBuilderActualDataType_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualActualDataTypeResult = builderResult.actualDataType(mock(EntityReference.class));
  ...
  @Test
  @DisplayName(
      "Test Builder counterpart(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderCounterpart_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualCounterpartResult = builderResult.counterpart(mock(EntityReference.class));
  ...
  @Test
  @DisplayName(
      "Test Builder rollupDataType(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderRollupDataType_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualRollupDataTypeResult = builderResult.rollupDataType(mock(EntityReference.class));
