...
class ImmutableAllocationsViewDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return allocationSchemes is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableAllocationsView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return allocationSchemes is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableAllocationsView ImmutableAllocationsView.fromJson(Json)"})
  void testFromJson_thenReturnAllocationSchemesIsLinkedHashSet() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); when Json (default constructor) Allocations is HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableAllocationsView ImmutableAllocationsView.fromJson(Json)"})
  void testFromJson_whenJsonAllocationsIsHashSet() {
    // Arrange
    Json json = new Json();
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) Allocations is 'null'; then return allocations is allocationSchemes")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableAllocationsView ImmutableAllocationsView.fromJson(Json)"})
  void testFromJson_whenJsonAllocationsIsNull_thenReturnAllocationsIsAllocationSchemes() {
    // Arrange
    Json json = new Json();
    json.setAllocationSchemes(new HashSet<>());
