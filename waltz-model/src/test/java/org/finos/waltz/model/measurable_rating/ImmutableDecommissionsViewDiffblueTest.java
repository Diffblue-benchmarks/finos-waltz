...
class ImmutableDecommissionsViewDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder addAllPlannedReplacements(Iterable); when ArrayList(); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test Builder addAllReplacingDecommissions(Iterable); when ArrayList(); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test Builder replacingDecommissions(Iterable); when ArrayList(); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Then return plannedDecommissions is {@link LinkedHashSet#LinkedHashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDecommissionsView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return plannedDecommissions is LinkedHashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableDecommissionsView ImmutableDecommissionsView.fromJson(Json)"})
  void testFromJson_thenReturnPlannedDecommissionsIsLinkedHashSet() {
    // Arrange
    LinkedHashSet<MeasurableRatingPlannedDecommission> plannedDecommissions = new LinkedHashSet<>();
    plannedDecommissions.add(
        ImmutableMeasurableRatingPlannedDecommission.builder()
            .createdAt(LocalDate.of(1970, 1, 1).atStartOfDay())
    ...
    assertEquals(plannedDecommissions, actualFromJsonResult.plannedDecommissions());
  }
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) PlannedDecommissions is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDecommissionsView#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) PlannedDecommissions is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableDecommissionsView ImmutableDecommissionsView.fromJson(Json)"})
  void testFromJson_whenJsonPlannedDecommissionsIsNull() {
    // Arrange
    Json json = new Json();
    json.setPlannedDecommissions(null);
    json.setReplacingDecommissions(new HashSet<>());
    json.setPlannedReplacements(new HashSet<>());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) PlannedReplacements is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDecommissionsView#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); when Json (default constructor) PlannedReplacements is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableDecommissionsView ImmutableDecommissionsView.fromJson(Json)"})
  void testFromJson_whenJsonPlannedReplacementsIsNull() {
    // Arrange
    Json json = new Json();
    json.setPlannedDecommissions(new HashSet<>());
    json.setReplacingDecommissions(new HashSet<>());
   ...
   *
   * <ul>
   *   <li>When {@link Json} (default constructor) ReplacingDecommissions is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableDecommissionsView#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); when Json (default constructor) ReplacingDecommissions is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableDecommissionsView ImmutableDecommissionsView.fromJson(Json)"})
  void testFromJson_whenJsonReplacingDecommissionsIsNull() {
    // Arrange
    Json json = new Json();
    json.setPlannedDecommissions(new HashSet<>());
