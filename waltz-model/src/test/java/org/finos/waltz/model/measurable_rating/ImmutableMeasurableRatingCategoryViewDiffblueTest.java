...
class ImmutableMeasurableRatingCategoryViewDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ImmutableAllocationsView.Json} (default constructor).
   *   <li>When {@link Json} (default constructor) Allocations is {@link
   *       ImmutableAllocationsView.Json} (default constructor).
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given Json (default constructor); when Json (default constructor) Allocations is Json (default constructor); then return allocations is Json (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableMeasurableRatingCategoryView ImmutableMeasurableRatingCategoryView.fromJson(Json)"
  })
  void testFromJson_givenJson_whenJsonAllocationsIsJson_thenReturnAllocationsIsJson() {
    // Arrange
    Json json = new Json();
