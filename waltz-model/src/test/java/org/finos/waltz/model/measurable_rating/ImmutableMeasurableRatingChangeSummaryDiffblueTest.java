...
class ImmutableMeasurableRatingChangeSummaryDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder measurableCategoryRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.measurableCategoryRef(EntityReference)"})
  void testBuilderMeasurableCategoryRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableMeasurableRatingChangeSummary.builder();

    // Act
    Builder actualMeasurableCategoryRefResult =
        builderResult.measurableCategoryRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
   ...
   */
  @Test
  @DisplayName("Test Builder measurableRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.measurableRef(EntityReference)"})
  void testBuilderMeasurableRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableMeasurableRatingChangeSummary.builder();

    // Act
    Builder actualMeasurableRefResult =
        builderResult.measurableRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
