...
class ImmutablePrimaryRatingViewItemDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder measurableCategory(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.measurableCategory(EntityReference)"})
  void testBuilderMeasurableCategory_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutablePrimaryRatingViewItem.builder();

    // Act
    Builder actualMeasurableCategoryResult =
        builderResult.measurableCategory(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
   ...
   */
  @Test
  @DisplayName("Test Builder measurable(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.measurable(EntityReference)"})
  void testBuilderMeasurable_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutablePrimaryRatingViewItem.builder();

    // Act
    Builder actualMeasurableResult =
