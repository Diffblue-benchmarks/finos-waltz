...
class ImmutableOrphanRelationshipDiffblueTest {
  ...
  void testBuilderEntityA_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualEntityAResult = builderResult.entityA(mock(EntityReference.class));
  ...
  void testBuilderEntityB_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualEntityBResult = builderResult.entityB(mock(EntityReference.class));
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); given 'A'; then return orphanSide is 'A'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableOrphanRelationship ImmutableOrphanRelationship.fromJson(Json)"})
  void testFromJson_givenA_thenReturnOrphanSideIsA() {
    // Arrange
    Json json = new Json();
    json.setEntityA(
        ImmutableEntityReference.builder()
