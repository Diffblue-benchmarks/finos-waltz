...
class ImmutablePermissionViewItemDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder involvementGroup(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderInvolvementGroup_whenEntityReference_thenReturnBuilder() {
    ...
    Builder actualInvolvementGroupResult =
        builderResult.involvementGroup(mock(EntityReference.class));
  ...
  @Test
  @DisplayName(
      "Test Builder involvementKind(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderInvolvementKind_whenEntityReference_thenReturnBuilder() {
    ...
    Builder actualInvolvementKindResult =
        builderResult.involvementKind(mock(EntityReference.class));
  ...
  @Test
  @DisplayName(
      "Test Builder permissionGroup(EntityReference); when EntityReference; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderPermissionGroup_whenEntityReference_thenReturnBuilder() {
    ...
    Builder actualPermissionGroupResult =
        builderResult.permissionGroup(mock(EntityReference.class));
