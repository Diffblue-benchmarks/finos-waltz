...
class ImmutablePhysicalFlowParticipantDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder participant(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.participant(EntityReference)"})
  void testBuilderParticipant_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutablePhysicalFlowParticipant.builder();

    // Act
    Builder actualParticipantResult =
        builderResult.participant(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
