...
class PhysicalSpecificationDiffblueTest {
  /**
   * Test {@link PhysicalSpecification#entityReference()}.
   *
   * <ul>
   *   <li>Then return {@link ImmutableEntityReference}.
   * </ul>
   *
   * <p>Method under test: {@link PhysicalSpecification#entityReference()}
   */
  @Test
  @DisplayName("Test entityReference(); then return ImmutableEntityReference")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityReference PhysicalSpecification.entityReference()"})
  void testEntityReference_thenReturnImmutableEntityReference() {
    ...
    assertEquals(EntityKind.PHYSICAL_SPECIFICATION, actualEntityReferenceResult.kind());
    assertEquals(EntityLifecycleStatus.ACTIVE, actualEntityReferenceResult.entityLifecycleStatus());
  }

  /**
   * Test {@link PhysicalSpecification#kind()}.
   *
   * <ul>
   *   <li>Then return {@code ALL}.
   * </ul>
   *
   * <p>Method under test: {@link PhysicalSpecification#kind()}
   */
  @Test
  @DisplayName("Test kind(); then return 'ALL'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityKind PhysicalSpecification.kind()"})
