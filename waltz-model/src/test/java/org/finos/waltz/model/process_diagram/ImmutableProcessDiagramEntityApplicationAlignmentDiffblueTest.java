...
class ImmutableProcessDiagramEntityApplicationAlignmentDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder applicationRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.applicationRef(EntityReference)"})
  void testBuilderApplicationRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableProcessDiagramEntityApplicationAlignment.builder();

    // Act
    Builder actualApplicationRefResult =
   ...
   */
  @Test
  @DisplayName("Test Builder diagramMeasurableRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.diagramMeasurableRef(EntityReference)"})
  void testBuilderDiagramMeasurableRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableProcessDiagramEntityApplicationAlignment.builder();

    // Act
    Builder actualDiagramMeasurableRefResult =
        builderResult.diagramMeasurableRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
   ...
   */
  @Test
  @DisplayName("Test Builder referencedMeasurableRef(EntityReference); then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.referencedMeasurableRef(EntityReference)"})
  void testBuilderReferencedMeasurableRef_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableProcessDiagramEntityApplicationAlignment.builder();

    // Act
    Builder actualReferencedMeasurableRefResult =
        builderResult.referencedMeasurableRef(
            ImmutableEntityReference.builder()
                .description("The characteristics of someone or something")
                .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
                .externalId("42")
