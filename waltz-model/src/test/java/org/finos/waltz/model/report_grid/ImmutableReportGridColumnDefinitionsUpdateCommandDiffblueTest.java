...
class ImmutableReportGridColumnDefinitionsUpdateCommandDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add Json (default constructor); then return derivedColumnDefinitions size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableReportGridColumnDefinitionsUpdateCommand ImmutableReportGridColumnDefinitionsUpdateCommand.fromJson(Json)"
  })
  void testFromJson_givenArrayListAddJson_thenReturnDerivedColumnDefinitionsSizeIsOne() {
    // Arrange
    ...
    Json json2 = new Json();
    json2.setFixedColumnDefinitions(null);
   ...
   *   <li>Then return fixedColumnDefinitions is {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableReportGridColumnDefinitionsUpdateCommand#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add Json (default constructor); then return fixedColumnDefinitions is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableReportGridColumnDefinitionsUpdateCommand ImmutableReportGridColumnDefinitionsUpdateCommand.fromJson(Json)"
  })
  void testFromJson_givenArrayListAddJson_thenReturnFixedColumnDefinitionsIsArrayList() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then return derivedColumnDefinitions size is two.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableReportGridColumnDefinitionsUpdateCommand#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return derivedColumnDefinitions size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableReportGridColumnDefinitionsUpdateCommand ImmutableReportGridColumnDefinitionsUpdateCommand.fromJson(Json)"
  })
  void testFromJson_thenReturnDerivedColumnDefinitionsSizeIsTwo() {
    // Arrange
    ArrayList<ReportGridDerivedColumnDefinition> derivedColumnDefinitions = new ArrayList<>();
    ...
    List<ReportGridDerivedColumnDefinition> derivedColumnDefinitionsResult =
        actualFromJsonResult.derivedColumnDefinitions();
    assertEquals(2, derivedColumnDefinitionsResult.size());
    ...
    assertSame(json, derivedColumnDefinitionsResult.get(1));
  }
   ...
   *
   * <ul>
   *   <li>Then return fixedColumnDefinitions is derivedColumnDefinitions.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableReportGridColumnDefinitionsUpdateCommand#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); then return fixedColumnDefinitions is derivedColumnDefinitions")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableReportGridColumnDefinitionsUpdateCommand ImmutableReportGridColumnDefinitionsUpdateCommand.fromJson(Json)"
