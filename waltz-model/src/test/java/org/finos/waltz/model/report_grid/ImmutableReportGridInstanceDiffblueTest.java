...
class ImmutableReportGridInstanceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test Builder addAllRatingSchemeItems(Iterable); when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addAllRatingSchemeItems(Iterable)"})
  void testBuilderAddAllRatingSchemeItems_whenArrayList() {
    // Arrange
    Builder builderResult = ImmutableReportGridInstance.builder();
   ...
   */
  @Test
  @DisplayName("Test Builder ratingSchemeItems(Iterable); when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.ratingSchemeItems(Iterable)"})
  void testBuilderRatingSchemeItems_whenArrayList() {
    // Arrange
    Builder builderResult = ImmutableReportGridInstance.builder();
   ...
   *
   * <ul>
   *   <li>Given {@link LinkedHashSet#LinkedHashSet()} add {@link ImmutableReportGridCell.Json}
   *       (default constructor).
   ...
   *
   * <ul>
   *   <li>Given {@link LinkedHashSet#LinkedHashSet()} add {@link ImmutableReportSubject.Json}
   *       (default constructor).
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given LinkedHashSet() add Json (default constructor); then return subjects size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableReportGridInstance ImmutableReportGridInstance.fromJson(Json)"})
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) Subjects is 'null'; then return cellData Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableReportGridInstance ImmutableReportGridInstance.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonSubjectsIsNull_thenReturnCellDataEmpty() {
    // Arrange
    Json json = new Json();
