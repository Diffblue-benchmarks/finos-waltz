...
class ImmutableReportGridMemberUpdateRoleCommandDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'Json'; when Json (default constructor) Role is 'null'; then return userId is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableReportGridMemberUpdateRoleCommand ImmutableReportGridMemberUpdateRoleCommand.fromJson(Json)"
  })
  void testFromJson_givenJson_whenJsonRoleIsNull_thenReturnUserIdIsJson() {
    // Arrange
    Json json = new Json();
    json.setUserId("Json");
    json.setRole(null);
