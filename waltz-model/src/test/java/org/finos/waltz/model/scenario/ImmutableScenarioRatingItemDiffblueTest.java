...
class ImmutableScenarioRatingItemDiffblueTest {
  ...
  void testBuilderColumn_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualColumnResult = builderResult.column(mock(EntityReference.class));
  ...
  void testBuilderItem_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualItemResult = builderResult.item(mock(EntityReference.class));
  ...
  void testBuilderRow_whenEntityReference_thenReturnBuilder() {
    ...
    // Act
    Builder actualRowResult = builderResult.row(mock(EntityReference.class));
