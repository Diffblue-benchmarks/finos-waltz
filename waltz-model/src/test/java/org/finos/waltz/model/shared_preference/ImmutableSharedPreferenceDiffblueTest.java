...
class ImmutableSharedPreferenceDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) LastUpdatedAt is 'null'; then return category is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSharedPreference ImmutableSharedPreference.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonLastUpdatedAtIsNull_thenReturnCategoryIsJson() {
    // Arrange
    Json json = new Json();
