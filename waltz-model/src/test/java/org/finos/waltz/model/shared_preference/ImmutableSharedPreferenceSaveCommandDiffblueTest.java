...
class ImmutableSharedPreferenceSaveCommandDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code Json}.
   *   <li>When {@link Json} (default constructor) Category is {@code Json}.
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'Json'; when Json (default constructor) Category is 'Json'; then return category is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableSharedPreferenceSaveCommand ImmutableSharedPreferenceSaveCommand.fromJson(Json)"
  })
  void testFromJson_givenJson_whenJsonCategoryIsJson_thenReturnCategoryIsJson() {
    // Arrange
    Json json = new Json();
    json.setKey("Json");
