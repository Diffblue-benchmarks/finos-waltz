...
class ImmutableSoftwareCatalogDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add Json (default constructor); then return usages Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link ArrayList#ArrayList()} add {@link ImmutableSoftwareUsage.Json} (default
   *       constructor).
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add Json (default constructor); then return usages is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSoftwareCatalog ImmutableSoftwareCatalog.fromJson(Json)"})
   ...
   *
   * <ul>
   *   <li>Given {@link ArrayList#ArrayList()} add {@link ImmutableSoftwareVersion.Json} (default
   *       constructor).
   *   <li>Then return versions size is one.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableSoftwareCatalog#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList() add Json (default constructor); then return versions size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSoftwareCatalog ImmutableSoftwareCatalog.fromJson(Json)"})
  void testFromJson_givenArrayListAddJson_thenReturnVersionsSizeIsOne() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) Versions is 'null'; then return packages Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSoftwareCatalog ImmutableSoftwareCatalog.fromJson(Json)"})
   ...
   *
   * <ul>
   *   <li>Then return versions size is two.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableSoftwareCatalog#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return versions size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableSoftwareCatalog ImmutableSoftwareCatalog.fromJson(Json)"})
  void testFromJson_thenReturnVersionsSizeIsTwo() {
    // Arrange
    ArrayList<SoftwareVersion> versions = new ArrayList<>();
    ...
    SoftwareVersion getResult = versionsResult.get(1);
