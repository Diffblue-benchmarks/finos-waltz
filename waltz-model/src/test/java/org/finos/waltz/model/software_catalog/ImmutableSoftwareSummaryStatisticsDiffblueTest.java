...
class ImmutableSoftwareSummaryStatisticsDiffblueTest {
  ...
  void testBuilderAddGroupCountsWithElements_thenBuilderBuildGroupCountsSizeIsOne() {
    ...
    // Act
    Builder actualAddGroupCountsResult =
  ...
  void testBuilderAddNameCountsWithElements_thenBuilderBuildNameCountsSizeIsOne() {
    ...
    // Act
    Builder actualAddNameCountsResult =
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link Json} (default constructor) GroupCounts is {@code null}.
   *   <li>Then return groupCounts Empty.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) GroupCounts is 'null'; then return groupCounts Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableSoftwareSummaryStatistics ImmutableSoftwareSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_givenNull_whenJsonGroupCountsIsNull_thenReturnGroupCountsEmpty() {
    // Arrange
    Json json = new Json();
    json.setVendorCounts(new ArrayList<>());
    json.setGroupCounts(null);
    json.setNameCounts(new ArrayList<>());
  ...
  void testFromJson_givenNull_whenJsonNameCountsIsNull_thenReturnGroupCountsEmpty() {
    ...
    Json json = new Json();
    json.setVendorCounts(new ArrayList<>());
    json.setGroupCounts(new ArrayList<>());
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) VendorCounts is 'null'; then return groupCounts Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableSoftwareSummaryStatistics ImmutableSoftwareSummaryStatistics.fromJson(Json)"
   ...
   */
  @Test
  @DisplayName("Test fromJson(Json); then return nameCounts size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableSoftwareSummaryStatistics ImmutableSoftwareSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_thenReturnNameCountsSizeIsOne() {
    // Arrange
    ...
    vendorCounts.add(builderResult.count(10.0d).id("42").index(1).build());

    ArrayList<Tally<String>> groupCounts = new ArrayList<>();

    ImmutableOrderedTally.Builder<String> builderResult2 = ImmutableOrderedTally.builder();
    groupCounts.add(builderResult2.count(10.0d).id("42").index(1).build());

    ArrayList<Tally<String>> nameCounts = new ArrayList<>();

    ImmutableOrderedTally.Builder<String> builderResult3 = ImmutableOrderedTally.builder();
    nameCounts.add(builderResult3.count(10.0d).id("42").index(1).build());
    ...
    assertEquals(1, nameCountsResult.size());
    assertTrue(nameCountsResult.get(0) instanceof ImmutableOrderedTally);
    ...
    assertEquals(groupCounts, actualFromJsonResult.groupCounts());
  }
   ...
   *
   * <ul>
   *   <li>Then return vendorCounts is {@link Json} (default constructor) {@link Json#vendorCounts}.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableSoftwareSummaryStatistics#fromJson(Json)}
   */
  @Test
  @DisplayName(
      "Test fromJson(Json); then return vendorCounts is Json (default constructor) vendorCounts")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableSoftwareSummaryStatistics ImmutableSoftwareSummaryStatistics.fromJson(Json)"
  })
  void testFromJson_thenReturnVendorCountsIsJsonVendorCounts() {
    // Arrange
    ArrayList<Tally<String>> vendorCounts = new ArrayList<>();
    ...
    ImmutableOrderedTally.Builder<String> builderResult3 = ImmutableOrderedTally.builder();
    groupCounts.add(builderResult3.count(10.0d).id("42").index(1).build());

    ArrayList<Tally<String>> nameCounts = new ArrayList<>();

    ImmutableOrderedTally.Builder<String> builderResult4 = ImmutableOrderedTally.builder();
    nameCounts.add(builderResult4.count(10.0d).id("42").index(1).build());
    ...
    // Assert
    List<Tally<String>> expectedVendorCountsResult = json.vendorCounts;
    assertEquals(expectedVendorCountsResult, actualFromJsonResult.vendorCounts());
  }
