...
class SurveyInstanceStateMachineFactoryDiffblueTest {
  /**
   * Test {@link SurveyInstanceStateMachineFactory#simple(SurveyInstanceStatus)} with {@code
   * SurveyInstanceStatus}.
   *
   * <p>Method under test: {@link SurveyInstanceStateMachineFactory#simple(SurveyInstanceStatus)}
   */
  @Test
