...
class SurveyInstanceStateTransitionDiffblueTest {
  /**
   * Test {@link SurveyInstanceStateTransition#SurveyInstanceStateTransition(SurveyInstanceAction, SurveyInstanceStatus, BiFunction)}.
   * <p>
   * Method under test: {@link SurveyInstanceStateTransition#SurveyInstanceStateTransition(SurveyInstanceAction, SurveyInstanceStatus, BiFunction)}
   */
  @Test
  @DisplayName("Test new SurveyInstanceStateTransition(SurveyInstanceAction, SurveyInstanceStatus, BiFunction)")
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"SurveyInstanceAction SurveyInstanceStateTransition.getAction()",
  ...
  /**
   * Test {@link SurveyInstanceStateTransition#transition(SurveyInstanceAction, SurveyInstanceStatus)} with {@code action}, {@code futureStatus}.
   * <p>
   * Method under test: {@link SurveyInstanceStateTransition#transition(SurveyInstanceAction, SurveyInstanceStatus)}
   */
  @Test
  @DisplayName("Test transition(SurveyInstanceAction, SurveyInstanceStatus) with 'action', 'futureStatus'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  /**
   * Test {@link SurveyInstanceStateTransition#transition(SurveyInstanceAction, SurveyInstanceStatus, BiFunction)} with {@code action}, {@code futureStatus}, {@code predicate}.
   * <p>
   * Method under test: {@link SurveyInstanceStateTransition#transition(SurveyInstanceAction, SurveyInstanceStatus, BiFunction)}
   */
  @Test
  @DisplayName("Test transition(SurveyInstanceAction, SurveyInstanceStatus, BiFunction) with 'action', 'futureStatus', 'predicate'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  /**
   * Test {@link SurveyInstanceStateTransition#equals(Object)}, and {@link SurveyInstanceStateTransition#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean SurveyInstanceStateTransition.equals(Object)",
