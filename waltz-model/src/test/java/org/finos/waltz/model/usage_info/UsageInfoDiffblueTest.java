...
class UsageInfoDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test description(); then return 'The characteristics of someone or something'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.String UsageInfo.description()"})
  void testDescription_thenReturnTheCharacteristicsOfSomeoneOrSomething() {
