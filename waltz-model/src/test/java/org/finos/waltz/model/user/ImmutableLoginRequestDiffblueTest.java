...
class ImmutableLoginRequestDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link Builder#from(LoginRequest)}
   */
  @Test
  @DisplayName("Test Builder from(LoginRequest); given 'iloveyou'; then builder build password is 'iloveyou'")
   ...
   */
  @Test
  @DisplayName("Test Builder from(LoginRequest); then throw IllegalStateException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Builder Builder.from(LoginRequest)"})
