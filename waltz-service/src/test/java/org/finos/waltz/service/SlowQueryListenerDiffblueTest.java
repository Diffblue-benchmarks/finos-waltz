...
class SlowQueryListenerDiffblueTest {
  /**
   * Test SQLPerformanceWarning {@link SQLPerformanceWarning#SQLPerformanceWarning(SlowQueryListener, String)}.
   * <p>
   * Method under test: {@link SQLPerformanceWarning#SQLPerformanceWarning(SlowQueryListener, String)}
   */
  @Test
  ...
  void testSQLPerformanceWarningNewSQLPerformanceWarning() {
    // Arrange and Act
    SQLPerformanceWarning actualSqlPerformanceWarning = (new SlowQueryListener(1)).new SQLPerformanceWarning(
