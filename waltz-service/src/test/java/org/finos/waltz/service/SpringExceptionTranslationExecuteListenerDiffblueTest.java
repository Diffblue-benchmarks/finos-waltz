...
class SpringExceptionTranslationExecuteListenerDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>Then calls {@link ExecuteContext#exception()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * SpringExceptionTranslationExecuteListener#exception(ExecuteContext)}
   */
  @Test
  ...
  void testException_givenNull_thenCallsException() {
    // Arrange
    SpringExceptionTranslationExecuteListener springExceptionTranslationExecuteListener =
    ...
    when(ctx.exception()).thenReturn(new RuntimeException());
   ...
   *
   * <ul>
   *   <li>Then calls {@link ExecuteContext#exception(RuntimeException)}.
   * </ul>
   *
   * <p>Method under test: {@link
   * SpringExceptionTranslationExecuteListener#exception(ExecuteContext)}
