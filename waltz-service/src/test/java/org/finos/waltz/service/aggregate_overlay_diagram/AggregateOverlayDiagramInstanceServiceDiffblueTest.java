...
class AggregateOverlayDiagramInstanceServiceDiffblueTest {
  @Mock private AggregateOverlayDiagramInstanceDao aggregateOverlayDiagramInstanceDao;

  @InjectMocks
  private AggregateOverlayDiagramInstanceService aggregateOverlayDiagramInstanceService;
  ...
  void testFindAll() {
    ...
    Set<AggregateOverlayDiagramInstance> actualFindAllResult =
        aggregateOverlayDiagramInstanceService.findAll();
  ...
  void testFindByDiagramId() {
    ...
    Set<AggregateOverlayDiagramInstance> actualFindByDiagramIdResult =
        aggregateOverlayDiagramInstanceService.findByDiagramId(1L);
  ...
  void testGetById() {
    ...
    // Act
    AggregateOverlayDiagramInstance actualById = aggregateOverlayDiagramInstanceService.getById(1L);
  ...
  void testCreateInstance() {
    ...
    int actualCreateInstanceResult =
        aggregateOverlayDiagramInstanceService.createInstance(null, "janedoe");
