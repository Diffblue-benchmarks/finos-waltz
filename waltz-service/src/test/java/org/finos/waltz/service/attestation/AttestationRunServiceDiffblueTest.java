...
class AttestationRunServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test create(String, AttestationRunCreateCommand)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
   ...
   */
  @Test
  @DisplayName("Test create(String, AttestationRunCreateCommand); given HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.finos.waltz.model.IdCommandResponse AttestationRunService.create(String, AttestationRunCreateCommand)"
  })
  void testCreate_givenHashSet() {
    // Arrange
    AttestationRunDao attestationRunDao = mock(AttestationRunDao.class);
    when(attestationRunDao.updateRecipientInvolvementGroupId(anyLong(), Mockito.<Long>any()))
        .thenReturn(1);
   ...
   */
  @Test
  @DisplayName("Test create(String, AttestationRunCreateCommand); given HashSet() add one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.finos.waltz.model.IdCommandResponse AttestationRunService.create(String, AttestationRunCreateCommand)"
  })
  void testCreate_givenHashSetAddOne() {
    // Arrange
    AttestationRunDao attestationRunDao = mock(AttestationRunDao.class);
    when(attestationRunDao.updateRecipientInvolvementGroupId(anyLong(), Mockito.<Long>any()))
        .thenReturn(1);
   ...
   */
  @Test
  @DisplayName("Test create(String, AttestationRunCreateCommand); given HashSet() add two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.finos.waltz.model.IdCommandResponse AttestationRunService.create(String, AttestationRunCreateCommand)"
  })
  void testCreate_givenHashSetAddTwo() {
    // Arrange
    AttestationRunDao attestationRunDao = mock(AttestationRunDao.class);
    when(attestationRunDao.updateRecipientInvolvementGroupId(anyLong(), Mockito.<Long>any()))
        .thenReturn(1);
   ...
   */
  @Test
  @DisplayName("Test create(String, AttestationRunCreateCommand); given IllegalArgumentException()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.finos.waltz.model.IdCommandResponse AttestationRunService.create(String, AttestationRunCreateCommand)"
  })
  void testCreate_givenIllegalArgumentException() {
    // Arrange
    AttestationRunDao attestationRunDao = mock(AttestationRunDao.class);
    when(attestationRunDao.updateRecipientInvolvementGroupId(anyLong(), Mockito.<Long>any()))
        .thenReturn(1);
    ...
    AttestationRunCreateCommand command = mock(AttestationRunCreateCommand.class);
    when(command.attestedEntityKind()).thenThrow(new IllegalArgumentException());
    when(command.name()).thenReturn("Name");
    when(command.involvementKindIds()).thenReturn(new HashSet<>());
   ...
   *
   * <ul>
   *   <li>Given {@link AttestationInstanceDao}.
  ...
  @Test
  @DisplayName(
      "Test createRecipientsGroup(long, String, Set, String); given AttestationInstanceDao; then calls createGroup(InvolvementGroupCreateCommand, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttestationRunService.createRecipientsGroup(long, String, Set, String)"})
  void testCreateRecipientsGroup_givenAttestationInstanceDao_thenCallsCreateGroup() {
    // Arrange
    when(involvementGroupService.createGroup(
            Mockito.<InvolvementGroupCreateCommand>any(), Mockito.<String>any()))
        .thenThrow(new IllegalArgumentException());
   ...
   * <ul>
   *   <li>Given {@link InvolvementGroupService} {@link
   *       InvolvementGroupService#createGroup(InvolvementGroupCreateCommand, String)} return one.
   * </ul>
   *
   * <p>Method under test: {@link AttestationRunService#createRecipientsGroup(long, String, Set,
   * String)}
  ...
  @Test
  @DisplayName(
      "Test createRecipientsGroup(long, String, Set, String); given InvolvementGroupService createGroup(InvolvementGroupCreateCommand, String) return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AttestationRunService.createRecipientsGroup(long, String, Set, String)"})
  void testCreateRecipientsGroup_givenInvolvementGroupServiceCreateGroupReturnOne() {
    // Arrange
    AttestationRunDao attestationRunDao = mock(AttestationRunDao.class);
    when(attestationRunDao.updateRecipientInvolvementGroupId(anyLong(), Mockito.<Long>any()))
        .thenThrow(new IllegalArgumentException());
