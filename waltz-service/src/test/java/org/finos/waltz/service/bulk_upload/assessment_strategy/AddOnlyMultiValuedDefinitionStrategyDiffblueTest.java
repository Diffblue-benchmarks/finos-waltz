...
@ContextConfiguration(classes = {AddOnlyMultiValuedDefinitionStrategy.class})
@ExtendWith(SpringExtension.class)
class AddOnlyMultiValuedDefinitionStrategyDiffblueTest {
  @Autowired
  private AddOnlyMultiValuedDefinitionStrategy addOnlyMultiValuedDefinitionStrategy;

  /**
   * Method under test:
   * {@link AddOnlyMultiValuedDefinitionStrategy#apply(DSLContext, AssessmentDefinition, Set, Set, String)}
   */
  @Test
