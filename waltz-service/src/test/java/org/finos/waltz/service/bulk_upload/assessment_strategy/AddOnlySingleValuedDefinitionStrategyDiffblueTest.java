...
class AddOnlySingleValuedDefinitionStrategyDiffblueTest {
  /**
   * Test {@link AddOnlySingleValuedDefinitionStrategy#apply(DSLContext, AssessmentDefinition, Set, Set, String)}.
   * <ul>
   *   <li>Then calls {@link Connection#createStatement()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AddOnlySingleValuedDefinitionStrategy#apply(DSLContext, AssessmentDefinition, Set, Set, String)}
   */
  @Test
  ...
  void testApply_thenCallsCreateStatement() throws SQLException {
    // Arrange
    AddOnlySingleValuedDefinitionStrategy addOnlySingleValuedDefinitionStrategy = new AddOnlySingleValuedDefinitionStrategy();
