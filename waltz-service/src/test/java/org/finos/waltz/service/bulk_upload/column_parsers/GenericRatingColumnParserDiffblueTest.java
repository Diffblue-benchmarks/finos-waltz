...
class GenericRatingColumnParserDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link AssessmentHeaderCell#ratingLookupMap()}.
   * </ul>
   *
   * <p>Method under test: {@link GenericRatingColumnParser#apply(String, Collection)}
   */
  @Test
  @DisplayName(
      "Test apply(String, Collection) with 'String', 'Collection'; then calls ratingLookupMap()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"AssessmentCell GenericRatingColumnParser.apply(String, Collection)"})
  void testApplyWithStringCollection_thenCallsRatingLookupMap() {
    // Arrange
