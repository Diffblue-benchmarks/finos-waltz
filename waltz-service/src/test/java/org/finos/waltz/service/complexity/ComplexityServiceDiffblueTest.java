...
class ComplexityServiceDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set ComplexityService.findBySelector(EntityKind, IdSelectionOptions)"})
  void testFindBySelector_givenHashSetAddActive2() {
    // Arrange
    when(complexityDao.findBySelector(Mockito.<GenericSelector>any())).thenReturn(new HashSet<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set ComplexityService.findBySelector(EntityKind, IdSelectionOptions)"})
  void testFindBySelector_givenHashSetAddActive3() {
    // Arrange
    when(complexityDao.findBySelector(Mockito.<GenericSelector>any())).thenReturn(new HashSet<>());
  ...
  void testFindBySelector_whenChangeUnit() {
    ...
    // Act
    Set<Complexity> actualFindBySelectorResult =
        complexityService.findBySelector(EntityKind.CHANGE_UNIT, options);
   ...
   */
  @Test
  @DisplayName("Test populateMeasurableComplexities(); then calls getByName(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ComplexityService.populateMeasurableComplexities()"})
  void testPopulateMeasurableComplexities_thenCallsGetByName() {
    // Arrange
