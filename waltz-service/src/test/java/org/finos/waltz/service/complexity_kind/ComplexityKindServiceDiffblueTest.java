...
class ComplexityKindServiceDiffblueTest {
  ...
  void testFindAll() {
    ...
    // Act
    Set<ComplexityKind> actualFindAllResult =
        new ComplexityKindService(complexityKindDao).findAll();
  ...
  void testFindBySelector_whenFlowDiagram() {
    ...
    // Act
    Set<ComplexityKind> actualFindBySelectorResult =
        complexityKindService.findBySelector(EntityKind.FLOW_DIAGRAM, selectionOptions);
