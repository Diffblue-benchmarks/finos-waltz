...
class CostServiceDiffblueTest {
  @Mock private AllocatedCostDefinitionDao allocatedCostDefinitionDao;

  @Mock private CostDao costDao;
  ...
  @Test
  @DisplayName(
      "Test findBySelector(IdSelectionOptions, EntityKind, int); given HashSet() add 'REMOVED'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set CostService.findBySelector(IdSelectionOptions, EntityKind, int)"})
  ...
  @Test
  @DisplayName(
      "Test findBySelector(IdSelectionOptions, EntityKind, int); given HashSet() add 'REMOVED'; then calls scope()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set CostService.findBySelector(IdSelectionOptions, EntityKind, int)"})
  void testFindBySelector_givenHashSetAddRemoved_thenCallsScope() {
    // Arrange
    when(costDao.findBySelector(Mockito.<GenericSelector>any(), anyInt()))
        .thenReturn(new HashSet<>());
   ...
   */
  @Test
  @DisplayName("Test findBySelector(IdSelectionOptions, EntityKind, int); then calls scope()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set CostService.findBySelector(IdSelectionOptions, EntityKind, int)"})
  void testFindBySelector_thenCallsScope() {
    // Arrange
    when(costDao.findBySelector(Mockito.<GenericSelector>any(), anyInt()))
        .thenReturn(new HashSet<>());
  ...
  @Test
  @DisplayName(
      "Test findBySelector(IdSelectionOptions, EntityKind, int); when 'LICENCE'; then calls scope()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set CostService.findBySelector(IdSelectionOptions, EntityKind, int)"})
  void testFindBySelector_whenLicence_thenCallsScope() {
    // Arrange
    when(costDao.findBySelector(Mockito.<GenericSelector>any(), anyInt()))
        .thenReturn(new HashSet<>());
