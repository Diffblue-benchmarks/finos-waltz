...
class EntitySearchServiceDiffblueTest {
  /**
   * Method under test: {@link EntitySearchService#search(EntitySearchOptions)}
   */
  @Test
  void testSearch() {
    // Arrange
    ...
    ChangeInitiativeService changeInitiativeService2 = new ChangeInitiativeService(changeInitiativeDao2, searchDao2,
        relationshipDao2,
        new ChangeLogService(mock(ChangeLogDao.class), mock(ChangeLogSummariesDao.class), mock(PhysicalFlowDao.class),
            mock(PhysicalSpecificationDao.class), mock(LogicalFlowDao.class), mock(ApplicationDao.class),
            mock(MeasurableRatingReplacementDao.class), mock(MeasurableRatingDao.class),
    ...
    LogicalDataElementService logicalDataElementService = new LogicalDataElementService(
    ...
    EndUserAppService endUserAppService = new EndUserAppService(mock(EndUserAppDao.class), mock(ApplicationDao.class),
    ...
    OrganisationalUnitService organisationalUnitService = new OrganisationalUnitService(
    ...
    ServerInformationService serverInformationService = new ServerInformationService(mock(ServerInformationDao.class),
    ...
    DataTypeService dataTypeService2 = new DataTypeService(mock(DataTypeDao.class), mock(DataTypeSearchDao.class),
        mock(LogicalFlowDao.class));
    ...
    FlowDiagramService flowDiagramService = new FlowDiagramService(changeLogService, dataTypeService2, flowDiagramDao,
    ...
    LegalEntityService legalEntityService = new LegalEntityService(mock(LegalEntityDao.class),
        mock(LegalEntitySearchDao.class));

    DatabaseInformationService databaseInformationService = new DatabaseInformationService(
        mock(DatabaseInformationDao.class));
    EntitySearchService entitySearchService = new EntitySearchService(dbExecutorPool, actorService, applicationService,
        appGroupService, changeInitiativeService2, logicalDataElementService, dataTypeService, endUserAppService,
        measurableService, organisationalUnitService, personService, physicalSpecificationService, roadmapService,
        serverInformationService, softwareCatalogService, flowDiagramService, legalEntityService,
        databaseInformationService, new LicenceService(mock(LicenceDao.class), mock(LicenceSearchDao.class)));
  ...
  void testSearch2() {
    ...
    EntitySearchService entitySearchService = new EntitySearchService(dbExecutorPool, actorService, applicationService,
        ...
        databaseInformationService, new LicenceService(mock(LicenceDao.class), mock(LicenceSearchDao.class)));
    EntitySearchOptions options = mock(EntitySearchOptions.class);
    when(options.entityKinds()).thenThrow(new UnsupportedOperationException("options cannot be null"));
    when(options.searchQuery()).thenReturn("Search Query");
  ...
  void testSearch3() {
    ...
    EntitySearchOptions options = mock(EntitySearchOptions.class);
    when(options.entityKinds()).thenReturn(entityKindList);
    when(options.searchQuery()).thenReturn("Search Query");
  ...
  void testSearch4() {
    // Arrange
    DBExecutorPoolInterface dbExecutorPool = mock(DBExecutorPoolInterface.class);
    when(dbExecutorPool.submit(Mockito.<Callable<Object>>any())).thenReturn(new CompletableFuture<>());
    ActorService actorService = new ActorService(mock(ActorDao.class), mock(ActorSearchDao.class));
    ...
    // Act and Assert
    assertThrows(UnsupportedOperationException.class, () -> entitySearchService.search(options));
    verify(dbExecutorPool).submit(isA(Callable.class));
    verify(options).entityKinds();
    verify(options, atLeast(1)).searchQuery();
  }
}
