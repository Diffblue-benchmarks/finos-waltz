...
class EntityWorkflowServiceDiffblueTest {
  ...
  void testFindAllDefinitions() {
    ...
    EntityWorkflowDefinitionDao entityWorkflowDefinitionDao =
        mock(EntityWorkflowDefinitionDao.class);
    when(entityWorkflowDefinitionDao.findAll()).thenReturn(new ArrayList<>());
    EntityWorkflowService entityWorkflowService =
        new EntityWorkflowService(
            entityWorkflowDefinitionDao,
            mock(EntityWorkflowStateDao.class),
            mock(EntityWorkflowTransitionDao.class));
