...
class EnumValueAliasServiceDiffblueTest {
  @Mock private EnumValueAliasDao enumValueAliasDao;

  @InjectMocks private EnumValueAliasService enumValueAliasService;
  ...
  void testMkAliasesWithKind() {
    ...
    Aliases<String> actualMkAliasesResult =
        enumValueAliasService.mkAliases(EnumValueKind.TRANSPORT_KIND);
  ...
  void testMkAliasesWithKindMapper() {
    ...
    Aliases<Object> actualMkAliasesResult =
        enumValueAliasService.mkAliases(EnumValueKind.TRANSPORT_KIND, mock(Function.class));
