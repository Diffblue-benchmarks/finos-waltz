...
class FlowClassificationCalculatorDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test update(Long, EntityReference) with 'dataTypeId', 'vantageRef'; then return array of int with one and minus one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] FlowClassificationCalculator.update(Long, EntityReference)"})
  void testUpdateWithDataTypeIdVantageRef_thenReturnArrayOfIntWithOneAndMinusOne() {
    // Arrange
    when(dataTypeDao.getById(anyLong()))
        .thenReturn(
            ImmutableDataType.builder()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] FlowClassificationCalculator.update(Long, EntityReference)"})
  void testUpdateWithDataTypeIdVantageRef_thenReturnArrayOfIntWithOneAndMinusOne2() {
    // Arrange
    when(dataTypeDao.getById(anyLong()))
        .thenReturn(
            ImmutableDataType.builder()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] FlowClassificationCalculator.update(Long, EntityReference)"})
  void testUpdateWithDataTypeIdVantageRef_thenReturnArrayOfIntWithOneAndMinusOne3() {
    // Arrange
    when(dataTypeDao.getById(anyLong()))
        .thenReturn(
            ImmutableDataType.builder()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] FlowClassificationCalculator.update(Long, EntityReference)"})
  void testUpdateWithDataTypeIdVantageRef_thenReturnArrayOfIntWithOneAndMinusOne4() {
    // Arrange
    when(dataTypeDao.getById(anyLong()))
        .thenReturn(
            ImmutableDataType.builder()
    ...
    Builder decoratorEntityResult3 =
    ...
    Builder provenanceResult3 =
        decoratorEntityResult3
            ...
            .lastUpdatedBy("2020-03-01")
            .provenance("Provenance");
    Optional<? extends AuthoritativenessRatingValue> rating3 =
        Optional.of(AuthoritativenessRatingValue.of("42"));

    Builder ratingResult3 = provenanceResult3.rating(rating3);
    Optional<? extends AuthoritativenessRatingValue> targetInboundRating3 =
        Optional.of(AuthoritativenessRatingValue.of("42"));
    dataTypeDecoratorList2.add(ratingResult3.targetInboundRating(targetInboundRating3).build());
    when(logicalFlowDecoratorDao.updateDecorators(Mockito.<Set<DataTypeDecorator>>any()))
        .thenReturn(new int[] {1, -1, 1, -1});
    when(logicalFlowDecoratorDao.findByEntityIdSelector(
            Mockito.<Select<Record1<Long>>>any(), Mockito.<Optional<EntityKind>>any()))
  ...
  @Test
  @DisplayName(
      "Test update(Long, EntityReference) with 'dataTypeId', 'vantageRef'; then return empty array of int")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"int[] FlowClassificationCalculator.update(Long, EntityReference)"})
  void testUpdateWithDataTypeIdVantageRef_thenReturnEmptyArrayOfInt() {
    // Arrange
    when(dataTypeDao.getById(anyLong()))
        .thenReturn(
            ImmutableDataType.builder()
