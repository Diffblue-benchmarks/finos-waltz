...
class FlowClassificationServiceDiffblueTest {
  ...
  void testGetById() {
    ...
    // Act
    FlowClassification actualById =
        new FlowClassificationService(flowClassificationDao).getById(1L);
  ...
  void testFindAll() {
    ...
    // Act
    Set<FlowClassification> actualFindAllResult =
        new FlowClassificationService(flowClassificationDao).findAll();
