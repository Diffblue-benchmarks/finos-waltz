...
class LegalEntityRelationshipKindServiceDiffblueTest {
  @Mock private LegalEntityRelationshipKindDao legalEntityRelationshipKindDao;

  @InjectMocks private LegalEntityRelationshipKindService legalEntityRelationshipKindService;
  ...
  void testGetById() {
    ...
    // Act
    LegalEntityRelationshipKind actualById = legalEntityRelationshipKindService.getById(1L);
  ...
  void testFindAll() {
    ...
    Set<LegalEntityRelationshipKind> actualFindAllResult =
        legalEntityRelationshipKindService.findAll();
  ...
  void testFindUsageStats() {
    ...
    Set<LegalEntityRelKindStat> actualFindUsageStatsResult =
        legalEntityRelationshipKindService.findUsageStats();
