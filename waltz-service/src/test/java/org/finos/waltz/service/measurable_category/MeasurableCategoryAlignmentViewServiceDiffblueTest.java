...
class MeasurableCategoryAlignmentViewServiceDiffblueTest {
  ...
  void testFindAlignmentsByAppSelector() {
    // Arrange
    MeasurableCategoryAlignmentViewDao measurableCategoryAlignmentViewDao =
        mock(MeasurableCategoryAlignmentViewDao.class);
    when(measurableCategoryAlignmentViewDao.findAlignmentsByAppSelector(
            Mockito.<Select<Record1<Long>>>any()))
        .thenReturn(new HashSet<>());
    MeasurableCategoryAlignmentViewService measurableCategoryAlignmentViewService =
        new MeasurableCategoryAlignmentViewService(measurableCategoryAlignmentViewDao);
