...
class FlowPermissionCheckerDiffblueTest {
  ...
  void testFindPermissionsForDecorator_thenCallsFindExistingInvolvementKindIdsForUser2() {
    // Arrange
    LogicalFlowDao logicalFlowDao = mock(LogicalFlowDao.class);
    when(logicalFlowDao.calculateAmendedFlowOperations(
            Mockito.<Set<Operation>>any(), Mockito.<String>any()))
  ...
  @Test
  @DisplayName(
      "Test findPermissionsForDecorator(EntityReference, String); then calls findPermissionsForParentReference(EntityReference, String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Set FlowPermissionChecker.findPermissionsForDecorator(EntityReference, String)"
  })
  void testFindPermissionsForDecorator_thenCallsFindPermissionsForParentReference() {
    // Arrange
    LogicalFlowDao logicalFlowDao = mock(LogicalFlowDao.class);
    when(logicalFlowDao.calculateAmendedFlowOperations(
            Mockito.<Set<Operation>>any(), Mockito.<String>any()))
  ...
  @Test
  @DisplayName(
      "Test findPermissionsForDecorator(EntityReference, String); then calls getPersonByUserId(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Set FlowPermissionChecker.findPermissionsForDecorator(EntityReference, String)"
  })
  void testFindPermissionsForDecorator_thenCallsGetPersonByUserId() {
    // Arrange
    LogicalFlowDao logicalFlowDao = mock(LogicalFlowDao.class);
    when(logicalFlowDao.calculateAmendedFlowOperations(
            Mockito.<Set<Operation>>any(), Mockito.<String>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set FlowPermissionChecker.findPermissionsForSpec(long, String)"})
  void testFindPermissionsForSpec5() {
    // Arrange
    when(physicalSpecificationDao.calculateAmendedSpecOperations(
            Mockito.<Set<Operation>>any(), Mockito.<String>any()))
        .thenThrow(new UnsupportedOperationException());
  ...
  void testFindFlowPermissionsForParentEntity_thenCallsGetPersonByUserId() {
    ...
    // Act
    Set<Operation> actualFindFlowPermissionsForParentEntityResult =
        flowPermissionChecker.findFlowPermissionsForParentEntity(mock(EntityReference.class), "");

    // Assert
    verify(logicalFlowDao).calculateAmendedFlowOperations(isA(Set.class), eq(""));
    verify(permissionGroupDao).findPermissionsForParentEntityReference(isA(EntityReference.class));
    verify(involvementService)
        .findExistingInvolvementKindIdsForUser(isA(EntityReference.class), eq(""));
    verify(personService).getPersonByUserId("");
    assertTrue(actualFindFlowPermissionsForParentEntityResult.isEmpty());
  }
  ...
  void testFindSpecPermissionsForParentEntity_thenCallsGetPersonByUserId() {
    ...
    // Act
    Set<Operation> actualFindSpecPermissionsForParentEntityResult =
        flowPermissionChecker.findSpecPermissionsForParentEntity(mock(EntityReference.class), "");

    // Assert
    verify(permissionGroupDao).findPermissionsForParentEntityReference(isA(EntityReference.class));
    verify(physicalSpecificationDao).calculateAmendedSpecOperations(isA(Set.class), eq(""));
    verify(involvementService)
        .findExistingInvolvementKindIdsForUser(isA(EntityReference.class), eq(""));
    verify(personService).getPersonByUserId("");
    assertTrue(actualFindSpecPermissionsForParentEntityResult.isEmpty());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set FlowPermissionChecker.findPermissionsForFlow(Long, String)"})
  void testFindPermissionsForFlow5() {
    // Arrange
    when(logicalFlowDao.calculateAmendedFlowOperations(
            Mockito.<Set<Operation>>any(), Mockito.<String>any()))
        .thenThrow(new UnsupportedOperationException());
   ...
   */
  @Test
  @DisplayName("Test findPermissionsForFlow(Long, String); then calls getPersonByUserId(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set FlowPermissionChecker.findPermissionsForFlow(Long, String)"})
  void testFindPermissionsForFlow_thenCallsGetPersonByUserId() {
    // Arrange
    LogicalFlowDao logicalFlowDao = mock(LogicalFlowDao.class);
    when(logicalFlowDao.calculateAmendedFlowOperations(
            Mockito.<Set<Operation>>any(), Mockito.<String>any()))
    ...
    // Act
    Set<Operation> actualFindPermissionsForFlowResult =
        flowPermissionChecker.findPermissionsForFlow(1L, "");

    // Assert
    verify(logicalFlowDao, atLeast(1)).calculateAmendedFlowOperations(isA(Set.class), eq(""));
    verify(logicalFlowDao).getByFlowId(1L);
    verify(permissionGroupDao, atLeast(1))
        .findPermissionsForParentEntityReference(isA(EntityReference.class));
    verify(involvementService, atLeast(1))
        .findExistingInvolvementKindIdsForUser(isA(EntityReference.class), eq(""));
    verify(personService, atLeast(1)).getPersonByUserId("");
    assertTrue(actualFindPermissionsForFlowResult.isEmpty());
  }
  ...
  void testFindPermissionsForSourceAndTarget6() {
    ...
    assertThrows(
        ...
        () ->
            flowPermissionChecker.findPermissionsForSourceAndTarget(
                mock(EntityReference.class), mock(EntityReference.class), ""));
    verify(involvementService)
        .findExistingInvolvementKindIdsForUser(isA(EntityReference.class), eq(""));
    verify(permissionGroupService)
        .findPermissionsForParentReference(isA(EntityReference.class), eq(""));
  ...
  void testFindPermissionsForSourceAndTarget_thenCallsGetPersonByUserId() {
    ...
    verify(involvementService, atLeast(1))
        .findExistingInvolvementKindIdsForUser(Mockito.<EntityReference>any(), eq(""));
    verify(personService, atLeast(1)).getPersonByUserId("");
    assertTrue(actualFindPermissionsForSourceAndTargetResult.isEmpty());
  }
}
