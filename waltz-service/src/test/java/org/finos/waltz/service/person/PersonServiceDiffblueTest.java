...
class PersonServiceDiffblueTest {
  ...
  @Mock private PersonSearchDao personSearchDao;
   ...
   */
  @Test
  @DisplayName("Test getByEmployeeId(String); when '42'; then return ImmutablePerson")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Person PersonService.getByEmployeeId(String)"})
  void testGetByEmployeeId_when42_thenReturnImmutablePerson() {
    // Arrange
  ...
  void testFindDirectsByEmployeeId_when42_thenReturnEmpty() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test findDirectsForPersonIds(List); given PersonDao; when ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List PersonService.findDirectsForPersonIds(List)"})
  void testFindDirectsForPersonIds_givenPersonDao_whenArrayList() {
   ...
   */
  @Test
  @DisplayName("Test findDirectsForPersonIds(List); given PersonDao; when 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List PersonService.findDirectsForPersonIds(List)"})
  void testFindDirectsForPersonIds_givenPersonDao_whenNull() {
    // Arrange, Act and Assert
  ...
  void testFindAllManagersByEmployeeId_when42_thenReturnEmpty() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test search(String) with 'query'; given PersonSearchDao; when empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List PersonService.search(String)"})
  void testSearchWithQuery_givenPersonSearchDao_whenEmptyString() {
    // Arrange, Act and Assert
