...
class ImmutableCellVariableDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test Builder addOptions(CellOption) with 'element'; when CellOption; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderAddOptionsWithElement_whenCellOption_thenReturnBuilder() {
    ...
    // Act
    Builder actualAddOptionsResult = builderResult.addOptions(mock(CellOption.class));
  ...
  @Test
  @DisplayName(
      "Test Builder addOptions(CellOption[]) with 'elements'; when CellOption; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addOptions(CellOption[])"})
  ...
  @Test
  @DisplayName(
      "Test Builder addRatings(RatingSchemeItem) with 'element'; when RatingSchemeItem; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testBuilderAddRatingsWithElement_whenRatingSchemeItem_thenReturnBuilder() {
    ...
    // Act
    Builder actualAddRatingsResult = builderResult.addRatings(mock(RatingSchemeItem.class));
  ...
  @Test
  @DisplayName(
      "Test Builder addRatings(RatingSchemeItem[]) with 'elements'; when RatingSchemeItem; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.addRatings(RatingSchemeItem[])"})
