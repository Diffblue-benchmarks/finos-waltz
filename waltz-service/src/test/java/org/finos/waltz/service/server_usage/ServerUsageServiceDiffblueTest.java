...
class ServerUsageServiceDiffblueTest {
  ...
  void testFindByServerId() {
    ...
    // Act
    Collection<ServerUsage> actualFindByServerIdResult =
        new ServerUsageService(serverUsageDao).findByServerId(1L);
  ...
  void testFindByReferencedEntity() {
    ...
    Collection<ServerUsage> actualFindByReferencedEntityResult =
        new ServerUsageService(serverUsageDao).findByReferencedEntity(null);
