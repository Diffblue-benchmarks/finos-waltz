...
class SurveyInstanceActionQueueServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test performActions(); given DSLContext")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SurveyInstanceActionQueueService.performActions()"})
  void testPerformActions_givenDSLContext() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test performActions(); given DSLContext transaction(TransactionalRunnable) does nothing; then calls transaction(TransactionalRunnable)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SurveyInstanceActionQueueService.performActions()"})
  void testPerformActions_givenDSLContextTransactionDoesNothing_thenCallsTransaction() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SurveyInstanceActionQueueService.performActions()"})
  void testPerformActions_givenDSLContextTransactionDoesNothing_thenCallsTransaction2() {
    // Arrange
    ArrayList<SurveyInstanceActionQueueItem> surveyInstanceActionQueueItemList = new ArrayList<>();
