...
class SurveyInstanceViewServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test findByPersonId(long)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testFindByPersonId() {
    ...
    assertEquals(2, actualFindByPersonIdResult.size());
  }
   ...
   */
  @Test
  @DisplayName("Test findByPersonId(long); then return HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set SurveyInstanceViewService.findByPersonId(long)"})
  void testFindByPersonId_thenReturnHashSet() {
    // Arrange
    HashSet<SurveyInstanceInfo> surveyInstanceInfoSet = new HashSet<>();
    ...
    Builder historicalVersionsCountResult3 =
        ImmutableSurveyInstanceInfo.builder().historicalVersionsCount(3);

    ImmutableSurveyInstance.Builder owningRoleResult3 =
        ImmutableSurveyInstance.builder()
            .approvalDueDate(LocalDate.of(1970, 1, 1))
            .approvedAt(LocalDate.of(1970, 1, 1).atStartOfDay())
            .approvedBy("Approved By")
    ...
    ImmutableSurveyInstance.Builder submittedByResult3 =
        owningRoleResult3
            .qualifierEntity(
                ImmutableEntityReference.builder()
                    .description("The characteristics of someone or something")
    ...
    Builder surveyInstanceResult3 =
        historicalVersionsCountResult3.surveyInstance(
            submittedByResult3
                .surveyEntity(
                    ImmutableEntityReference.builder()
                        .description("The characteristics of someone or something")
    ...
    ImmutableSurveyRun.Builder ownerIdResult3 =
        ImmutableSurveyRun.builder()
            .approvalDueDate(LocalDate.of(1970, 1, 1))
            .contactEmail("jane.doe@example.org")
            .description("The characteristics of someone or something")
        ...
        builderResult3
            .entityReference(
                ImmutableEntityReference.builder()
                    ...
                    .build())
            .filters(ImmutableSelectionFilters.builder().build());
    Optional<? extends EntityKind> joiningEntityKind3 = Optional.of(EntityKind.ALL);

    ImmutableIdSelectionOptions.Builder joiningEntityKindResult3 =
        filtersResult3.joiningEntityKind(joiningEntityKind3);

    Builder surveyRunResult3 =
        surveyInstanceResult3.surveyRun(
            ownerIdResult3
                .selectionOptions(
                    joiningEntityKindResult3
                        .addAllEntityLifecycleStatuses(new ArrayList<>())
                        .scope(HierarchyQueryScope.EXACT)
                        .build())
                .status(SurveyRunStatus.DRAFT)
    ...
    verify(surveyViewDao).findForOwner(1L);
    verify(surveyViewDao).findForRecipient(1L);
    assertEquals(surveyInstanceInfoSet, actualFindByPersonIdResult);
  }
   ...
   */
  @Test
  @DisplayName("Test getFormDetailsById(long); given PersonDao; then calls eval(long)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "SurveyInstanceFormDetails SurveyInstanceViewService.getFormDetailsById(long)"
  })
  void testGetFormDetailsById_givenPersonDao_thenCallsEval() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test getFormDetailsById(long); then calls getById(long)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "SurveyInstanceFormDetails SurveyInstanceViewService.getFormDetailsById(long)"
  })
  void testGetFormDetailsById_thenCallsGetById() {
    // Arrange
    SurveyQuestionDao questionDao = mock(SurveyQuestionDao.class);
    when(questionDao.findForSurveyInstance(anyLong())).thenReturn(new ArrayList<>());
