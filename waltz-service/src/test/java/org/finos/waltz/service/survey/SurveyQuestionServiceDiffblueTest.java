...
class SurveyQuestionServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test findForIds(Set); when HashSet(); then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set SurveyQuestionService.findForIds(Set)"})
  void testFindForIds_whenHashSet_thenReturnEmpty() {
    // Arrange
    SurveyQuestionDao surveyQuestionDao = mock(SurveyQuestionDao.class);
    SurveyInstanceEvaluator evaluator =
        new SurveyInstanceEvaluator(
   ...
   */
  @Test
  @DisplayName("Test findForIds(Set); when 'null'; then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Set SurveyQuestionService.findForIds(Set)"})
  void testFindForIds_whenNull_thenReturnEmpty() {
    // Arrange
    SurveyQuestionDao surveyQuestionDao = mock(SurveyQuestionDao.class);
    SurveyInstanceEvaluator evaluator =
        new SurveyInstanceEvaluator(
