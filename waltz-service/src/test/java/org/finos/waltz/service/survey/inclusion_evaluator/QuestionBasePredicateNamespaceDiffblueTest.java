...
class QuestionBasePredicateNamespaceDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link SurveyQuestion} {@link ExternalIdProvider#externalId()} return empty.</li>
   * </ul>
   * <p>
   * Method under test: {@link QuestionBasePredicateNamespace#QuestionBasePredicateNamespace(List, Map)}
   */
  @Test
  @DisplayName("Test new QuestionBasePredicateNamespace(List, Map); given SurveyQuestion externalId() return empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void QuestionBasePredicateNamespace.<init>(List, Map)"})
  void testNewQuestionBasePredicateNamespace_givenSurveyQuestionExternalIdReturnEmpty() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test new QuestionBasePredicateNamespace(List, Map); then calls externalId()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void QuestionBasePredicateNamespace.<init>(List, Map)"})
  void testNewQuestionBasePredicateNamespace_thenCallsExternalId() {
    // Arrange
    SurveyQuestion surveyQuestion = mock(SurveyQuestion.class);
    Optional<String> ofResult = Optional.of("foo");
    when(surveyQuestion.externalId()).thenReturn(ofResult);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void QuestionBasePredicateNamespace.<init>(List, Map)"})
  void testNewQuestionBasePredicateNamespace_thenCallsExternalId2() {
    // Arrange
    SurveyQuestion surveyQuestion = mock(SurveyQuestion.class);
    Optional<String> ofResult = Optional.of("foo");
    when(surveyQuestion.externalId()).thenReturn(ofResult);
