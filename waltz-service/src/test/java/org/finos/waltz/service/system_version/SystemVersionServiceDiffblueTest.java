...
class SystemVersionServiceDiffblueTest {
  ...
  @InjectMocks private SystemVersionService systemVersionService;
   ...
   *   <li>Then return databaseVersions first is {@code 42}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test getVersionInfo(); given ArrayList() add '42'; then return databaseVersions first is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"SystemVersionInfo SystemVersionService.getVersionInfo()"})
  void testGetVersionInfo_givenArrayListAdd42_thenReturnDatabaseVersionsFirstIs42()
    ...
    // Act
    SystemVersionInfo actualVersionInfo = systemVersionService.getVersionInfo();
    ...
    assertEquals("42", databaseVersionsResult.get(0));
   ...
   *
   * <ul>
   *   <li>Then return databaseVersions first is {@code -1}.
   * </ul>
   *
   * <p>Method under test: {@link SystemVersionService#getVersionInfo()}
   */
  @Test
  @DisplayName("Test getVersionInfo(); then return databaseVersions first is '-1'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"SystemVersionInfo SystemVersionService.getVersionInfo()"})
  void testGetVersionInfo_thenReturnDatabaseVersionsFirstIs1() throws SQLException {
    // Arrange
