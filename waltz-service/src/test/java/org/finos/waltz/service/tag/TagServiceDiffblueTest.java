...
class TagServiceDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test updateTags(EntityReference, Collection, String); given '42'; when ArrayList() add '42'; then calls createTagUsage(EntityReference, String, Long)")
  @org.junit.jupiter.api.Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List TagService.updateTags(EntityReference, Collection, String)"})
  void testUpdateTags_given42_whenArrayListAdd42_thenCallsCreateTagUsage() {
    // Arrange
    ...
    verify(changeLogService)
        .writeChangeLogEntries(
            ...
            eq("janedoe"),
            eq(" Added tags: [foo, 42]. Removed tags: [Name]. "),
            eq(Operation.UPDATE));
   ...
   * <ul>
   *   <li>Given {@code Name}.
   *   <li>When {@link ArrayList#ArrayList()} add {@code Name}.
  ...
  @Test
  @DisplayName(
      "Test updateTags(EntityReference, Collection, String); given 'Name'; when ArrayList() add 'Name'; then return first tagUsages size is one")
  @org.junit.jupiter.api.Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List TagService.updateTags(EntityReference, Collection, String)"})
  void testUpdateTags_givenName_whenArrayListAddName_thenReturnFirstTagUsagesSizeIsOne() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test updateTags(EntityReference, Collection, String); then return Empty")
  @org.junit.jupiter.api.Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List TagService.updateTags(EntityReference, Collection, String)"})
  void testUpdateTags_thenReturnEmpty() {
    // Arrange
    TagDao tagDao = mock(TagDao.class);
    when(tagDao.findTagsForEntityReference(Mockito.<EntityReference>any()))
        .thenReturn(new ArrayList<>());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List TagService.updateTags(EntityReference, Collection, String)"})
  void testUpdateTags_thenReturnFirstTagUsagesSizeIsOne2() {
    // Arrange
    ImmutableTag.Builder builderResult = ImmutableTag.builder();
   ...
   * <ul>
   *   <li>When {@link ArrayList#ArrayList()}.
   *   <li>Then return first tagUsages Empty.
   * </ul>
   *
   * <p>Method under test: {@link TagService#updateTags(EntityReference, Collection, String)}
   */
  @Test
  @DisplayName(
      "Test updateTags(EntityReference, Collection, String); when ArrayList(); then return first tagUsages Empty")
  @org.junit.jupiter.api.Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List TagService.updateTags(EntityReference, Collection, String)"})
  void testUpdateTags_whenArrayList_thenReturnFirstTagUsagesEmpty() {
    // Arrange
    ArrayList<Tag> tagList = new ArrayList<>();
    tagList.add(ImmutableTag.builder().id(1L).name("Name").targetKind(EntityKind.ALL).build());
    tagList.add(ImmutableTag.builder().id(1L).name("Name").targetKind(EntityKind.ALL).build());
