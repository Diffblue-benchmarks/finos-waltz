...
class AddMeasurableCommandProcessorDiffblueTest {
  /**
   * Method under test: {@link AddMeasurableCommandProcessor#supportedTypes()}
   */
  @Test
  void testSupportedTypes() {
    ...
    // Act
    Set<TaxonomyChangeType> actualSupportedTypesResult = (new AddMeasurableCommandProcessor(
  ...
  /**
   * Method under test: {@link AddMeasurableCommandProcessor#domain()}
   */
  @Test
  void testDomain() {
    // Arrange
