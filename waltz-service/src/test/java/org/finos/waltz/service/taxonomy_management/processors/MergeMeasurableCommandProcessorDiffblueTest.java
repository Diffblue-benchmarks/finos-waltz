...
class MergeMeasurableCommandProcessorDiffblueTest {
  /**
   * Method under test: {@link MergeMeasurableCommandProcessor#supportedTypes()}
   */
  @Test
  void testSupportedTypes() {
    ...
    // Act
    Set<TaxonomyChangeType> actualSupportedTypesResult = (new MergeMeasurableCommandProcessor(
        ...
        mock(TaxonomyManagementHelper.class))).supportedTypes();
  ...
  /**
   * Method under test: {@link MergeMeasurableCommandProcessor#domain()}
   */
  @Test
  void testDomain() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(EntityKind.MEASURABLE_CATEGORY, (new MergeMeasurableCommandProcessor(
        new MeasurableService(measurableDao, measurableSearchDao, nameResolver,
            new ChangeLogService(mock(ChangeLogDao.class), mock(ChangeLogSummariesDao.class),
                mock(PhysicalFlowDao.class), mock(PhysicalSpecificationDao.class), mock(LogicalFlowDao.class),
                mock(ApplicationDao.class), mock(MeasurableRatingReplacementDao.class), mock(MeasurableRatingDao.class),
                mock(MeasurableRatingPlannedDecommissionDao.class), mock(EntityReferenceNameResolver.class))),
        mock(TaxonomyManagementHelper.class))).domain());
  }
}
