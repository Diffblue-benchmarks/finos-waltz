...
class ReorderSiblingsMeasurableCommandProcessorDiffblueTest {
  /**
   * Method under test:
   * {@link ReorderSiblingsMeasurableCommandProcessor#supportedTypes()}
   */
  @Test
  void testSupportedTypes() {
    ...
    // Act
    Set<TaxonomyChangeType> actualSupportedTypesResult = (new ReorderSiblingsMeasurableCommandProcessor(
  ...
  /**
   * Method under test: {@link ReorderSiblingsMeasurableCommandProcessor#domain()}
   */
  @Test
  void testDomain() {
    // Arrange
    ...
    assertEquals(EntityKind.MEASURABLE_CATEGORY,
        (new ReorderSiblingsMeasurableCommandProcessor(new MeasurableService(measurableDao, measurableSearchDao,
            nameResolver,
            new ChangeLogService(mock(ChangeLogDao.class), mock(ChangeLogSummariesDao.class),
                mock(PhysicalFlowDao.class), mock(PhysicalSpecificationDao.class), mock(LogicalFlowDao.class),
                mock(ApplicationDao.class), mock(MeasurableRatingReplacementDao.class), mock(MeasurableRatingDao.class),
