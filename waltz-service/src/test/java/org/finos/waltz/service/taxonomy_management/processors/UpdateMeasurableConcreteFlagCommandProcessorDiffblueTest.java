...
class UpdateMeasurableConcreteFlagCommandProcessorDiffblueTest {
  /**
   * Method under test:
   * {@link UpdateMeasurableConcreteFlagCommandProcessor#supportedTypes()}
   */
  @Test
  void testSupportedTypes() {
    ...
    // Act
    Set<TaxonomyChangeType> actualSupportedTypesResult = (new UpdateMeasurableConcreteFlagCommandProcessor(
        measurableService,
  ...
  /**
   * Method under test:
   * {@link UpdateMeasurableConcreteFlagCommandProcessor#domain()}
   */
  @Test
  void testDomain() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(EntityKind.MEASURABLE_CATEGORY, (new UpdateMeasurableConcreteFlagCommandProcessor(measurableService,
        new MeasurableRatingService(measurableRatingDao, measurableDao2, measurableCategoryDao, changeLogService,
            ratingSchemeService, entityReferenceNameResolver, measurableService2, new ApplicationService(appDao,
                new TagService(mock(TagDao.class), null), mock(EntityAliasDao.class), mock(ApplicationSearchDao.class)),
