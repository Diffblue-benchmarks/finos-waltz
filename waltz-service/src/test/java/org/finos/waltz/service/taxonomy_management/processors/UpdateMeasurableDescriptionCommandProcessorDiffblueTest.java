...
class UpdateMeasurableDescriptionCommandProcessorDiffblueTest {
  /**
   * Method under test:
   * {@link UpdateMeasurableDescriptionCommandProcessor#supportedTypes()}
   */
  @Test
  void testSupportedTypes() {
    ...
    // Act
    Set<TaxonomyChangeType> actualSupportedTypesResult = (new UpdateMeasurableDescriptionCommandProcessor(
        measurableService,
  ...
  /**
   * Method under test:
   * {@link UpdateMeasurableDescriptionCommandProcessor#domain()}
   */
  @Test
  void testDomain() {
    // Arrange
    ...
    // Act and Assert
    assertEquals(EntityKind.MEASURABLE_CATEGORY, (new UpdateMeasurableDescriptionCommandProcessor(measurableService,
        new MeasurableRatingService(measurableRatingDao, measurableDao2, measurableCategoryDao, changeLogService,
            ratingSchemeService, entityReferenceNameResolver, measurableService2, new ApplicationService(appDao,
                new TagService(mock(TagDao.class), null), mock(EntityAliasDao.class), mock(ApplicationSearchDao.class)),
