...
class UpdateMeasurableDescriptionCommandProcessorDiffblueTest {
  ...
  void testSupportedTypes() {
    ...
    UpdateMeasurableDescriptionCommandProcessor updateMeasurableDescriptionCommandProcessor =
        new UpdateMeasurableDescriptionCommandProcessor(measurableService, measurableRatingService);
