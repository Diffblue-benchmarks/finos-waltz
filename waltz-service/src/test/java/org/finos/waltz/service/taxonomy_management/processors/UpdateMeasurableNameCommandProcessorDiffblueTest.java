...
class UpdateMeasurableNameCommandProcessorDiffblueTest {
  ...
  void testSupportedTypes() {
    ...
    UpdateMeasurableNameCommandProcessor updateMeasurableNameCommandProcessor =
        new UpdateMeasurableNameCommandProcessor(measurableService, measurableRatingService);
