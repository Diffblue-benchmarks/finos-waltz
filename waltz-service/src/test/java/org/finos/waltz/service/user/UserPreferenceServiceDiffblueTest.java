...
class UserPreferenceServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test getPreferences(String); then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List UserPreferenceService.getPreferences(String)"})
  void testGetPreferences_thenReturnEmpty() {
    // Arrange
    ...
    // Act
    List<UserPreference> actualPreferences =
        new UserPreferenceService(userPreferenceDao).getPreferences("janedoe");
   ...
   */
  @Test
  @DisplayName("Test savePreferences(String, List); then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List UserPreferenceService.savePreferences(String, List)"})
  void testSavePreferences_thenReturnEmpty() {
    // Arrange
    UserPreferenceDao userPreferenceDao = mock(UserPreferenceDao.class);
    when(userPreferenceDao.savePreferencesForUser(
            Mockito.<String>any(), Mockito.<List<UserPreference>>any()))
   ...
   */
  @Test
  @DisplayName("Test clearPreferences(String); then return 'true'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean UserPreferenceService.clearPreferences(String)"})
  void testClearPreferences_thenReturnTrue() {
    // Arrange
    UserPreferenceDao userPreferenceDao = mock(UserPreferenceDao.class);
    doNothing().when(userPreferenceDao).clearPreferencesForUser(Mockito.<String>any());

    // Act
    boolean actualClearPreferencesResult =
        new UserPreferenceService(userPreferenceDao).clearPreferences("janedoe");
