...
class UserContributionServiceDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test getRankedLeaderBoard(String); then return first id is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List UserContributionService.getRankedLeaderBoard(String)"})
  void testGetRankedLeaderBoard_thenReturnFirstIdIs42() {
    // Arrange
    ArrayList<OrderedTally<String>> orderedTallyList = new ArrayList<>();
   ...
   *
   * <ul>
   *   <li>Then return second id is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link UserContributionService#getRankedLeaderBoard(String)}
   */
  @Test
  @DisplayName("Test getRankedLeaderBoard(String); then return second id is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List UserContributionService.getRankedLeaderBoard(String)"})
  void testGetRankedLeaderBoard_thenReturnSecondIdIs42() {
    // Arrange
    ArrayList<OrderedTally<String>> orderedTallyList = new ArrayList<>();
   ...
   */
  @Test
  @DisplayName("Test getRankedLeaderBoard(String); when 'User Id'; then return first id is '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List UserContributionService.getRankedLeaderBoard(String)"})
  void testGetRankedLeaderBoard_whenUserId_thenReturnFirstIdIs42() {
    // Arrange
    ArrayList<OrderedTally<String>> orderedTallyList = new ArrayList<>();
   ...
   */
  @Test
  @DisplayName("Test findScoresForDirectReports(String); when '42'; then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List UserContributionService.findScoresForDirectReports(String)"})
  void testFindScoresForDirectReports_when42_thenReturnEmpty() {
    // Arrange
    when(changeLogDao.getContributionScoresForUsers(Mockito.<List<String>>any()))
        .thenReturn(new ArrayList<>());
