...
class ContextVariableReferenceDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ContextVariableReference#mkVarRef(EntityKind, String)}
   */
  @Test
  @DisplayName("Test mkVarRef(EntityKind, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ContextVariableReference ContextVariableReference.mkVarRef(EntityKind, String)"})
  void testMkVarRef() {
    // Arrange and Act
