...
class ReferenceBuilderNamespaceDiffblueTest {
   ...
   *
   * <p>Method under test: {@link ReferenceBuilderNamespace#assessment(String)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link ReferenceBuilderNamespace#surveyQuestionResponse(String, String)}
   */
  @Test
  ...
  void testSurveyQuestionResponse() {
    // Arrange and Act
    SurveyQuestionResponseContextVariableReference actualSurveyQuestionResponseResult =
        ReferenceBuilderNamespace.surveyQuestionResponse("42", "42");

    // Assert
    assertTrue(
        actualSurveyQuestionResponseResult
            instanceof ImmutableSurveyQuestionResponseContextVariableReference);
