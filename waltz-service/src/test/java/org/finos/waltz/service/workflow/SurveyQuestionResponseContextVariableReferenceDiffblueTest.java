...
class SurveyQuestionResponseContextVariableReferenceDiffblueTest {
  /**
   * Test {@link SurveyQuestionResponseContextVariableReference#mkVarRef(String, String)} with
   * {@code surveyExternalId}, {@code externalId}.
   *
   * <p>Method under test: {@link SurveyQuestionResponseContextVariableReference#mkVarRef(String,
   * String)}
   */
  @Test
  ...
  void testMkVarRefWithSurveyExternalIdExternalId() {
    // Arrange and Act
    SurveyQuestionResponseContextVariableReference actualMkVarRefResult =
        SurveyQuestionResponseContextVariableReference.mkVarRef("42", "42");

    // Assert
    assertTrue(
        actualMkVarRefResult instanceof ImmutableSurveyQuestionResponseContextVariableReference);
