...
class AssessmentSideEffectNamespaceDiffblueTest {
   ...
   * <p>
   * Method under test: {@link AssessmentSideEffectNamespace#update(String, String)}
   */
  @Test
  @DisplayName("Test update(String, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ImmutableAssessmentRatingUpdateSideEffect AssessmentSideEffectNamespace.update(String, String)"})
  void testUpdate() {
    // Arrange and Act
