...
class AllocationSchemeHelperDiffblueTest {
  @InjectMocks private AllocationSchemeHelper allocationSchemeHelper;
   ...
   *
   * <p>Method under test: {@link AllocationSchemeHelper#createAllocationScheme(String, long,
   * String, String)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "long AllocationSchemeHelper.createAllocationScheme(String, long, String, String)"
  })
  void testCreateAllocationScheme() {
    ...
    // Act
    long actualCreateAllocationSchemeResult =
        allocationSchemeHelper.createAllocationScheme(
            "The characteristics of someone or something", 1L, "Name", "42");
