...
class AssessmentHelperDiffblueTest {
  ...
  @InjectMocks private AssessmentHelper assessmentHelper;
  ...
  /**
   * Test {@link AssessmentHelper#createDefinition(long, String, String, AssessmentVisibility,
   * String)} with {@code schemeId}, {@code name}, {@code permittedRole}, {@code visibility}, {@code
   * definitionGroup}.
   *
   * <p>Method under test: {@link AssessmentHelper#createDefinition(long, String, String,
   * AssessmentVisibility, String)}
   */
  @Test
  @DisplayName(
      "Test createDefinition(long, String, String, AssessmentVisibility, String) with 'schemeId', 'name', 'permittedRole', 'visibility', 'definitionGroup'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "long AssessmentHelper.createDefinition(long, String, String, AssessmentVisibility, String)"
  })
  void testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroup() {
    ...
    // Act
    long actualCreateDefinitionResult =
        assessmentHelper.createDefinition(
            1L, "Name", "Permitted Role", AssessmentVisibility.PRIMARY, "Definition Group");
  ...
  void testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroup2() {
    ...
    long actualCreateDefinitionResult =
        assessmentHelper.createDefinition(
            1L, "Name", "", AssessmentVisibility.PRIMARY, "Definition Group");
  ...
  void testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroup3() {
    ...
    long actualCreateDefinitionResult =
        assessmentHelper.createDefinition(
            1L, "Name", "Permitted Role", AssessmentVisibility.PRIMARY, "");
  ...
  /**
   * Test {@link AssessmentHelper#createDefinition(long, String, String, AssessmentVisibility,
   * String, EntityKind, Cardinality, Optional)} with {@code schemeId}, {@code name}, {@code
   * permittedRole}, {@code visibility}, {@code definitionGroup}, {@code entityKind}, {@code
   * cardinality}, {@code qualifierRef}.
   *
   * <p>Method under test: {@link AssessmentHelper#createDefinition(long, String, String,
   * AssessmentVisibility, String, EntityKind, Cardinality, Optional)}
   */
  @Test
  @DisplayName(
      "Test createDefinition(long, String, String, AssessmentVisibility, String, EntityKind, Cardinality, Optional) with 'schemeId', 'name', 'permittedRole', 'visibility', 'definitionGroup', 'entityKind', 'cardinality', 'qualifierRef'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void
      testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroupEntityKindCardinalityQualifierRef() {
    // Arrange
    when(assessmentDefinitionService.save(Mockito.<AssessmentDefinition>any())).thenReturn(1L);
  ...
  void
      testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroupEntityKindCardinalityQualifierRef2() {
    // Arrange
    when(assessmentDefinitionService.save(Mockito.<AssessmentDefinition>any())).thenReturn(1L);
    ImmutableEntityReference immutableEntityReference =
        ImmutableEntityReference.builder()
  ...
  void
      testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroupEntityKindCardinalityQualifierRef3() {
    // Arrange
    when(assessmentDefinitionService.save(Mockito.<AssessmentDefinition>any())).thenReturn(1L);
    ImmutableEntityReference immutableEntityReference =
        ImmutableEntityReference.builder()
  ...
  /**
   * Test {@link AssessmentHelper#createDefinition(long, String, String, AssessmentVisibility,
   * String, EntityKind, EntityReference)} with {@code schemeId}, {@code name}, {@code
   * permittedRole}, {@code visibility}, {@code definitionGroup}, {@code entityKind}, {@code
   * qualifierRef}.
   *
   * <p>Method under test: {@link AssessmentHelper#createDefinition(long, String, String,
   * AssessmentVisibility, String, EntityKind, EntityReference)}
   */
  @Test
  @DisplayName(
      "Test createDefinition(long, String, String, AssessmentVisibility, String, EntityKind, EntityReference) with 'schemeId', 'name', 'permittedRole', 'visibility', 'definitionGroup', 'entityKind', 'qualifierRef'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void
      testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroupEntityKindQualifierRef() {
    // Arrange
    when(assessmentDefinitionService.save(Mockito.<AssessmentDefinition>any())).thenReturn(1L);
  ...
  void
      testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroupEntityKindQualifierRef2() {
    // Arrange
    when(assessmentDefinitionService.save(Mockito.<AssessmentDefinition>any())).thenReturn(1L);
    ...
    long actualCreateDefinitionResult =
        assessmentHelper.createDefinition(
            1L, "Name", "", AssessmentVisibility.PRIMARY, "Definition Group", EntityKind.ALL, null);
  ...
  void
      testCreateDefinitionWithSchemeIdNamePermittedRoleVisibilityDefinitionGroupEntityKindQualifierRef3() {
    // Arrange
    when(assessmentDefinitionService.save(Mockito.<AssessmentDefinition>any())).thenReturn(1L);
    ...
    long actualCreateDefinitionResult =
        assessmentHelper.createDefinition(
            1L, "Name", "Permitted Role", AssessmentVisibility.PRIMARY, "", EntityKind.ALL, null);
  ...
  /**
   * Test {@link AssessmentHelper#createAssessment(Long, EntityReference, Long, String)} with {@code
   * defId}, {@code ref}, {@code ratingId}, {@code username}.
   *
   * <p>Method under test: {@link AssessmentHelper#createAssessment(Long, EntityReference, Long,
   * String)}
   */
  @Test
  @DisplayName(
      "Test createAssessment(Long, EntityReference, Long, String) with 'defId', 'ref', 'ratingId', 'username'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testCreateAssessmentWithDefIdRefRatingIdUsername() throws InsufficientPrivelegeException {
    // Arrange
    when(assessmentRatingService.store(
            Mockito.<SaveAssessmentRatingCommand>any(), Mockito.<String>any()))
        .thenReturn(true);

    // Act
    assessmentHelper.createAssessment(
        1L,
        ImmutableEntityReference.builder()
            .description("The characteristics of someone or something")
            .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
  ...
  /**
   * Test {@link AssessmentHelper#createAssessment(Long, EntityReference, Long)} with {@code defId},
   * {@code ref}, {@code ratingId}.
   *
   * <ul>
   *   <li>Then calls {@link DSLContext#insertInto(Table)}.
   * </ul>
   *
   * <p>Method under test: {@link AssessmentHelper#createAssessment(Long, EntityReference, Long)}
   */
  @Test
  @DisplayName(
      "Test createAssessment(Long, EntityReference, Long) with 'defId', 'ref', 'ratingId'; then calls insertInto(Table)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AssessmentHelper.createAssessment(Long, EntityReference, Long)"})
  void testCreateAssessmentWithDefIdRefRatingId_thenCallsInsertInto() throws DataAccessException {
    // Arrange
    InsertReturningStep<AssessmentRatingRecord> insertReturningStep =
    ...
    when(dSLContext.insertInto(Mockito.<Table<AssessmentRatingRecord>>any()))
        .thenReturn(insertSetStep);
    when(dSLContext.newRecord(Mockito.<Table<AssessmentRatingRecord>>any()))
   ...
   *
   * <ul>
   *   <li>Then calls {@link AssessmentRatingRecord#setAssessmentDefinitionId(Long)}.
   * </ul>
   *
   * <p>Method under test: {@link AssessmentHelper#createAssessment(Long, EntityReference, Long)}
   */
  @Test
  @DisplayName(
      "Test createAssessment(Long, EntityReference, Long) with 'defId', 'ref', 'ratingId'; then calls setAssessmentDefinitionId(Long)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AssessmentHelper.createAssessment(Long, EntityReference, Long)"})
  void testCreateAssessmentWithDefIdRefRatingId_thenCallsSetAssessmentDefinitionId()
    ...
    verify(assessmentRatingRecord).setDescription("test");
    verify(assessmentRatingRecord).setEntityId(1L);
    verify(assessmentRatingRecord).setEntityKind("ALL");
    verify(assessmentRatingRecord).setIsReadonly(false);
    verify(assessmentRatingRecord).setLastUpdatedAt(isA(Timestamp.class));
    verify(assessmentRatingRecord).setLastUpdatedBy("test");
    verify(assessmentRatingRecord).setProvenance("test");
   ...
   *
   * <p>Method under test: {@link AssessmentHelper#updateDefinitionReadOnly(long)}
   */
  @Test
  ...
  void testUpdateDefinitionReadOnly() throws DataAccessException {
    // Arrange
    UpdateConditionStep<AssessmentDefinitionRecord> updateConditionStep =
    ...
    UpdateSetFirstStep<AssessmentDefinitionRecord> updateSetFirstStep =
    ...
    when(dSLContext.update(Mockito.<Table<AssessmentDefinitionRecord>>any()))
   ...
   * </ul>
   *
   * <p>Method under test: {@link AssessmentHelper#updateRatingReadOnly(EntityReference, long)}
   */
  @Test
  @DisplayName("Test updateRatingReadOnly(EntityReference, long); then calls update(Table)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AssessmentHelper.updateRatingReadOnly(EntityReference, long)"})
  void testUpdateRatingReadOnly_thenCallsUpdate() throws DataAccessException {
    // Arrange
    ...
    // Act
    assessmentHelper.updateRatingReadOnly(
        ImmutableEntityReference.builder()
            .description("The characteristics of someone or something")
            .entityLifecycleStatus(EntityLifecycleStatus.ACTIVE)
            .externalId("42")
   ...
   *
   * <p>Method under test: {@link AssessmentHelper#setDefExtId(long, String)}
   */
  @Test
