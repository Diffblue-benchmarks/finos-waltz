...
class DataTypeHelperDiffblueTest {
  ...
  /**
   * Test {@link DataTypeHelper#createDataType(Long, String, String)} with {@code id}, {@code name}, {@code code}.
   * <p>
   * Method under test: {@link DataTypeHelper#createDataType(Long, String, String)}
   */
  @Test
