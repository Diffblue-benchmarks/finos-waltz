...
class MeasurableHelperDiffblueTest {
  ...
  @InjectMocks private MeasurableHelper measurableHelper;

  /**
   * Test {@link MeasurableHelper#createMeasurableCategory(String, String)} with {@code name},
   * {@code ratingEditorRole}.
   *
   * <ul>
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link MeasurableHelper#createMeasurableCategory(String, String)}
   */
  @Test
  @DisplayName(
      "Test createMeasurableCategory(String, String) with 'name', 'ratingEditorRole'; then return one")
  ...
  void testCreateMeasurableCategoryWithNameRatingEditorRole_thenReturnOne() {
    ...
    measurableCategorySet.add(
        ImmutableMeasurableCategory.builder()
            ...
            .ratingSchemeId(1L)
            .build());
    when(measurableCategoryService.findByExternalId(Mockito.<String>any()))
        .thenReturn(measurableCategorySet);
    ...
    // Act
    long actualCreateMeasurableCategoryResult =
        measurableHelper.createMeasurableCategory("Name", "Rating Editor Role");

    // Assert
    verify(measurableCategoryService).findByExternalId("Name");
   ...
   * </ul>
   *
   * <p>Method under test: {@link MeasurableHelper#createMeasurableCategory(String)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link MeasurableHelper#updateCategoryNotEditable(long)}
   */
  @Test
  ...
  void testUpdateCategoryNotEditable() throws DataAccessException {
    // Arrange
    UpdateConditionStep<MeasurableCategoryRecord> updateConditionStep =
    ...
    UpdateSetFirstStep<MeasurableCategoryRecord> updateSetFirstStep =
    ...
    when(dSLContext.update(Mockito.<Table<MeasurableCategoryRecord>>any()))
  ...
  /**
   * Test {@link MeasurableHelper#createMeasurable(String, String, long)} with {@code externalId},
   * {@code name}, {@code categoryId}.
   *
   * <ul>
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link MeasurableHelper#createMeasurable(String, String, long)}
   */
  @Test
  @DisplayName(
      "Test createMeasurable(String, String, long) with 'externalId', 'name', 'categoryId'; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testCreateMeasurableWithExternalIdNameCategoryId_thenReturnOne() throws DataAccessException {
    ...
    when(dSLContext.newRecord(Mockito.<Table<Record>>any())).thenReturn(new AccessLogRecord());
    when(dSLContext.newRecord(Mockito.<Table<MeasurableRecord>>any()))
        .thenReturn(new MeasurableRecord());
  ...
  /**
   * Test {@link MeasurableHelper#createMeasurable(String, long)} with {@code name}, {@code
   * categoryId}.
   *
   * <ul>
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link MeasurableHelper#createMeasurable(String, long)}
   */
  @Test
  ...
  @Test
  @DisplayName(
      "Test createMeasurable(String, long) with 'name', 'categoryId'; when 'null'; then return one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long MeasurableHelper.createMeasurable(String, long)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link MeasurableHelper#updateMeasurableReadOnly(EntityReference, long)}
   */
  @Test
  @DisplayName("Test updateMeasurableReadOnly(EntityReference, long); then calls update(Table)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void MeasurableHelper.updateMeasurableReadOnly(EntityReference, long)"})
  void testUpdateMeasurableReadOnly_thenCallsUpdate() throws DataAccessException {
    // Arrange
    ...
    // Act
    measurableHelper.updateMeasurableReadOnly(
   ...
   *
   * <p>Method under test: {@link MeasurableHelper#updateMeasurableLifecycleStatus(long,
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "int MeasurableHelper.updateMeasurableLifecycleStatus(long, EntityLifecycleStatus)"
  })
  void testUpdateMeasurableLifecycleStatus() throws DataAccessException {
    ...
    // Act
    int actualUpdateMeasurableLifecycleStatusResult =
        measurableHelper.updateMeasurableLifecycleStatus(1L, EntityLifecycleStatus.ACTIVE);
