...
class RatingSchemeHelperDiffblueTest {
  ...
  /**
   * Test {@link RatingSchemeHelper#saveRatingItem(long, String, int, String, String)} with {@code schemeId}, {@code name}, {@code position}, {@code color}, {@code code}.
   * <p>
   * Method under test: {@link RatingSchemeHelper#saveRatingItem(long, String, int, String, String)}
   */
  @Test
  @DisplayName("Test saveRatingItem(long, String, int, String, String) with 'schemeId', 'name', 'position', 'color', 'code'")
  @Tag("MaintainedByDiffblue")
  ...
  /**
   * Test {@link RatingSchemeHelper#saveRatingItem(long, String, int, String, String, String)} with {@code schemeId}, {@code name}, {@code position}, {@code color}, {@code code}, {@code externalId}.
   * <p>
   * Method under test: {@link RatingSchemeHelper#saveRatingItem(long, String, int, String, String, String)}
   */
  @Test
  @DisplayName("Test saveRatingItem(long, String, int, String, String, String) with 'schemeId', 'name', 'position', 'color', 'code', 'externalId'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"long RatingSchemeHelper.saveRatingItem(long, String, int, String, String, String)"})
