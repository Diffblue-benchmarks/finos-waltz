...
class SurveyTemplateHelperDiffblueTest {
  ...
  @InjectMocks private SurveyTemplateHelper surveyTemplateHelper;
   ...
   *
   * <p>Method under test: {@link SurveyTemplateHelper#createTemplate(String, String)}
   */
  @Test
  ...
  void testCreateTemplate() {
    // Arrange
    when(surveyTemplateService.create(
            Mockito.<String>any(), Mockito.<SurveyTemplateChangeCommand>any()))
        .thenReturn(1L);
   ...
   *
   * <p>Method under test: {@link SurveyTemplateHelper#updateStatus(String, long,
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SurveyTemplateHelper.updateStatus(String, long, ReleaseLifecycleStatus)"
  })
  void testUpdateStatus() {
    // Arrange
    when(surveyTemplateService.updateStatus(
            Mockito.<String>any(), anyLong(), Mockito.<ReleaseLifecycleStatusChangeCommand>any()))
        .thenReturn(1);
    ...
    // Assert
    verify(surveyTemplateService)
        .updateStatus(eq("42"), eq(1L), isA(ReleaseLifecycleStatusChangeCommand.class));
  }

  /**
   * Test {@link SurveyTemplateHelper#addQuestion(long)}.
   *
   * <p>Method under test: {@link SurveyTemplateHelper#addQuestion(long)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link SurveyTemplateHelper#addMandatoryQuestion(long)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link SurveyTemplateHelper#deleteAllSurveyTemplate()}
   */
  @Test
