...
class PlaywrightUtilitiesDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test mkEmbeddedFrag(Section, EntityReference); given one; when EntityReference id() return one; then calls id()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String PlaywrightUtilities.mkEmbeddedFrag(Section, EntityReference)"})
  void testMkEmbeddedFrag_givenOne_whenEntityReferenceIdReturnOne_thenCallsId() {
    // Arrange
    ...
    // Act
    String actualMkEmbeddedFragResult =
        PlaywrightUtilities.mkEmbeddedFrag(Section.APP_SURVEYS, appRef);
  ...
  @Test
  @DisplayName(
      "Test toFrag(EntityReference); given one; when EntityReference id() return one; then calls id()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String PlaywrightUtilities.toFrag(EntityReference)"})
  void testToFrag_givenOne_whenEntityReferenceIdReturnOne_thenCallsId() {
    // Arrange
   ...
   * </ul>
   *
   * <p>Method under test: {@link PlaywrightUtilities#logAppLink(EntityReference)}
   */
  @Test
  @DisplayName(
      "Test logAppLink(EntityReference); given of 'foo'; when EntityReference name() return of 'foo'; then calls id()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PlaywrightUtilities.logAppLink(EntityReference)"})
  void testLogAppLink_givenOfFoo_whenEntityReferenceNameReturnOfFoo_thenCallsId() {
    // Arrange
    EntityReference appRef = mock(EntityReference.class);
