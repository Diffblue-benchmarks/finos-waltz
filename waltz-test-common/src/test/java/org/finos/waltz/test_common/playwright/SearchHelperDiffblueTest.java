...
class SearchHelperDiffblueTest {
   ...
   *
   * <p>Method under test: {@link SearchHelper#SearchHelper(Page)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link SearchHelper#search(String)}
   */
  @Test
  ...
  void testSearch() {
    ...
    verify(locator2).fill("Qry");
    verify(locator3).getByTestId("search-button");
    verify(locator3).locator("input[type=search]");
   ...
   *
   * <p>Method under test: {@link SearchHelper#waitForResult(String)}
   */
  @Test
  ...
  void testWaitForResult() {
    ...
    // Assert
    verify(locator3).getByTestId("entity-name");
    verify(locator2).getByText("Name");
    verify(locator).waitFor();
    verify(page).locator(".wnso-search-results");
  }

  /**
   * Test {@link SearchHelper#getSearchResultsPanel()}.
   *
   * <p>Method under test: {@link SearchHelper#getSearchResultsPanel()}
   */
  @Test
