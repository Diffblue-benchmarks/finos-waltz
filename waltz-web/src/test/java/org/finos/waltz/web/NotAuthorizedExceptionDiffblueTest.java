...
class NotAuthorizedExceptionDiffblueTest {
  ...
  @MethodsUnderTest({"void NotAuthorizedException.<init>()", "void NotAuthorizedException.<init>(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link NotAuthorizedException#NotAuthorizedException(String)}
   */
  @Test
  @DisplayName("Test new NotAuthorizedException(String); then return Message is 'An error occurred'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void NotAuthorizedException.<init>()", "void NotAuthorizedException.<init>(String)"})
