...
class ImmutableUpdateAppCapabilitiesActionDiffblueTest {
  ...
  void testBuilderAddAdditionsWithElement_thenBuilderBuildAdditionsSizeIsOne() {
    ...
    ImmutableEntityReference element =
  ...
  void testBuilderAddAdditionsWithElements_thenBuilderBuildAdditionsSizeIsOne() {
    ...
    // Act
    Builder actualAddAdditionsResult =
  ...
  @Test
  @DisplayName(
      "Test Builder from(UpdateAppCapabilitiesAction); given builder; when builder build; then return builder")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Builder Builder.from(UpdateAppCapabilitiesAction)"})
  void testBuilderFrom_givenBuilder_whenBuilderBuild_thenReturnBuilder() {
    // Arrange
    Builder builderResult = ImmutableUpdateAppCapabilitiesAction.builder();
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given ArrayList(); when Json (default constructor) Removals is 'null'; then return removals is additions")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableUpdateAppCapabilitiesAction ImmutableUpdateAppCapabilitiesAction.fromJson(Json)"
  })
  void testFromJson_givenArrayList_whenJsonRemovalsIsNull_thenReturnRemovalsIsAdditions() {
    // Arrange
    Json json = new Json();
    json.setAdditions(new ArrayList<>());
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link Json} (default constructor) Additions is {@code null}.
   *   <li>Then return removals is additions.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableUpdateAppCapabilitiesAction#fromJson(Json)}
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) Additions is 'null'; then return removals is additions")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableUpdateAppCapabilitiesAction ImmutableUpdateAppCapabilitiesAction.fromJson(Json)"
  ...
  void testFromJson_givenNull_whenJsonAdditionsIsNull_thenReturnRemovalsIsAdditions() {
    ...
    json.setRemovals(new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>Then return additions size is two.
   * </ul>
   *
   * <p>Method under test: {@link ImmutableUpdateAppCapabilitiesAction#fromJson(Json)}
   */
  @Test
  @DisplayName("Test fromJson(Json); then return additions size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ImmutableUpdateAppCapabilitiesAction ImmutableUpdateAppCapabilitiesAction.fromJson(Json)"
  })
  void testFromJson_thenReturnAdditionsSizeIsTwo() {
    // Arrange
    ...
    // Assert
    List<EntityReference> additionsResult = actualFromJsonResult.additions();
    assertEquals(2, additionsResult.size());
    EntityReference getResult = additionsResult.get(1);
    assertTrue(getResult instanceof ImmutableEntityReference);
    assertEquals(additionsResult.get(0), getResult);
    List<EntityReference> expectedRemovalsResult = json.removals;
    assertEquals(expectedRemovalsResult, actualFromJsonResult.removals());
  }
  ...
  void testFromJson_thenReturnRemovalsSizeIsOne() {
    ...
    assertEquals(1, removalsResult.size());
    assertTrue(removalsResult.get(0) instanceof ImmutableEntityReference);
    assertEquals(additions, actualFromJsonResult.additions());
  }
