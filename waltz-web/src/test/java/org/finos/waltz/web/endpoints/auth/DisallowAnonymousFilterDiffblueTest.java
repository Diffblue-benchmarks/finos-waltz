...
class DisallowAnonymousFilterDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link DisallowAnonymousFilter#DisallowAnonymousFilter(SettingsService)}
   */
  @Test
  @DisplayName("Test new DisallowAnonymousFilter(SettingsService); then return not SettingValue is 'Name' Present")
