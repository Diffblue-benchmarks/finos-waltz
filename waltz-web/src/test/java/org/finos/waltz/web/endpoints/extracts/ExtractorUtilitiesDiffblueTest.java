...
class ExtractorUtilitiesDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@code format}.
   * </ul>
   *
   * <p>Method under test: {@link ExtractorUtilities#parseExtractFormat(Request)}
   */
  @Test
  @DisplayName("Test parseExtractFormat(Request); given 'format'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ExtractFormat ExtractorUtilities.parseExtractFormat(Request)"})
  void testParseExtractFormat_givenFormat() {
    // Arrange
    MockHttpServletRequest request = new MockHttpServletRequest();
    request.addParameter("format", "Request");

    // Act and Assert
    assertEquals(
        ExtractFormat.CSV,
        ExtractorUtilities.parseExtractFormat(RequestResponseFactory.create(request)));
  }
  ...
  @Test
  @DisplayName(
      "Test parseExtractFormat(Request); given 'Query Params'; when Request queryParams(String) return 'Query Params'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ExtractFormat ExtractorUtilities.parseExtractFormat(Request)"})
  void testParseExtractFormat_givenQueryParams_whenRequestQueryParamsReturnQueryParams() {
    // Arrange
