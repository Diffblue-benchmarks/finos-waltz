...
class DynamicJSONFormatterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link DynamicJSONFormatter#DynamicJSONFormatter(FormatterUtils)} with
   *       formatterUtils is {@link FormatterUtils} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link DynamicJSONFormatter#format(String, ReportGrid, List, List)}
   */
  @Test
  @DisplayName(
      "Test format(String, ReportGrid, List, List); given DynamicJSONFormatter(FormatterUtils) with formatterUtils is FormatterUtils (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"byte[] DynamicJSONFormatter.format(String, ReportGrid, List, List)"})
  void testFormat_givenDynamicJSONFormatterWithFormatterUtilsIsFormatterUtils() throws IOException {
    // Arrange
    DynamicJSONFormatter dynamicJSONFormatter = new DynamicJSONFormatter(new FormatterUtils());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"byte[] DynamicJSONFormatter.format(String, ReportGrid, List, List)"})
  void testFormat_givenDynamicJSONFormatterWithFormatterUtilsIsFormatterUtils2()
      throws IOException {
    // Arrange
    DynamicJSONFormatter dynamicJSONFormatter = new DynamicJSONFormatter(new FormatterUtils());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"byte[] DynamicJSONFormatter.format(String, ReportGrid, List, List)"})
  void testFormat_givenDynamicJSONFormatterWithFormatterUtilsIsFormatterUtils3()
      throws IOException {
    // Arrange
    DynamicJSONFormatter dynamicJSONFormatter = new DynamicJSONFormatter(new FormatterUtils());
  ...
  @Test
  @DisplayName(
      "Test format(String, ReportGrid, List, List); then calls mkColumnHeaders(List, List)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"byte[] DynamicJSONFormatter.format(String, ReportGrid, List, List)"})
  void testFormat_thenCallsMkColumnHeaders() throws IOException {
    // Arrange
    when(formatterUtils.mkColumnHeaders(
            Mockito.<List<Tuple2<ReportGridFixedColumnDefinition, ColumnCommentary>>>any(),
            Mockito.<List<ReportGridDerivedColumnDefinition>>any()))
