...
class ImmutableFullScenarioDiffblueTest {
  ...
  void testBuilderRoadmap_whenRoadmap_thenReturnBuilder() {
    ...
    // Act
    Builder actualRoadmapResult = builderResult.roadmap(mock(Roadmap.class));
  ...
  void testBuilderScenario_whenScenario_thenReturnBuilder() {
    ...
    // Act
    Builder actualScenarioResult = builderResult.scenario(mock(Scenario.class));
  ...
  @MethodsUnderTest({
    ...
    "String ImmutableFullScenario.toString()"
  })
  void testGettersAndSetters() {
    ...
    // Act
    String actualToStringResult = immutableFullScenario.toString();
    ...
    assertEquals(
        "FullScenario{roadmap=Roadmap{id=1, name=Name, lastUpdatedAt=1970-01-01T00:00, lastUpdatedBy=2020-03-01,"
            + " entityLifecycleStatus=ACTIVE, ratingSchemeId=1, rowType=EntityReference{kind=ALL, id=1, entityLifec"
            + "ycleStatus=ACTIVE}, columnType=EntityReference{kind=ALL, id=1, entityLifecycleStatus=ACTIVE}},"
            + " scenario=Scenario{id=1, name=Name, lastUpdatedAt=1970-01-01T00:00, lastUpdatedBy=2020-03-01,"
            + " entityLifecycleStatus=ACTIVE, position=0, roadmapId=1, effectiveDate=1970-01-01, scenarioType=TARGET,"
            + " releaseStatus=DRAFT}, axisDefinitions=[], ratings=[]}",
