...
class ImmutableReportGridJSONDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ImmutableGrid.Json} (default constructor).
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given Json (default constructor); when Json (default constructor) Type is 'Json'; then return type is 'Json'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test fromJson(Json); given 'null'; when Json (default constructor) Type is 'null'; then return type is REPORT_GRID_TYPE")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ImmutableReportGridJSON ImmutableReportGridJSON.fromJson(Json)"})
  void testFromJson_givenNull_whenJsonTypeIsNull_thenReturnTypeIsReport_grid_type() {
    // Arrange
    Json json = new Json();
    ApiTypes apiTypes = new ApiTypes();
    json.setApiTypes(apiTypes);
